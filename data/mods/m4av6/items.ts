export const BattleItems: {[k: string]: ModdedItemData} = {
	...
	lycanite: {
		...
		onAfterMega(source) {
			...
			this.add(`raw|<ul class="utilichart"><li class="result"><span class="col numcol">` + species.tier + `</span> <span class="col pokemonnamecol" style="white-space: nowrap">` + species.name + `</span> <span class="col typecol"><img src="https://${Config.routes.client}/sprites/types/` + source.species.types[0] + `.png" alt="` + source.species.types[0] + `" height="14" width="32"><img src="https://${Config.routes.client}/sprites/types/` + source.species.types[1] + `.png" alt="` + source.species.types[1] + `" height="14" width="32"></span> <span style="float: left ; min-height: 26px"><span class="col abilitycol">` + species.abilities['0'] + `</span><span class="col abilitycol"></span></span><span style="float: left ; min-height: 26px"><span class="col statcol"><em>HP</em><br>` + species.baseStats['hp'] + `</span> <span class="col statcol"><em>Atk</em><br>` + species.baseStats['atk'] + `</span> <span class="col statcol"><em>Def</em><br>` + species.baseStats['def'] + `</span> <span class="col statcol"><em>SpA</em><br>` + species.baseStats['spa'] + `</span> <span class="col statcol"><em>SpD</em><br>` + species.baseStats['spd'] + `</span> <span class="col statcol"><em>Spe</em><br>` + species.baseStats['spe'] + `</span> </span></li><li style="clear: both"></li></ul>`);
		},
		num: -1011,
		gen: 8,
