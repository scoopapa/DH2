...
exports.BattleScripts = {
	...
	init: function () {
		this.modData('Pokedex', 'magnemite').types = ['Electric'];
		this.modData('Pokedex', 'magneton').types = ['Electric'];
		this.modData('Pokedex', 'forretress').types = ['Bug', 'Rock'];
		this.modData('Pokedex', 'scizor').types = ['Bug', 'Rock'];
		this.modData('Pokedex', 'skarmory').types = ['Rock', 'Flying'];
		this.modData('Pokedex', 'steelix').types = ['Ground', 'Rock'];
	},
