...
// SANDBOX CONTENT STARTS HERE
	...
	init() {
		...
		newMoves("burmysandy", ["strugglebug"]);
		newMoves("burmytrash", ["strugglebug"]);
		...
		newMoves("finneon", ["bubble", "airslash", "roost", "hydropump"]);
		newMoves("flareon", ["calmmind", "powershift", "mimic"]);
		newMoves("gallade", ["icebeam"]);
		...
		newMoves("lumineon", ["bubble", "airslash", "roost", "hydropump"]);
		...
		newMoves("munchlax", ["highhorsepower", "iceball"]);
		...
		newMoves("onix", ["iceball", "powershift"]);
		...
		newMoves("vulpixalola", ["dazzlinggleam", "icefang"]);
