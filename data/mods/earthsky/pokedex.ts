export const Pokedex: {[speciesid: string]: ModdedSpeciesData} = {
	...
	apherove: {
		...
		abilities: {0: "Irresistible", H: "Competitive"},
		heightm: 1.1,
		weightkg: 45.4,
		tags: ["Sub-Legendary"],
		color: "Pink",
	...
	terapagosstellar: {
		inherit: true,
		requiredItem: "Stellar Tera Shard",
	},
	pecharunt: {
		inherit: true,
