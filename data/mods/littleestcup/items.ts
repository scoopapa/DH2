...
*/
	...
	focusband: {
		...
		num: 230,
		shortDesc: "Holder will block the first attack that would KO it. Single-use.",
		gen: 2,
		rating: 1,
	},
	focussash: {
	...
	ringtarget: {
		...
		onNegateImmunity: false,
		num: 543,
		shortDesc: "The holders' type immunities granted solely by their typing are negated.",
		gen: 5,
	},
	rockgem: {
		name: "Rock Gem",
...
*/
	...
	zoomlens: {
		...
		onBasePower(basePower, pokemon) {
			...
			if (boosted) {
				this.debug('Zoom Lens boost');
				return this.chainModify([4903, 4096]);
			}
		},
		num: 276,
		shortDesc: "The power of attacks by the holder is 1.2x if it moves after its target.",
		gen: 4,
	},
