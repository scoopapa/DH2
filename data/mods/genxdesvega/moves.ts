export const Moves: {[moveid: string]: MoveData} = {
	...
	inkburst: {
		...
		category: "Special",
		name: "Ink Burst",
		shortDesc: "30% chance to lower the target's Speed by 1 stage. If Crayoct, type depends on color.",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1},
		onPrepareHit: function(target, source, move) {
	...
	voraciousfang: {
		...
		shortDesc: "30% chance to flinch target. Target poisoned: 100% chance to flinch instead.",
		pp: 10,
		priority: 0,
		flags: {bite: 1, contact: 1, protect: 1, mirror: 1},
		onPrepareHit: function(target, source, move) {
