export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	torterra: {
		inherit: true,
		baseStats: {hp: 95, atk: 109, def: 105, spa: 85, spd: 85, spe: 56},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	skeledirge: {
		inherit: true,
		baseStats: {hp: 104, atk: 75, def: 100, spa: 110, spd: 110, spe: 66},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	samurott: {
		inherit: true,
		baseStats: {hp: 95, atk: 100, def: 85, spa: 108, spd: 108, spe: 70},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	audino: {
	...
	orbeetle: {
		inherit: true,
		baseStats: {hp: 60, atk: 45, def: 110, spa: 80, spd: 80, spe: 90},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	hariyama: {
		inherit: true,
		baseStats: {hp: 144, atk: 120, def: 60, spa: 40, spd: 40, spe: 50},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	abomasnow: {
	...
	volcarona: {
		inherit: true,
		baseStats: {hp: 85, atk: 60, def: 65, spa: 105, spd: 105, spe: 100},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	nihilego: {
		inherit: true,
		baseStats: {hp: 109, atk: 53, def: 47, spa: 131, spd: 131, spe: 103},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	articunogalar: {
	...
	zapdosgalar: {
		inherit: true,
		baseStats: {hp: 90, atk: 125, def: 90, spa: 90, spd: 90, spe: 100},
		abilities: {0: "No Ability"},
		gen: 1,
	},
	moltresgalar: {
