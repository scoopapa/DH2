...
brokenherosword: {
		...
		onPrimal(pokemon) {
			if(pokemon.baseSpecies.name === 'Shadow') pokemon.formeChange('Ancient Shadow', this.effect, true);
			if(pokemon.baseSpecies.name === 'Hallowed') pokemon.formeChange('Ancient Hallowed', this.effect, true);
		},
