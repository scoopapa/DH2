export const Rulesets: {[k: string]: ModdedFormatData} = {
	megadatamod: {
		...
		onBegin() {
			...
			this.add('-message', `Right now, we're working on giving new Mega Evolutions to a variety of Pokémon in a Paldea Pokédex-based format. The only Mega Evolutions allowed are our new ones!`);
