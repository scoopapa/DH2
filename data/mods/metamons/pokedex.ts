export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	eldegoss: {
		...
		baseStats: {hp: 95, atk: 50, def: 80, spa: 80, spd: 120, spe: 70},
	...
	abomasnow: {
		...
		name: "Abomasnow",
		types: ["Ground", "Ice"],
		baseStats: {hp: 70, atk: 92, def: 70, spa: 92, spd: 65, spe: 90},
		abilities: {0: "Snow Warning", 1: "Skill Link", H: "Soundproof"},
		heightm: 2.2,
		weightkg: 135.5,
		color: "White",
		prevo: "Snover",
	...
	necrozma: {
		...
		types: ["Psychic", "Steel"],
		gender: "N",
		baseStats: {hp: 87, atk: 117, def: 96, spa: 117, spd: 94, spe: 79},
		abilities: {0: "Prism Armor", H: "Levitate"},
		heightm: 2.4,
		weightkg: 230,
		color: "Black",
