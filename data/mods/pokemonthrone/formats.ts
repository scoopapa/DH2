...
export const Formats: FormatData[] = [
	{
		...
		threads: [],
		mod: 'pokemonthrone',
		ruleset: ['Species Clause', 'Sleep Clause Mod', 'Evasion Moves Clause', 'OHKO Clause', 'Endless Battle Clause', 
			'HP Percentage Mod', 'Team Preview', 'Data Mod', 'Mega Data Mod', 'Force Open Team Sheets', 'nohptypeiv'],
