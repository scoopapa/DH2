export const Pokedex: {[k: string]: ModdednameData} = {
	...
	fatalis: {
		...
		name: "Fatalis",
		types: ["Dragon"],
		baseStats: {hp: 100, atk: 110, def: 90, spa: 140, spd: 100, spe: 90},
	...
	crimsonfatalis: {
		...
		forme: "Mega",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 100, atk: 155, def: 115, spa: 90, spd: 90, spe: 100},
		abilities: {0: "Orichalcum Pulse"},
		heightm: 1.0,
		weightkg: 270.0,
		color: "Black",
		eggGroups: ["Field"],
		requiredMove: "Crimson Dawn",
	},
	whitefatalis: {
		num: 15,
		name: "White-Fatalis",
		...
		baseStats: {hp: 100, atk: 90, def: 90, spa: 155, spd: 115, spe: 100},
		abilities: {0: "Hadron Engine"},
		heightm: 1.0,
		weightkg: 270.0,
		color: "Black",
		eggGroups: ["Field"],
		requiredMove: "Ancestral Thunder",
	},
	gaismagorm: {
		num: 116,
		name: "Gaismagorm",
