export const Items: import('../../../sim/dex-items').ModdedItemDataTable = {
  cornerstonemask: {
	...
	terashard: {
		...
		onTakeItem: false,
		onStart(pokemon) {
			if (['Ogerpon', 'Skeledirge', 'Samurott', 'Tinkaton', 'Pincurchin', 'Metagross', 'Blissey', 'Pawmot', 'Hydrapple', 'Mabosstiff', 'Flygon', 'Iron Leaves', 'Clodsire', 'Weezing', 'Volcanion', 'Meowscarada', 'Okidogi', 'Munkidori', 'Fezandipiti', 'Basculegion', 'Diancie', 'Kleavor', 'Goodra', 'Avalugg', 'Hawlucha', 'Primarina', 'Dragonite', 'Farigiraf', 'Blaziken'].includes(pokemon.baseSpecies.baseSpecies)) {
	  			if (pokemon.side.sideConditions['teraused']) {
	  				pokemon.canTerastallize = null;
	  			} else {
	        		pokemon.canTerastallize = this.actions.canTerastallize(pokemon);
		...
		itemUser: ["Ogerpon", "Skeledirge", "Samurott-Hisui", "Tinkaton", "Pincurchin", "Metagross", "Blissey", "Pawmot", "Hydrapple", "Mabosstiff", "Flygon", "Iron Leaves", "Clodsire", "Weezing-Galar", "Volcanion", "Meowscarada", "Okidogi", "Munkidori", "Fezandipiti", "Basculegion-F", "Diancie", "Kleavor", "Goodra", "Avalugg", "Hawlucha", "Primarina", "Dragonite", "Farigiraf", "Blaziken"],
		num: -1001,
		gen: 9,
