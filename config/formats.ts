...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['All Pokemon'],
		unbanlist: ['Sceptile', 'Charizard', 'Inteleon', 'Lanturn', 'Larvesta', 'Aggron'],
		mod: "abilitypos",
	},
	{
	...
	*/
	{
		...
		unbanlist: ['Whimsicott', 'Salazzle', 'Kingler', 'Ariados', 'Sandslash', 'Bastiodon', 'Slowbro-Galar', 'Sableye', 'Grapploct'],
	},
	{
