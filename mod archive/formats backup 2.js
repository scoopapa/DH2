...
export const Formats: FormatList = [
	...
	
	{
        ...
        mod: 'expansions',
        ruleset: ['Standard NatDex', 'Fifth Move Additions'],
...
*/		onAfterMega(pokemon) {
    ...
    },
   {
		...
		mod: 'genxloria',
		ruleset: ['Standard NatDex', 'Data Mod', 'Z-Move Clause', 'Mega Data Mod'],
		banlist: [
			'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'Baton Pass',
	...
	},
	{
		...
		mod: 'gen3hoenngaiden',
		ruleset: ['Standard', 'Data Mod', 'Freeze Clause Mod', 'Hoenn Gaiden Mod'],
	...
	},
	{
		...
		ruleset: ['Standard NatDex', 'Data Mod', 'Legends Boosts Mod'],
		banlist: [
			'Arena Trap', 'Moody', 'Shadow Tag', 'Baton Pass',
			'Sceptilite', 'Blazikenite', 'Swampertite', 'Gardevoirite', 'Galladite', 'Alakazite', 'Gyaradosite',
			'Sablenite', 'Mawilite', 'Aggronite', 'Medichamite', 'Manectite', 'Sharpedonite', 'Cameruptite', 
	...
	*/
	...
	},
	{
		...
		ruleset: ['Standard NatDex', '+Nonexistent', '!Obtainable Abilities', '!Obtainable Moves', '!Obtainable Formes', 'Forme Clause', '2 Ability Clause', /*, 'Arceus Clause'*/],
		banlist: [
	...
	{  
		...
		mod: 'sylvemonstest',
		teambuilderFormat: 'OU',
		ruleset: ['Standard NatDex', 'Data Mod', 'Mega Data Mod', 'SylveMons Intro Mod'],
	...
	},
	{
		...
		mod: 'tothegigantamax',
		gameType: 'doubles',
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Standard GBU', 'VGC Timer'],
		minSourceGen: 8,
	},
	{
		...
		challengeShow: false,
		debug: true,
		ruleset: ['!! Adjust Level = 50', 'Picked Team Size = 3', 'Dynamax Clause', 'Team Preview'],
	...
	},*/
	{
		...
		gameType: 'doubles',
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Standard GBU', 'VGC Timer', 'Dynamax Clause', 'Z-Move Clause', 'Data Mod', 'Mega Data Mod'],
		banlist: [
			'All Pokemon',
		],
		unbanlist: [
	...
	},
	{
		...
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Obtainable', 'Species Clause', 'Nickname Clause', 'Item Clause', 'Team Preview', 'Cancel Mod', 'Dynamax Clause', 'Data Mod', 'Mega Data Mod'],
		banlist: [
			'DUber', 'All Pokemon'
		],
		unbanlist: [
	...
	},
	{
		...
		mod: 'genxloria',
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Standard GBU', 'VGC Timer', 'Dynamax Clause', 'Data Mod', 'Mega Data Mod', '+Past', 'Z-Move Clause', 'Mega Data Mod'],
		gameType: 'doubles',
		forcedLevel: 50,
		banlist: [
			'Altarianite', 'Gengarite', 'Salamencite',
	...
	},*/
	{
		...
		mod: 'joltemons',	
		teambuilderFormat: 'OU',
		ruleset: ['Picked Team Size = 1', 'Max Team Size = 3',
			'Standard NatDex', 'Data Mod', 'Mega Data Mod'],
...
*/
	...
	},
	{
		...
		gameType: 'doubles',
		forcedLevel: 50,
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Standard GBU', '+Unobtainable', '+Past', 'VGC Timer', 'Dynamax Clause', 'Mega Data Mod'],
		mod: 'm4av6',
		// teambuilderFormat: 'S',
		onValidateSet(set) {
	...
	},
	{
		...
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Obtainable', 'Team Preview', 'Species Clause', 'Nickname Clause', 'Item Clause', 'Cancel Mod', '+Unobtainable', '+Past', 'VGC Timer', 'Dynamax Clause', 'Mega Data Mod'],
		mod: 'm4av6',
	...
	},
	{
		...
		gameType: 'doubles',
		forcedLevel: 50,
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Team Preview', 'Cancel Mod', 'VGC Timer', 'Mega Data Mod', 'Sandbox Mod', 'Overflow Stat Mod'],
		teambuilderFormat: 'Doubles OU',
	},
	{
	...
	},
	{
		...
		mod: 'paleomons',
		ruleset: ['Little Cup', 'Standard NatDex', 'Z-Move Clause', 'Data Mod', 'Mega Data Mod'],
		banlist: [
			'All Pokemon',
		],
		unbanlist: [
	...
	},*/
	{
		...
		ruleset: ['Little Cup', 'Dynamax Clause', 'Data Mod'],
		onValidateTeam(team, format) {
			let speciesTable = {};
	...
	},
	{
		...
		ruleset: ['Standard NatDex', 'Data Mod', 'Little Cup'],
...
//   		},
	...
	*/
	...
	},
	{
		...
		ruleset: ['Standard NatDex', 'Z-Move Clause', 'Movexit Clause', 'Data Mod', 'Mega Data Mod'],
		mod: 'conniecorddraft',
		searchShow: false,
		banlist: [
	...
	},
	{
		...
		forcedLevel: 50,
		banlist: ['Scizor'],
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Standard GBU', '+Unobtainable', '+Past', 'VGC Timer', 'Dynamax Clause', 'Z-Move Clause', 'Data Mod', 'Mega Data Mod'],
		onValidateTeam(team, format) {
			/**@type {{[k: string]: true}} */
			let speciesTable = {};
			for (const set of team) {
	...
	},
	{
		...
		desc: `Chaos Chaos Chaos`,
  		...
  		ruleset: ['Standard NatDex', '!Species Clause', 'Z-Move Clause'],
	...
	},
	{
        ...
        mod: 'danceofthedead',
        ruleset: ['Standard NatDex', 'Item Clause', 'Data Mod'],
 ...
 'Baloon-Popped', 'Encrave', 'Eneryth', 'Fantom', 'Flamepion', 'Grievenge', 'Hydread', 'Marspookial', 'Mortemoth', 'Pozaqes', 'Sanbatter', 'Sheegal', 'Spirox', 'Tumbleak', 'Wistape',			  
	...
	*/
	...
	},
	{
		...
		mod: 'gen1moderngen1',
		ruleset: ['Standard NatDex', '!Obtainable', '!Team Preview'],
	...
	},
	{
      ...
      mod: 'mememons',
      ruleset: ['Standard NatDex', 'Realmon Clause'],
	...
	},
	{
		...
		mod: 'gen8',
		gameType: 'doubles',
		ruleset: ['Standard NatDex', 'Item Clause', '!! Adjust Level = 50', 'VGC Timer', 'Picked Team Size = 4', 'Limit Two Restricted'],
		banlist: ['Mythical'],
	...
	
	{
		...
		gameType: 'doubles',
		forcedLevel: 77,
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Standard GBU', 'VGC Timer', 'Dynamax Clause', 'Data Mod', 'Mega Data Mod', '+Past'],
...
*/
	...
	},
	{
		...
		mod: 'wildmons',
		teambuilderFormat: "OU",
		ruleset: ['Standard NatDex', 'Z-Move Clause', 'Mega Rayquaza Clause', 'Data Mod',],
		banlist: [
				//Abilities
	...
	},
	{
		...
		ruleset: ['Megas Only Mod', 'Standard NatDex', 'Standard M4A', 'Mega Data Mod'],
		mod: 'm4av6',
		searchShow: false,
		challengeShow: false,
	},
