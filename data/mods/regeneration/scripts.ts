   ...
   gen: 9,
	...
	actions: {
		modifyDamage(
			...
			if (pokemon.m.tasteTested && pokemon.m.tasteTested.includes(target)) baseDamage = this.battle.modify(baseDamage, 1.5);
	...
	init() {
		...
		this.modData("Learnsets", "tangela").learnset.rapidspin = ["9L1"];
		this.modData("Learnsets", "tangela").learnset.spikes = ["9L1"];
		this.modData("Learnsets", "tangela").learnset.toxicspikes = ["9L1"];
		this.modData("Learnsets", "tangela").learnset.strengthsap = ["9L1"];
		this.modData("Learnsets", "tangela").learnset.earthpower = ["9L1"];
		this.modData("Learnsets", "golbat").learnset.toxicspikes = ["9L1"];
		this.modData("Learnsets", "golbat").learnset.psychicfangs = ["9L1"];
		this.modData("Learnsets", "golbat").learnset.partingshot = ["9L1"];
		this.modData("Learnsets", "golbat").learnset.toxicbite = ["9L1"];
