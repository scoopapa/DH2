"use strict";Object.defineProperty(exports, "__esModule", {value: true});
 ...
 const translations = {
	strings: {
		...
		"User ${name} must be in the battle room already.": "${name} doit déjà être présent dans le combat.",
		...
		"${name} was added to the battle as Player ${playerNum} by ${user.name}.": "${name} a été ajouté à ce combat comme le Joueur ${playerNum} par ${user.name}.",
		"Player 2": "Joueur 2",
		...
		"${targetUser.name} was kicked from a battle by ${user.name} ${displayTarget}": "${targetUser.name} a été exclu d'un combat par ${user.name} ${displayTarget}",
		...
		"The user '${targetUsername}' was not found.": "L'utilisateur '${targetUsername}' n'a pas été trouvé.",
		"You are locked and cannot challenge unlocked users.": "Tu es locked et ne peux pas envoyer de challenge aux utilisateurs qui ne le sont pas.",
