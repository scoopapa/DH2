export const BattleFormatsData: {[k: string]: ModdedSpeciesFormatsData} = {
	...
	*/
	...
	mismagiusmega: {
		randomBattleMoves: ["nastyplot", "substitute", "willowisp", "shadowball", "thunderbolt", "sludgebomb", "taunt", "painsplit", "poisonfang", "toxic", "partingshot", "toxicspikes"],
		randomDoubleBattleMoves: ["nastyplot", "willowisp", "shadowball", "thunderbolt", "dazzlinggleam", "taunt", "protect"],
		tier: "NU",
		doublesTier: "(DUU)",
	},
	...
	*/
	...
	mimikyubustedtotem: {},
	mimikyumega: {
		randomBattleMoves: ["strengthsap", "shadowsneak", "playrough", "taunt", "shadowclaw", "leechlife", "swordsdance"],
		randomDoubleBattleMoves: ["shadowclaw", "playrough", "willowisp", "shadowsneak", "swordsdance", "protect"],
		tier: "UU",
		doublesTier: "DUU",
	},
	mimikyubustedmega: {
		randomBattleMoves: ["swordsdance", "shadowsneak", "leechlife", "taunt", "shadowclaw", "uturn", "firstimpression"],
		randomDoubleBattleMoves: ["shadowclaw", "playrough", "willowisp", "shadowsneak", "swordsdance", "protect"],
		tier: "UU",
		doublesTier: "DUU",
	},
