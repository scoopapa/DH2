export const Pokedex: {[k: string]: ModdednameData} = {
	...
	valstrax: {
		...
		name: "Valstrax",
		types: ["Dragon", "Steel"],
		baseStats: {hp: 95, atk: 105, def: 115, spa: 80, spd: 85, spe: 131},
	...
	yiankutku: {
		...
		name: "Yian Kutku",
		types: ["Fire", "Normal"],
		baseStats: {hp: 71, atk: 102, def: 70, spa: 106, spd: 85, spe: 90},
		abilities: {0: "Forewarn", H: "Blaze"},
		heightm: 1.0,
		weightkg: 30.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	bluekutku: {
		...
		name: "Blue Kutku",
		types: ["Fire", "Normal"],
		baseStats: {hp: 71, atk: 106, def: 102, spa: 85, spd: 70, spe: 90},
		abilities: {0: "Plow", H: "Blaze"},
		heightm: 1.0,
		weightkg: 30.0,
		color: "Black",
		eggGroups: ["Field"],
