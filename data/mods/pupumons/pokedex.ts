export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	croagunkapple: {
		num: 47,
		species: "Croagunk-Apple",
		baseSpecies: "Croagunk",
		forme: "Apple",
		types: ["Poison", "Fire"],
		baseStats: {hp: 48, atk: 58, def: 43, spa: 58, spd: 43, spe: 50},
		abilities: {0: "Dry Skin", 1: "Anticipation", H: "Stamina"},
		weightkg: 28,
		evos: ["Toxicroak-Apple"],
	},
	toxicroakapple: {
		num: 48,
		species: "Toxicroak-Apple",
