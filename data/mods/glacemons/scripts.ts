export const Scripts: ModdedBattleScriptsData = {
	...
	init() {
		...
		this.modData('Learnsets', 'ironjugulis').learnset.burningjealousy = ['891'];
		// Barb Barrage
		...
		this.modData('Learnsets', 'glacemon').learnset.frostnip = ['9L1'];
		...
		this.modData('Learnsets', 'garchomp').learnset.millstone = ['9L1'];
		...
		this.modData('Learnsets', 'sandline').learnset.millstone = ['9L1'];
