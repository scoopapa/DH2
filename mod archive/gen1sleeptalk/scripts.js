...
exports.BattleScripts = {
	...
	init: function () {
		this.modData('Learnsets', 'bulbasaur').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'ivysaur').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'venusaur').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'charmander').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'charmeleon').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'charizard').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'squirtle').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'wartortle').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'blastoise').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'butterfree').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'beedrill').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'pidgey').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'pidgeotto').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'pidgeot').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'rattata').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'raticate').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'spearow').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'fearow').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'ekans').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'arbok').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'pikachu').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'raichu').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'sandshrew').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'sandslash').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'nidoranf').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'nidorina').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'nidoqueen').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'nidoranm').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'nidorino').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'nidoking').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'clefairy').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'clefable').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'vulpix').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'ninetales').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'jigglypuff').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'wigglytuff').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'zubat').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'golbat').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'oddish').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'gloom').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'vileplume').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'paras').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'parasect').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'venonat').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'venomoth').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'diglett').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'dugtrio').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'meowth').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'persian').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'psyduck').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'golduck').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'mankey').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'primeape').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'growlithe').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'arcanine').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'poliwag').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'poliwhirl').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'poliwrath').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'abra').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'kadabra').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'alakazam').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'machop').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'machoke').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'machamp').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'bellsprout').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'weepinbell').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'victreebel').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'tentacool').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'tentacruel').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'geodude').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'graveler').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'golem').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'ponyta').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'rapidash').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'slowpoke').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'slowbro').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'magnemite').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'magneton').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'farfetchd').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'doduo').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'dodrio').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'seel').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'dewgong').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'grimer').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'muk').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'shellder').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'cloyster').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'gastly').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'haunter').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'gengar').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'onix').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'drowzee').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'hypno').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'krabby').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'kingler').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'voltorb').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'electrode').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'exeggcute').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'exeggutor').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'cubone').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'marowak').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'hitmonchan').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'hitmonlee').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'lickitung').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'koffing').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'weezing').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'rhyhorn').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'rhydon').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'chansey').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'tangela').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'kangaskhan').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'horsea').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'seadra').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'goldeen').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'seaking').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'staryu').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'starmie').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'mrmime').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'scyther').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'jynx').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'electabuzz').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'magmar').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'pinsir').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'tauros').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'gyarados').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'lapras').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'eevee').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'vaporeon').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'jolteon').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'flareon').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'porygon').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'omanyte').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'omastar').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'kabuto').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'kabutops').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'aerodactyl').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'snorlax').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'articuno').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'zapdos').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'moltres').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'dratini').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'dragonair').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'dragonite').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'mewtwo').learnset.sleeptalk = ['1L1'];
		this.modData('Learnsets', 'mew').learnset.sleeptalk = ['1L1'];
	},
