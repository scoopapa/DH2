	...
	},
{
	...
	},
	{
		...
		banlist: [
			...
			'Lycanroc-Base + Dusk Lycanite', 'Lycanroc-Base + Midnight Lycanite', 'Lycanroc-Midnight + Midday Lycanite', 'Lycanroc-Midnight + Dusk Lycanite',
			'Lycanroc-Dusk + Midday Lycanite', 'Lycanroc-Dusk + Midnight Lycanite', 'Raichu-Alola + Raichunite', 'Slowbro-Galar + Slowbronite',
		],
		unbanlist: ['Zarude'],
		mod: 'm4av6',
	},
	...
	},
	{
		...
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod'],
		banlist: ['All Pokemon', 'Midday Lycanite', 'Dusk Lycanite', 'Slowkinite', 'Gengarite'],
		unbanlist: [
			...
			'Vaporeon', 'Omanyte', 'Omastar', 'Kabuto', 'Kabutops', 'Aerodactyl', 'Hoothoot', 'Noctowl', 'Spinarak', 'Ariados', 'Crobat', 'Espeon', 'Umbreon', 'Murkrow',
			'Misdreavus', 'Unown', 'Wobbuffet', 'Gligar', 'Granbull', 'Sneasel', 'Corsola-Galar', 'Houndour', 'Houndoom', 'Mightyena', 'Zigzagoon-Galar', 'Linoone-Galar',
			'Dustox', 'Shiftry', 'Shedinja', 'Whismur', 'Loudred', 'Exploud', 'Sableye', 'Mawile', 'Gulpin', 'Swalot', 'Carvanha', 'Sharpedo', 'Cacnea', 'Cacturne',
			'Zangoose', 'Seviper', 'Lunatone', 'Crawdaunt', 'Baltoy', 'Claydol', 'Shuppet', 'Banette', 'Duskull', 'Dusclops', 'Absol', 'Snorunt', 'Glalie', 'Huntail',
			'Drifloon', 'Drifblim', 'Mismagius', 'Honchkrow', 'Stunky', 'Skuntank', 'Spiritomb', 'Skorupi', 'Drapion', 'Croagunk', 'Toxicroak', 'Carnivine', 'Abomasnow',
			...
			'Guzzlord', 'Poipole', 'Blacephalon', 'Inteleon', 'Corviknight', 'Blipbug', 'Dottler', 'Orbeetle', 'Nickit', 'Thievul', 'Coalossal', 'Silicobra', 'Sandaconda',
			'Toxtricity', 'Sizzlipede', 'Centiskorch', 'Sinistea', 'Polteageist', 'Hatenna', 'Hattrem', 'Hatterene', 'Impidimp', 'Morgrem', 'Grimmsnarl', 'Obstagoon',
