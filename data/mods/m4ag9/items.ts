export const Items: {[itemid: string]: ModdedItemData} = {
	...
	ninetalesite: {
		...
		num: -2016,
		gen: 9,
		desc: "If held by a Ninetales or a Ninetales-Alola, this item allows it to Mega Evolve in battle.",
	},
	noctowlite: {
		name: "Noctowlite",
		spritenum: 578,
	...
	dugtrionite: {
		...
		num: -2025,
		gen: 9,
		desc: "If held by a Dugtrio or a Dugtrio-Alola, this item allows it to Mega Evolve in battle.",
	},
	farigirafite: {
		name: "Farigirafite",
		spritenum: 578,
