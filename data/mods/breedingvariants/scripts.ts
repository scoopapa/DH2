export const Scripts: {[k: string]: ModdedBattleScriptsData} = {
	init: function () {
		...
		this.modData('Learnsets', 'goodraflame').learnset.swordsdance = ['8L1'];
		...
		this.modData('Learnsets', 'rapidashgalar').learnset.fakeout = ['8L1'];
		this.modData('Learnsets', 'rapidashgalar').learnset.ironhead = ['8L1'];
