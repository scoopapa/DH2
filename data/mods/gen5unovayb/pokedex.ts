export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	...
	liepard: {
		inherit: true,
		types: ["Dark", "Normal"],
		baseStats: {hp: 68, atk: 88, def: 50, spa: 88, spd: 50, spe: 116},
	},
	pansage: {
		inherit: true,
	...
	swoobat: {
		inherit: true,
		baseStats: {hp: 77, atk: 57, def: 55, spa: 77, spd: 55, spe: 114},
	},
	drilbur: {
		inherit: true,
	...
	zorua: {
		inherit: true,
		types: ["Dark", "Ghost"],
		abilities: {0: "Illusion", 1: "Imposter"},
	},
	zoroark: {
		inherit: true,
		types: ["Dark", "Ghost"],
	...
	galvantula: {
		inherit: true,
		baseStats: {hp: 70, atk: 77, def: 68, spa: 107, spd: 60, spe: 108},
	},
	ferroseed: {
		inherit: true,
	...
	beheeyem: {
		inherit: true,
		baseStats: {hp: 75, atk: 75, def: 75, spa: 140, spd: 95, spe: 40},
	},
	cubchoo: {
		inherit: true,
	...
	bouffalant: {
		inherit: true,
		baseStats: {hp: 95, atk: 110, def: 65, spa: 65, spd: 95, spe: 55},
		abilities: {0: "Reckless", 1: "Soundproof", H: "Fur Coat"},
	},
	litwick: {
		inherit: true,
		unreleasedHidden: null,
