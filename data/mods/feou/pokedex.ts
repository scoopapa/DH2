...
// OU
 ...
 // fusion: ['Vikavolt', 'Regidrago'],
	...
	lurret: {
		...
		name: "Deoxislash-Speed", 
		baseForme: "Shield",
		types: ["Psychic", "Steel"],
		baseStats: {hp: 61, atk: 72, def: 120, spa: 72, spd: 120, spe: 120}, 
		abilities: {0: "Forced Fencer"}, 
		weightkg: 56.9,
		otherFormes: ["Deoxislash-Speed-Blade"],
		formeOrder: ["Deoxislash-Speed", "Deoxislash-Speed-Blade"],
	 },
	 deoxislashspeedblade: {
		num: 69, 
		//fusion: ["Deoxys-Speed", "Aegislash"],
		name: "Deoxislash-Speed-Blade", 
		baseSpecies: "Deoxislash-Speed",
		forme: "Blade",
		types: ["Psychic", "Steel"],
