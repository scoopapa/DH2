export const Pokedex: { [k: string]: ModdedSpeciesData } = {
	...
	minior: {
		...
		formeOrder: [
		   ...
		   "Minior-Hoenn-Meteor", "Minior-Hoenn-Meteor", "Minior-Hoenn-Meteor", "Minior-Hoenn-Meteor", "Minior-Hoenn-Meteor", "Minior-Hoenn-Meteor", "Minior-Hoenn-Meteor",
		   "Minior-Hoenn", "Minior-Hoenn-Orange", "Minior-Hoenn-Yellow", "Minior-Hoenn-Green", "Minior-Hoenn-Blue", "Minior-Hoenn-Indigo", "Minior-Hoenn-Violet",
	   ],
	},
	miniorhoenn: {
		num: 774,
