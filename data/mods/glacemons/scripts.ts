export const Scripts: ModdedBattleScriptsData = {
	...
	init() {//Tera Blast
		...
		this.modData('Learnsets', 'buzzwole').learnset.wildcharge = ['9M'];
		this.modData('Learnsets', 'buzzwole').learnset.accelerock = ['9M'];
		this.modData('Learnsets', 'buzzwole').learnset.comeuppance = ['9M'];
		this.modData('Learnsets', 'buzzwole').learnset.curse = ['9M'];
		this.modData('Learnsets', 'buzzwole').learnset.destinybond = ['9M'];
		this.modData('Learnsets', 'buzzwole').learnset.dynamicpunch = ['9M'];
		this.modData('Learnsets', 'pheromosa').learnset.headsmash = ['9M'];
		this.modData('Learnsets', 'pheromosa').learnset.icefang = ['9M'];
		this.modData('Learnsets', 'pheromosa').learnset.icepunch = ['9M'];
		this.modData('Learnsets', 'pheromosa').learnset.moonlight = ['9M'];
		this.modData('Learnsets', 'xurkitree').learnset.poltergeist = ['9M'];
		this.modData('Learnsets', 'xurkitree').learnset.shadowpunch = ['9M'];
		this.modData('Learnsets', 'xurkitree').learnset.shoreup = ['9M'];
		this.modData('Learnsets', 'xurkitree').learnset.wildcharge = ['9M'];
		this.modData('Learnsets', 'xurkitree').learnset.metalsound = ['9M'];
		this.modData('Learnsets', 'celesteela').learnset.agility = ['9M'];
		this.modData('Learnsets', 'celesteela').learnset.crosschop = ['9M'];
