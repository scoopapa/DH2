...
tiersovereignmod: {
		...
		onBegin() {
			this.add(`raw|<img src="https://cdn.discordapp.com/attachments/406520870714998787/1418382418515333131/tiersovereignbanner.png" height="213" width="381">`);
			this.add('-message', `Welcome to Tier Soveriegn!`);
			this.add('-message', `This is a mod that revolves around a pokemon who is central to the tiers function, Lindwallow!`);
