...
export const Moves: {[k: string]: ModdedMoveData} = {
	...
	takedown: {
		inherit: true,
		basePower: 95, // any troders in chat?
		accuracy: 95,
	},
	gigadrain: { // meganium fans quaking
		inherit: true,
		basePower: 75,
		pp: 15,
	},
	...
	firespin: { // This could be a gigantic problem as it re-introduces sleeptrap with rapidash among other things. Keep a close fucking eye on this.
		inherit: true,
		basePower: 35,
		accuracy: 100,
	},
	...
	sunnyday: {
		inherit: true,
		pp: 10, // sunny day molt could be a bit strong
	},
	clamp: {
		inherit: true,
		accuracy: 100,
	},
	crabhammer: { // wowie zowie
		inherit: true,
		basePower: 110,
		accuracy: 100,
		pp: 15,
	...
	skyattack: { // yep it's that move
		inherit: true,
		onTryMove(attacker, defender, move) {}, // neutralises charge turn
		basePower: 120,
		accuracy: 85,
		pp: 10,
		critratio: 1, // make sure it's not using that later gen mechanic
	},
	poisonsting: {
		inherit: true,
		basePower: 25,
...
// Vanilla stuff starts here.
	beatup: {
		inherit: true,
		basePower: 20, // crystal legacy change
	...
	dig: {
		inherit: true,
		basePower: 70, // crystal legacy
		pp: 20, // crystal legacy
	...
	highjumpkick: {
		inherit: true,
		basePower: 100, // this is gonna make some people cry
	...
	outrage: {
		inherit: true,
		basePower: 110, // crystal legacy
		pp: 15, // crystal legacy
		onMoveFail(target, source, move) {
	...
	rest: {
		inherit: true,
		pp: 5, // crystal legacy, casually destroys a huge metagame point lol
		onTry(pokemon) {
	...
	thief: {
		inherit: true,
		basePower: 60, // crystal legacy; this is insane and will probably define some mons
		pp: 15, // crystal legacy
		onAfterHit() {},
		secondary: {
			chance: 100,
