export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	kingdra: {
		...
		otherFormes: ["Kingdra-Classic", "Kingdra-Brinepool", "Kingdra-Druid", "Kingdra-Bard", "Kingdra-Gourmet"/*, "Kingdra-"*/],
		formeOrder: ["Kingdra", "Kingdra-Classic", "Kingdra-Brinepool", "Kingdra-Druid", "Kingdra-Bard", "Kingdra-Gourmet"/*, "Kingdra-"*/],
	},
	kingdraclassic: {
		num: 230,
	...
	nidoqueen: {
		...
		otherFormes: ["Nidoqueen-Classic", "Nidoqueen-Erudite", "Nidoqueen-Volcanic", "Nidoqueen-Rosegold", "Nidoqueen-Shaman"/*, "Nidoqueen-"*/],
		formeOrder: ["Nidoqueen", "Nidoqueen-Classic", "Nidoqueen-Erudite", "Nidoqueen-Volcanic", "Nidoqueen-Rosegold", "Nidoqueen-Shaman"/*, "Nidoqueen-"*/],
	},
	nidoqueenclassic: {
		num: 31,
	...
	bisharp: {
		...
		otherFormes: ["Bisharp-Centurion", "Bisharp-Savage", "Bisharp-Ronin", "Bisharp-Mantis", "Bisharp-Revenant"/*, "Bisharp-"*/],
		formeOrder: ["Bisharp", "Bisharp-Centurion", "Bisharp-Savage", "Bisharp-Ronin", "Bisharp-Mantis", "Bisharp-Revenant"/*, "Bisharp-"*/],
	},
	bisharpcenturion: {
		num: 625,
	...
	corviknight: {
    	...
    	prevo: null,
		eggGroups: ["Flying"], */
		otherFormes: ["Corviknight-Thunderbird", "Corviknight-Genie", "Corviknight-Yeti", "Corviknight-Analytical", "Corviknight-Martian"/*, "Corviknight-"*/],
		formeOrder: ["Corviknight", "Corviknight-Thunderbird", "Corviknight-Genie", "Corviknight-Yeti", "Corviknight-Analytical", "Corviknight-Martian"/*, "Corviknight-"*/],
	},
	...
	krookodile: {
    	...
    	prevo: null,
		eggGroups: ["Field"], */
		otherFormes: ["Krookodile-Infernal", "Krookodile-Abyssal", "Krookodile-Wetlander", "Krookodile-Cave Dweller", "Krookodile-Cliffside"/*, "Krookodile-"*/],
		formeOrder: ["Krookodile", "Krookodile-Infernal", "Krookodile-Abyssal", "Krookodile-Wetlander", "Krookodile-Cave Dweller", "Krookodile-Cliffside"/*, "Krookodile-"*/],
	},
	krookodileinfernal: {
		num: 553,
	...
	ogerpon: {
		...
		color: "Green",
		eggGroups: ["Undiscovered"], */
		otherFormes: ["Ogerpon-Muerta", "Ogerpon-Easter", "Ogerpon-Ankh", "Ogerpon-Eid", "Ogerpon-Vessel"/*, "Ogerpon-"*/],
		formeOrder: ["Ogerpon", "Ogerpon-Muerta", "Ogerpon-Easter", "Ogerpon-Ankh", "Ogerpon-Eid", "Ogerpon-Vessel"/*, "Ogerpon-"*/],
		forceTeraType: null,
	},
	ogerponmuerta: {
		num: 1017,
