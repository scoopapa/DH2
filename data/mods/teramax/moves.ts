export const Moves: import('../../../sim/dex-moves').ModdedMoveDataTable = {
	...
	decorate: {
		inherit: true,
		shortDesc: "The user swaps all its stat stage changes with the target.",
	...
	appleacid: {
		...
		accuracy: 90,
		basePower: 80,
		shortDesc: "Has a 20% chance to poison the target. The user recovers 1/2 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
	...
	gravapple: {
		inherit: true,
		shortDesc: "Has a 100% chance to lower the target's Defense by 1 stage. Power is multiplied by 1.5 during Gravity's effect. If this move is resisted, it sets Gravity.",
	...
	noretreat: {
		inherit: true,
		shortDesc: "Once per switch-in, raises the user's Attack, Defense, Special Attack, Special Defense, and Speed by 1 stage. Fails if the user has already used this move.",
	...
	spicyextract: {
		...
		basePower: 80,
		category: "Physical",
		shortDesc: "Has a 100% chance to lower the target's Defense by 1 stage.",
	...
	hyperdrill: {
		inherit: true,
		shortDesc: "The user ignores the resistances to this move.",
	...
	psyblade: {
		inherit: true,
		shortDesc: "If the current terrain is Electric Terrain, this move's power is multiplied by 1.5. If there is no terrain active, this move will set Electric Terrain.",
	...
	tarshot: {
		...
		basePower: 80,
		category: "Special",
		shortDesc: "Has a 30% chance to burn the target. This move nullifies all abilities that mitigate the effects of Fire-type damage or the burn status (Flash Fire, Water Bubble, Thermal Exchange, Water Veil, Thick Fat, Steam Engine, Well-Baked Body, Heatproof, Purifying Salt).",
	...
	overdrive: {
		inherit: true,
		basePower: 85,
		shortDesc: "This move becomes a physical attack if the user's Attack is greater than its Special Attack, including stat stage changes.",
	...
	grassknot: {
		inherit: true,
		shortDesc: "This move's power is 20 if the target weighs less than 10 kg, 40 if less than 25 kg, 60 if less than 50 kg, 80 if less than 100 kg, 100 if less than 200 kg, and 120 if greater than or equal to 200 kg or if the target is Dynamax or Gigantamax.",
	...
	heatcrash: {
		inherit: true,
		shortDesc: "The power of this move depends on (user's weight / target's weight), rounded down. Power is equal to 120 if the result is 5 or more, 100 if 4, 80 if 3, 60 if 2, and 40 if 1 or less or if the target is Dynamax or Gigantamax. Damage doubles and no accuracy check is done if the target has used Minimize while active.",
		basePowerCallback(pokemon, target) {
			const targetWeight = target.getWeight();
...
// Max and GMax Moves
	gmaxbefuddle: {
		...
		shortDesc: "If the target uses a Fire-type move in the next 3 turns, it is prevented from executing and the target loses 1/4 of its maximum HP, rounded half up. This effect does not happen if the Fire-type move is prevented by Primordial Sea.",
	...
	gmaxcannonade: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the user gains the Aqua Ring effect, healing it by 1/8 of its maximum HP, rounded down.",
	...
	gmaxchistrike: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, each Pokemon on the user's side has their critical hit ratio raised by 1 stage, even if they have a substitute.",
	...
	gmaxcuddle: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, each Pokemon on the target becomes infatuated, even if they have a substitute. This effect does not happen if the target is already infatuated.",
	...
	gmaxdepletion: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, each Pokemon on the opposing side loses 2 PP from its last move used, even if they have a substitute. This Pokemon heals the total PP of the target's moves * 2 in HP.",
	...
	gmaxfinale: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, each Pokemon on the user's side restores 1/6 of its current maximum HP, even if they have a substitute.",
	...
	gmaxfireball: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful and the user has not fainted, the user switches out even if it is trapped and is replaced immediately by a selected party member. The user does not switch out if there are no unfainted party members, or if the target switched out using an Eject Button or through the effect of the Emergency Exit or Wimp Out Abilities.",
	...
	gmaxfoamburst: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the Speed of target is lowered by 1 stages, even if they have a substitute.",
	...
	gmaxgoldrush: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "Hits two to five times. Has a 35% chance to hit two or three times and a 15% chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times.",
	...
	gmaxgravitas: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the effect of Gravity begins.",
	...
	gmaxhydrosnipe: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "Fails if the target did not select a physical attack, special attack, or Me First for use this turn, or if the target moves before the user.",
	...
	gmaxmalodor: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the target becomes badly poisoned, even if they have a substitute.",
	...
	gmaxmeltdown: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the effect of Torment begins for each Pokemon on the opposing side, even if they have a substitute.",
	...
	gmaxoneblow: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "This move bypasses all protection effects, except Max Guard.",
	...
	gmaxrapidflow: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "Hits 3 times. This move bypasses all protection effects, except Max Guard.",
	...
	gmaxreplenish: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the user restores its changes the target's item with an Iapapa Berry and consumes it, even if they have a substitute.",
	...
	gmaxresonance: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "This move's type effectiveness against Water is changed to be super effective no matter what this move's type is.",
	...
	gmaxsmite: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the effects of Light Screen begin.",
	...
	gmaxsnooze: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If an opposing Pokemon switches out this turn, this move hits that Pokemon before it leaves the field, even if it was not the original target. If the user moves after an opponent using Flip Turn, Parting Shot, Teleport, U-turn, or Volt Switch, but not Baton Pass, it will hit that opponent before it leaves the field. Power doubles and no accuracy check is done if the user hits an opponent switching out, and the user's turn is over; if an opponent faints from this, the replacement Pokemon does not become active until the end of the turn.",
	...
	gmaxstunshock: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the target becomes poisoned (if user is Toxtricity-Amped) or paralyzed (if user is Toxtricity-Low-Key), even if they have a substitute.",
	...
	gmaxsweetness: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, each Pokemon on the user's side has its status condition cured, even if they have a substitute.",
	...
	gmaxtartness: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the target loses its held item, even if they have a substitute. This move cannot cause Pokemon with the Sticky Hold Ability to lose their held item or cause a Kyogre, a Groudon, a Giratina, an Arceus, a Genesect, a Silvally, a Zacian, or a Zamazenta to lose their Blue Orb, Red Orb, Griseous Orb, Plate, Drive, Memory, Rusted Sword, or Rusted Shield respectively. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
	...
	gmaxterror: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, there is a 30% chance to poison the target, even if they have a substitute.",
	...
	gmaxvinelash: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, it inflicts the target with Leech Seed, even if they have a substitute.",
	...
	gmaxvolcalith: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the effectiveness of Fire-type moves against the target is doubled against it, even if they have a substitute.",
	...
	gmaxvoltcrash: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the target becomes paralyzed, even if they have a substitute.",
	...
	gmaxwildfire: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the target becomes burned, even if they have a substitute. This move becomes a physical attack if the user's Attack is greater than its Special Attack, including stat stage changes.",
	...
	gmaxwindrage: {
		...
		category: "Physical",
		isNonstandard: "Gigantamax",
		shortDesc: "If this move is successful, the effects of Electric Terrain, Grassy Terrain, Misty Terrain, and Psychic Terrain end, the effects of Reflect, Light Screen, Aurora Veil, Safeguard, Mist, G-Max Steelsurge, Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the target's side, and the effects of G-Max Steelsurge, Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the user's side. Additionally, it heals 1/4 of its max HP when it removes hazards, screens or terrain.",
	...
	maxhailstorm: {
		...
		category: "Physical",
		isNonstandard: "Past",
		shortDesc: "Power is equal to the base move's Max Move power. If this move is successful, the effect of Snow begins. This effect does not happen if the user is not Dynamaxed. If this move is used as a base move, it deals damage with a power of 0.",
