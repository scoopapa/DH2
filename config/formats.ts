...
export const Formats: FormatList = [
	...
	},
	{
		...
		unbanlist: [
			...
			'Mamoswine', 'Roserade', 'Leafeon', 'Dusknoir', 'Slowbro-Galar', 'Mismagius', 'Honchkrow', 'Budew', 'Ambipom', 'Chingling', 'Munchlax', 'Weavile', 'Happiny', 'Lickilicky', 'Tangrowth', 'Magmortar', 'Togekiss', 'Yanmega', 'Porygon-Z', 'Magnezone', 'Gallade', 'Froslass', 'Probopass',
	...
	*/
	...
	},
	{
		...
		unbanlist: [
			...
			//Pokémon
			'Snover', 'Frillish', 'Tynamo', 'Eelektrik', 'Type: Null', 'Silvally-Bug', 'Silvally-Dark',
			'Silvally-Dragon', 'Silvally-Electric', 'Silvally-Fire', 'Silvally-Grass', 'Silvally-Ice', 
			'Silvally-Poison', 'Silvally-Psychic', 'Silvally-Rock', 'Silvally-Water', 'Golett', 'Geodude-Alola', 'Graveler-Alola', 'Croagunk', 
			'Crabrawler', 'Starly', 'Staravia', 'Fletchling', 'Fletchinder', 'Stunky', 'Skuntank', 'Sylveon',
			'Buneary', 'Chespin', 'Quilladin',
			'Litten', 'Torracat', 'Mr. Mime-Galar', 'Mime Jr.',
			'Slowpoke-Galar', 'Marowak-Alola', 'Marowak-Alola-Totem',
			'Milcery',
			'Leafeon', 'Slowbro-Galar', 'Mismagius', 'Honchkrow', 'Budew', 'Ambipom', 'Chingling', 'Munchlax', 'Weavile', 'Happiny', 'Lickilicky', 'Tangrowth', 'Togekiss', 'Yanmega', 'Gallade', 'Probopass',
			'Rattata-Alola', 'Raticate-Alola', 'Persian-Alola', 'Diglett-Alola', 'Meowth-Alola', 'Meowth-Galar', 'Perrserker', 'Grimer-Alola', 'Muk-Alola', 'Exeggutor-Alola', 'Farfetchd-Galar', 'Weezing-Galar', 'Zigzagoon-Galar', 'Linoone-Galar', 'Corsola-Galar', 'Cursola', 'Vulpix-Alola', 'Ninetales-Alola', 'Sandshrew-Alola', 'Sandslash-Alola', 'Ponyta-Galar', 'Rapidash-Galar',
			'Mantyke', 'Bonsly',
			'Skrelp', 'Sandile', 'Krokorok', 'Wimpod', 'Impidimp', 'Morgrem',
