	...
	},
{
	...
	},
	{
		...
		banlist: [
			...
			'Baton Pass', 'Lycanroc-Base + Dusk Lycanite', 'Lycanroc-Base + Midnight Lycanite', 'Lycanroc-Midnight + Midday Lycanite', 'Lycanroc-Midnight + Dusk Lycanite',
			'Lycanroc-Dusk + Midday Lycanite', 'Lycanroc-Dusk + Midnight Lycanite', 'Raichu-Alola + Raichunite', 'Slowbro-Galar + Slowbronite', 'Slowking-Galar + Slowkinite',
		],
		unbanlist: ['Zarude'],
		mod: 'm4av6',
	},
	...
	},
	{
		...
		unbanlist: [
			...
			'Perrserker', 'Cursola', 'Runerigus', 'Morpeko', 'Arctovish', 'Arctozolt', 'Dracozolt', 'Dreepy', 'Drakloak', 'Dragapult', 'Zarude', 'Spectrier',
		],
		mod: 'm4av6',
		searchShow: false,
	},
