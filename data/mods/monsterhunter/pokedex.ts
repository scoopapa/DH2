export const Pokedex: {[k: string]: ModdednameData} = {
	...
	almudron: {
		...
		abilities: {0: "Mold Breaker", H: "Earth Eater"},
		heightm: 1.0,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field"],
	...
	barioth: {
		...
		name: "Barioth",
		types: ["Ice", "Flying"],
		baseStats: {hp: 103, atk: 120, def: 83, spa: 78, spd: 90, spe: 91},
	...
	barroth: {
		...
		abilities: {0: "Earth Eater", H: "Sand Stream"},
		heightm: 1.0,
		weightkg: 105.8,
		color: "Black",
		eggGroups: ["Field"],
	...
	tetsucabra: {
		...
		abilities: {0: "Strong Jaw", H: "Stamina"},
		heightm: 1.0,
		weightkg: 110.0,
		color: "Black",
		eggGroups: ["Field"],
