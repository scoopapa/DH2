export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	kingdra: {
		...
		otherFormes: ["Kingdra-Brinepool", "Kingdra-Druid"/*, "Kingdra-", "Kingdra-", "Kingdra-"*/],
		formeOrder: ["Kingdra", "Kingdra-Brinepool", "Kingdra-Druid"/*, "Kingdra-", "Kingdra-", "Kingdra-"*/],
	},
	kingdrabrinepool: {
		num: 230,
	...
	nidoqueen: {
		...
		otherFormes: ["Nidoqueen-Erudite", "Nidoqueen-Volcanic"/*, "Nidoqueen-", "Nidoqueen-", "Nidoqueen-"*/],
		formeOrder: ["Nidoqueen", "Nidoqueen-Erudite", "Nidoqueen-Volcanic"/*, "Nidoqueen-", "Nidoqueen-", "Nidoqueen-"*/],
	},
	nidoqueenerudite: {
		num: 31,
	...
	bisharp: {
		...
		otherFormes: ["Bisharp-Savage", "Bisharp-Ronin"/*, "Bisharp-", "Bisharp-", "Bisharp-"*/],
		formeOrder: ["Bisharp", "Bisharp-Savage", "Bisharp-Ronin"/*, "Bisharp-", "Bisharp-", "Bisharp-"*/],
	},
	bisharpsavage: {
		num: 625,
		name: "Bisharp-Savage",
	...
	corviknight: {
    	...
    	prevo: null,
		eggGroups: ["Flying"],
		otherFormes: ["Corviknight-Genie", "Corviknight-Yeti"/*, "Corviknight-", "Corviknight-", "Corviknight-"*/],
		formeOrder: ["Corviknight", "Corviknight-Genie", "Corviknight-Yeti"/*, "Corviknight-", "Corviknight-", "Corviknight-"*/],
	},
	corviknightgenie: {
		num: 823,
	...
	krookodile: {
    	...
    	prevo: null,
		eggGroups: ["Field"],
		otherFormes: ["Krookodile-Abyssal", "Krookodile-Wetlander"/*, "Krookodile-", "Krookodile-", "Krookodile-"*/],
		formeOrder: ["Krookodile", "Krookodile-Abyssal", "Krookodile-Wetlander"/*, "Krookodile-", "Krookodile-", "Krookodile-"*/],
	},
	krookodileabyssal: {
		num: 553,
	...
	ogerpon: {
		...
		color: "Green",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Ogerpon-Easter", "Ogerpon-Ankh"/*, "Ogerpon-", "Ogerpon-", "Ogerpon-"*/],
		formeOrder: ["Ogerpon", "Ogerpon-Easter", "Ogerpon-Ankh"/*, "Ogerpon-", "Ogerpon-", "Ogerpon-"*/],
		forceTeraType: null,
	},
	ogerponeaster: {
		num: 1017,
