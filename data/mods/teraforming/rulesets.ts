export const Rulesets: import('../../../sim/dex-formats').ModdedFormatDataTable = {
	terastalclause: {
		...
		banlist: ['Samurott-Base + Tera Shard', 'Samurott-Base + Poke Ball', 'Weezing-Base + Tera Shard', 'Weezing-Base + Poke Ball', 'Basculegion-Base + Tera Shard', 'Basculegion-Base + Poke Ball', 'Goodra-Hisui + Tera Shard', 'Goodra-Hisui + Poke Ball', 'Avalugg-Hisui + Tera Shard', 'Avalugg-Hisui + Poke Ball'],
		onBegin() {
	...
	megadatamod: {
		...
		onSwitchIn(pokemon) {
			if (pokemon.illusion) {
				if (pokemon.illusion.species.forme.startsWith('Mega') || pokemon.illusion.species.forme.startsWith('Tera') || 
					 pokemon.illusion.species.forme.startsWith('Ultra')
					) {
