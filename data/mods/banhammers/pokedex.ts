export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	...
	pawmi: {
		...
		abilities: {0: "Natural Cure", H: "Iron Fist"},
		heightm: 0.3,
		weightkg: 2.5,
		color: "Yellow",
		evos: ["Pawmo"],
	...
	nacli: {
		...
		abilities: {0: "Sturdy", H: "Clear Body"},
		heightm: 0.4,
		weightkg: 16,
		color: "Brown",
		evos: ["Naclstack"],
	...
	bellibolt: {
		...
		abilities: {0: "Electromorphosis", H: "Damp"},
		heightm: 1.2,
		weightkg: 113,
		color: "Green",
		prevo: "Tadbulb",
