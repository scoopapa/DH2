...
// start: Ma'adowr
{
	...
	},
	{
		...
		threads: [],
		mod: 'monsterhunter',
		ruleset: ['Standard NatDex', 'Data Mod', 'Status Mod'],
		banlist: [],
		onBegin() {
		...
		onValidateTeam(team, format) {
			/**@type {{[k: string]: true}}*/
			let speciesTable = {};
			let allowedTiers = ['MHAG', 'MHOU', 'MHUU', 'MHRU'];
			for (const set of team) {
				let template = this.dex.species.get(set.species);
				if (!allowedTiers.includes(template.tier)) {
	 ...
	 },
	 {
		...
		mod: 'monsterhunter',
		gameType: 'doubles',
		ruleset: ['Standard NatDex', 'Data Mod', 'Status Mod', 'OHKO Clause', 'Evasion Clause', 'Species Clause', 'Sleep Clause Mod', 'Terastal Clause', 'Baton Pass Clause'],
	 ...
	 },
	 {
		...
		mod: 'monsterhunter',
		gameType: 'freeforall',
		ruleset: ['Standard NatDex', 'Data Mod', 'Status Mod', 'OHKO Clause', 'Evasion Clause', 'Species Clause', 'Sleep Clause Mod', 'Baton Pass Clause'],
