export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	kingdra: {
		...
		otherFormes: ["Kingdra-Classic", "Kingdra-Brinepool", "Kingdra-Druid", "Kingdra-Bard"/*, "Kingdra-", "Kingdra-"*/],
		formeOrder: ["Kingdra", "Kingdra-Classic", "Kingdra-Brinepool", "Kingdra-Druid", "Kingdra-Bard"/*, "Kingdra-", "Kingdra-"*/],
	},
	kingdraclassic: {
		num: 230,
	...
	nidoqueen: {
		...
		otherFormes: ["Nidoqueen-Classic", "Nidoqueen-Erudite", "Nidoqueen-Volcanic", "Nidoqueen-Rosegold"/*, "Nidoqueen-", "Nidoqueen-"*/],
		formeOrder: ["Nidoqueen", "Nidoqueen-Classic", "Nidoqueen-Erudite", "Nidoqueen-Volcanic", "Nidoqueen-Rosegold"/*, "Nidoqueen-", "Nidoqueen-"*/],
	},
	nidoqueenclassic: {
		num: 31,
	...
	bisharp: {
		...
		otherFormes: ["Bisharp-Centurion", "Bisharp-Savage", "Bisharp-Ronin", "Bisharp-Mantis"/*, "Bisharp-", "Bisharp-"*/],
		formeOrder: ["Bisharp", "Bisharp-Centurion", "Bisharp-Savage", "Bisharp-Ronin", "Bisharp-Mantis"/*, "Bisharp-", "Bisharp-"*/],
	},
	bisharpcenturion: {
		num: 625,
	...
	corviknight: {
    	...
    	prevo: null,
		eggGroups: ["Flying"], */
		otherFormes: ["Corviknight-Thunderbird", "Corviknight-Genie", "Corviknight-Yeti", "Corviknight-Analytical"/*, "Corviknight-", "Corviknight-"*/],
		formeOrder: ["Corviknight", "Corviknight-Thunderbird", "Corviknight-Genie", "Corviknight-Yeti", "Corviknight-Analytical"/*, "Corviknight-", "Corviknight-"*/],
	},
	...
	krookodile: {
    	...
    	prevo: null,
		eggGroups: ["Field"], */
		otherFormes: ["Krookodile-Infernal", "Krookodile-Abyssal", "Krookodile-Wetlander", "Krookodile-Cave Dweller"/*, "Krookodile-", "Krookodile-"*/],
		formeOrder: ["Krookodile", "Krookodile-Infernal", "Krookodile-Abyssal", "Krookodile-Wetlander", "Krookodile-Cave Dweller"/*, "Krookodile-", "Krookodile-"*/],
	},
	krookodileinfernal: {
		num: 553,
	...
	ogerpon: {
		...
		color: "Green",
		eggGroups: ["Undiscovered"], */
		otherFormes: ["Ogerpon-Muerta", "Ogerpon-Easter", "Ogerpon-Ankh", "Ogerpon-Eid"/*, "Ogerpon-", "Ogerpon-"*/],
		formeOrder: ["Ogerpon", "Ogerpon-Muerta", "Ogerpon-Easter", "Ogerpon-Ankh", "Ogerpon-Eid"/*, "Ogerpon-", "Ogerpon-"*/],
		forceTeraType: null,
	},
	ogerponmuerta: {
		num: 1017,
