export const Scripts: {[k: string]: ModdedBattleScriptsData} = {
	init: function () {
		...
		this.modData('Learnsets', 'sawsbuck-summer').learnset.flameburst = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-summer').learnset.flamethrower = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-summer').learnset.growth = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-summer').learnset.leafstorm = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-summer').learnset.overheat = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-autumn').learnset.petalblizzard = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-autumn').learnset.poltergeist = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-autumn').learnset.shadowsneak = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-autumn').learnset.strengthsap = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-autumn').learnset.trickortreat = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-winter').learnset.blizzard = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-winter').learnset.freezedry = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-winter').learnset.icebeam = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-winter').learnset.iceshard = ['7L1'];
		this.modData('Learnsets', 'sawsbuck-winter').learnset.iciclecrash = ['7L1'];
