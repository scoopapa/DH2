export const Moves: {[k: string]: ModdedMoveData} = {
	...
	strengthen: {
		...
		shortDesc: "Raises the user's Attackk and evasion by 1.",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: {},
	...
	upbeat: {
		...
		category: "Physical",
		name: "Upbeat",
		desc: "Has a 75% chance to raises the user's Speed and Attack by 1 stage.",
		shortDesc: "75% chance to raises the user's Spe and Atk by 1.",
		pp: 10,
		noPPBoosts: true,
		priority: 0,
		flags: {contact: 1},
	...
	cookiecontrol: {
		...
		category: "Status",
		name: "Cookie Control",
		desc: "Lowers the target's Attackk, Defense and Speed by 2 stages.",
		shortDesc: "Lowers the target's Atk, Def and Spe by 2.",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
