export const Pokedex: { [k: string]: ModdedSpeciesData } = {
	...
	parascent: {
		...
		movepoolAdditions: ["earthpower", "subdued"],
		category: "Mushroom",
		heightm: 2.0,
		weightkg: 91.3,
		color: "Green",
	...
	pinsirmaadowr: {
		...
		movepoolAdditions: ["fissure", "headlongrush", "spikes", "upperhand"],
	...
	kabujatsu: {
		...
		abilities: {0: "Natural Cure", 1: "Mold Breaker", H: "Filter"},
		movepoolAdditions: ["bodypress", "firstimpression", "fissure", "hasamiwaza", "headlongrush", "heavyslam", "spikes", "upperhand"],
