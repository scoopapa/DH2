export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	...
	escavalier: {
		...
		name: "Escavalier",
		types: ["Bug", "Rock"],
		baseStats: {hp: 70, atk: 135, def: 105, spa: 60, spd: 60, spe: 20},
		abilities: {},
		heightm: 1,
		weightkg: 33,
		color: "Gray",
	...
	ralts: {
		...
		baseStats: {hp: 18, atk: 25, def: 25, spa: 45, spd: 45, spe: 40},
		abilities: {},
		heightm: 0.4,
		weightkg: 6.6,
		color: "White",
	...
	kirlia: {
		...
		name: "Kirlia",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 28, atk: 35, def: 35, spa: 65, spd: 65, spe: 50},
		abilities: {},
		heightm: 0.8,
		weightkg: 20.2,
		color: "White",
	...
	gardevoir: {
		...
		name: "Gardevoir",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 48, atk: 65, def: 65, spa: 125, spd: 125, spe: 80},
		abilities: {},
		heightm: 1.6,
		weightkg: 48.4,
		color: "White",
