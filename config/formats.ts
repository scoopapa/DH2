	...
	},
{
	...
	},
	{
		...
		ruleset: ['Standard', 'Obtainable', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod'],
		banlist: [
		...
		unbanlist: [
			...
			'Xatu', 'Nosepass', 'Probopass', 'Pyukumuku', 'Chinchou', 'Lanturn', 'Type: Null', 'Silvally', 'Poipole', 'Zygarde', 'Trubbish', 'Garbodor', 'Minccino',
