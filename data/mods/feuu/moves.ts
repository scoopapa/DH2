		...
		condition: {
			...
			onStart(pokemon) {
				...
				if (
					...
					|| pokemon.hasAbility('aerialbreak') || pokemon.hasAbility('levimetal') || pokemon.hasAbility('hoverboard') || pokemon.hasAbility('levistatic') || pokemon.hasAbility('lovelessfloat')
				) applies = true;
	...
	thousandarrows: {
		...
		onModifyMove(move, source, target) {
			if (target.hasAbility('magneticwaves') || target.hasAbility('leviflame') 
					...
					|| target.hasAbility('aerialbreak') || target.hasAbility('levimetal') || target.hasAbility('hoverboard') || target.hasAbility('levistatic') || target.hasAbility('lovelessfloat')) {
	...
	stickyweb: {
		...
		condition: {
			...
			onSwitchIn(pokemon) {
				...
				if (pokemon.hasAbility('etativel') || pokemon.hasAbility('lighthearted') || pokemon.hasAbility('clearlyfloating') || pokemon.hasAbility('aerialbreak') || pokemon.hasAbility('levimetal') || pokemon.hasAbility('hoverboard') || pokemon.hasAbility('levistatic') || pokemon.hasAbility('lovelessfloat')) return;
