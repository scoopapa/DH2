export const Scripts: ModdedBattleScriptsData = {
  ...
  init() {
    ...
    this.modData('Learnsets', 'mew').learnset.flamingsphere = ['9M'];
    ...
    this.modData('Learnsets', 'mew').learnset.fireball = ['9M'];
    ...
    this.modData('Learnsets', 'mew').learnset.backfire = ['9M'];
    ...
    this.modData('Learnsets', 'mew').learnset.highwater = ['9M'];
    ...
    this.modData('Learnsets', 'mew').learnset.parallelcircuit = ['9M'];
    ...
    // chistrike 
    this.modData('Learnsets', 'machop').learnset.chistrike = ['9L1'];
    this.modData('Learnsets', 'makuhita').learnset.chistrike = ['9L1'];
    this.modData('Learnsets', 'infernape').learnset.chistrike = ['9L1'];
    this.modData('Learnsets', 'riolu').learnset.chistrike = ['9L1'];
    this.modData('Learnsets', 'mienfoo').learnset.chistrike = ['9L1'];
    this.modData('Learnsets', 'sawk').learnset.chistrike = ['9L1'];
    this.modData('Learnsets', 'throh').learnset.chistrike = ['9L1'];
    this.modData('Learnsets', 'kubfu').learnset.chistrike = ['9L1'];
    ...
    this.modData('Learnsets', 'mew').learnset.dissolution = ['9M'];
    ...
    this.modData('Learnsets', 'braviaryhisui').learnset.downdraft = ['9L1'];
    ...
    // punishingblow 
    this.modData('Learnsets', 'venusaur').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'banette').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'froslass').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'golurk').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'trevenant').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'decidueye').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'mimikyu').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'dhelmise').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'blacephalon').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'basculegion').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'basculegionf').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'annihilape').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'paranormear').learnset.punishingblow = ['9M'];
    this.modData('Learnsets', 'slendawful').learnset.punishingblow = ['9M'];
    ...
    // martialpunch 
    this.modData('Learnsets', 'machamp').learnset.martialpunch = ['9L1'];
    this.modData('Learnsets', 'poliwrath').learnset.martialpunch = ['9L1'];
    this.modData('Learnsets', 'hitmonchan').learnset.martialpunch = ['9L1'];
    this.modData('Learnsets', 'hariyama').learnset.martialpunch = ['9L1'];    
    this.modData('Learnsets', 'infernape').learnset.martialpunch = ['9L1'];
    this.modData('Learnsets', 'lucario').learnset.martialpunch = ['9L1'];   
    this.modData('Learnsets', 'azelf').learnset.martialpunch = ['9L1'];
    this.modData('Learnsets', 'throh').learnset.martialpunch = ['9L1'];   
    this.modData('Learnsets', 'sawk').learnset.martialpunch = ['9L1'];
    this.modData('Learnsets', 'mienshao').learnset.martialpunch = ['9L1'];   
    this.modData('Learnsets', 'hawlucha').learnset.martialpunch = ['9L1'];   
    this.modData('Learnsets', 'buzzwole').learnset.martialpunch = ['9L1'];   
    ...
    this.modData('Learnsets', 'beedrill').learnset.bugbuzz = ['9L1']; // ZA addition
    this.modData('Learnsets', 'beedrill').learnset.lunge = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'clefable').learnset.healblock = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'wigglytuff').learnset.moonblast = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'persian').learnset.versatiledance = ['9L1'];
    ...
    this.modData('Learnsets', 'persianalola').learnset.versatiledance = ['9L1'];
    this.modData('Learnsets', 'persianalola').learnset.spikes = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'poliwrath').learnset.courtchange = ['9L1'];
    ...
    this.modData('Learnsets', 'victreebel').learnset.toxicspikes = ['9L1']; // ZA addition
    this.modData('Learnsets', 'tentacruel').learnset.mortalspin = ['9L1'];
    ...
    this.modData('Learnsets', 'slowbro').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'slowbro').learnset.powergem = ['9L1']; // ZA addition
    this.modData('Learnsets', 'slowbrogalar').learnset.corrosiveacid = ['9L1'];
    this.modData('Learnsets', 'slowbrogalar').learnset.toxicspikes = ['9L1']; // ZA addition
    this.modData('Learnsets', 'slowbrogalar').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'slowbrogalar').learnset.firepunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'slowbrogalar').learnset.thunderpunch = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'gengar').learnset.shadowsneak = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'starmie').learnset.selfdestruct = ['9L1']; // ZA addition
    this.modData('Learnsets', 'starmie').learnset.safeguard = ['9L1']; // ZA addition
    this.modData('Learnsets', 'starmie').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'starmie').learnset.tripleaxel = ['9L1']; // ZA addition
    this.modData('Learnsets', 'mrmime').learnset.firstimpression = ['9L1']; // ZA addition
    this.modData('Learnsets', 'mrmimegalar').learnset.firstimpression = ['9L1']; // ZA addition
    this.modData('Learnsets', 'pinsir').learnset.megahorn = ['9L1'];
    this.modData('Learnsets', 'pinsir').learnset.lunge = ['9L1']; // ZA addition
    this.modData('Learnsets', 'pinsir').learnset.aerialace = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'gyarados').learnset.dragonrush = ['9L1']; // ZA addition
    this.modData('Learnsets', 'eevee').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'eevee').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'eevee').learnset.versatiledance = ['9L1'];
    this.modData('Learnsets', 'vaporeon').learnset.bouncybubble = ['9L1'];
    this.modData('Learnsets', 'vaporeon').learnset.taunt = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'flareon').learnset.swordsdance = ['9L1']; // ZA addition
    this.modData('Learnsets', 'flareon').learnset.taunt = ['9L1']; // ZA addition
    this.modData('Learnsets', 'flareon').learnset.flamewheel = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'ariados').learnset.firstimpression = ['9L1']; // ZA addition
    this.modData('Learnsets', 'crobat').learnset.knockoff = ['9L1']; // ZA addition
    this.modData('Learnsets', 'lanturn').learnset.tailglow = ['9L1'];
    this.modData('Learnsets', 'ampharos').learnset.wish = ['9L1'];
    this.modData('Learnsets', 'ampharos').learnset.milkdrink = ['9L1'];
    this.modData('Learnsets', 'ampharos').learnset.flashcannon = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'espeon').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'espeon').learnset.safeguard = ['9L1']; // ZA addition
    this.modData('Learnsets', 'umbreon').learnset.baddybad = ['9L1'];
    this.modData('Learnsets', 'umbreon').learnset.nightdaze = ['9L1'];
    this.modData('Learnsets', 'umbreon').learnset.knockoff = ['9L1']; // ZA addition
    this.modData('Learnsets', 'murkrow').learnset.partingshot = ['9L1'];
    this.modData('Learnsets', 'slowkinggalar').learnset.corrosiveacid = ['9L1'];
    this.modData('Learnsets', 'heracross').learnset.outrage = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'sableye').learnset.partingshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sableye').learnset.nightslash = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sableye').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sableye').learnset.safeguard = ['9L1']; // ZA addition
    this.modData('Learnsets', 'mawile').learnset.dazzlinggleam = ['9L1']; // ZA addition
    this.modData('Learnsets', 'medicham').learnset.agility = ['9L1']; // ZA addition
    this.modData('Learnsets', 'medicham').learnset.blazekick = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'seviper').learnset.versatiledance = ['9L1']; 
    ...
    this.modData('Learnsets', 'banette').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'banette').learnset.zenheadbutt = ['9L1']; // ZA addition
    this.modData('Learnsets', 'banette').learnset.vacuumwave = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'absol').learnset.versatiledance = ['9L1']; 
    this.modData('Learnsets', 'glalie').learnset.rapidspin = ['9L1'];
    this.modData('Learnsets', 'glalie').learnset.ironhead = ['9L1']; // ZA addition
    ...
    // Gen 4:
    this.modData('Learnsets', 'torterra').learnset.scaredyshell = ['9L1'];
    this.modData('Learnsets', 'staraptor').learnset.intrepidcrash = ['9L1'];
    this.modData('Learnsets', 'staraptor').learnset.blazekick = ['9L1']; // ZA addition
    this.modData('Learnsets', 'staraptor').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'staraptor').learnset.knockoff = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'roserade').learnset.mortalspin = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'lopunny').learnset.machpunch = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'toxicroak').learnset.versatiledance = ['9L1']; 
    ...
    this.modData('Learnsets', 'abomasnow').learnset.icehammer = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'leafeon').learnset.taunt = ['9L1']; // ZA addition
    this.modData('Learnsets', 'glaceon').learnset.freezyfrost = ['9L1'];
    this.modData('Learnsets', 'glaceon').learnset.taunt = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'porygonz').learnset.voltswitch = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'froslass').learnset.phantomforce = ['9L1']; // ZA addition
    this.modData('Learnsets', 'froslass').learnset.healblock = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'rotom').learnset.paraboliccharge = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'heatran').learnset.firstimpression = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'darkrai').learnset.vacuumwave = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'emboar').learnset.flamewheel = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'watchog').learnset.doubleedge = ['9L1']; // ZA addition
    this.modData('Learnsets', 'watchog').learnset.endure = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'purrloin').learnset.partingshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'purrloin').learnset.firstimpression = ['9L1']; // ZA addition
    this.modData('Learnsets', 'liepard').learnset.partingshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'liepard').learnset.firstimpression = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'simisage').learnset.endure = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'simisage').learnset.flamewheel = ['9L1']; // ZA addition
    this.modData('Learnsets', 'simisage').learnset.endure = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'simisage').learnset.endure = ['9L1']; // ZA addition
    this.modData('Learnsets', 'simisage').learnset.flipturn = ['9L1']; // ZA addition
    this.modData('Learnsets', 'simisage').learnset.liquidation = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'throh').learnset.ironhead = ['9L1']; // ZA addition
    this.modData('Learnsets', 'throh').learnset.closecombat = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sawk').learnset.machpunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sawk').learnset.ironhead = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sawk').learnset.drainpunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'leavanny').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'whirlipede').learnset.mortalspin = ['9L1']; // ZA addition
    this.modData('Learnsets', 'scolipede').learnset.uturn = ['9L1']; // ZA addition
    this.modData('Learnsets', 'scolipede').learnset.gunkshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'scolipede').learnset.firstimpression = ['9L1']; // ZA addition
    this.modData('Learnsets', 'scolipede').learnset.mortalspin = ['9L1']; // ZA addition
    this.modData('Learnsets', 'scolipede').learnset.trailblaze = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'krookodile').learnset.ironhead = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'darmanitan').learnset.fissure = ['9L1'];
    this.modData('Learnsets', 'darmanitangalar').learnset.fissure = ['9L1'];
    ...
    this.modData('Learnsets', 'scraggy').learnset.partingshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'scrafty').learnset.partingshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'scrafty').learnset.dynamicpunch = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'cofagrigus').learnset.partingshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'cofagrigus').learnset.stealthrock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'carracosta').learnset.wavecrash = ['9L1'];
    this.modData('Learnsets', 'trubbish').learnset.poisonjab = ['9L1']; // ZA addition
    this.modData('Learnsets', 'garbodor').learnset.poisonjab = ['9L1']; // ZA addition
    this.modData('Learnsets', 'garbodor').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'garbodor').learnset.bulletseed = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'sawsbuck').learnset.seasonpass = ['9L1'];
    ...
    this.modData('Learnsets', 'foongus').learnset.toxicspikes = ['9L1']; // ZA addition
    this.modData('Learnsets', 'foongus').learnset.firstimpression = ['9L1']; // ZA addition
    this.modData('Learnsets', 'amoonguss').learnset.toxicspikes = ['9L1']; // ZA addition
    this.modData('Learnsets', 'amoonguss').learnset.firstimpression = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'eelektross').learnset.waterfall = ['9L1']; // ZA addition
    this.modData('Learnsets', 'beheeyem').learnset.focusblast = ['9L1'];
    this.modData('Learnsets', 'chandelure').learnset.flamewheel = ['9L1']; // ZA addition
    this.modData('Learnsets', 'chandelure').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'beartic').learnset.mountaingale = ['9L1'];
    this.modData('Learnsets', 'accelgor').learnset.taunt = ['9L1'];
    this.modData('Learnsets', 'stunfiskgalar').learnset.irondefense = ['9L1']; // ZA addition
    this.modData('Learnsets', 'stunfiskgalar').learnset.crunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'stunfiskgalar').learnset.icefang = ['9L1']; // ZA addition
    this.modData('Learnsets', 'stunfiskgalar').learnset.flashcannon = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'golurk').learnset.fissure = ['9L1']; // ZA addition
    this.modData('Learnsets', 'golurk').learnset.ironhead = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'braviary').learnset.intrepidcrash = ['9L1'];
    ...
    this.modData('Learnsets', 'terrakion').learnset.headsmash = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'greninja').learnset.vacuumwave = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'greninjabond').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'diggersby').learnset.drainpunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'talonflame').learnset.flamewheel = ['9L1']; // ZA addition
    this.modData('Learnsets', 'talonflame').learnset.whirlwind = ['9L1']; // ZA addition
    this.modData('Learnsets', 'talonflame').learnset.vacuumwave = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'floetteeternal').learnset.drainingkiss = ['9L1']; // ZA addition
    this.modData('Learnsets', 'floetteeternal').learnset.hyperbeam = ['9L1']; // ZA addition
    this.modData('Learnsets', 'floetteeternal').learnset.lightscreen = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'pangoro').learnset.gigadrain = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'furfrou').learnset.crunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'furfrou').learnset.doubleedge = ['9L1']; // ZA addition
    this.modData('Learnsets', 'furfrou').learnset.hyperbeam = ['9L1']; // ZA addition
    this.modData('Learnsets', 'furfrou').learnset.endure = ['9L1']; // ZA addition
    this.modData('Learnsets', 'furfrou').learnset.icefang = ['9L1']; // ZA addition
    this.modData('Learnsets', 'furfrou').learnset.thunderfang = ['9L1']; // ZA addition
    this.modData('Learnsets', 'furfrou').learnset.firefang = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.wish = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.taunt = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.stealthrock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.spikes = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.toxicspikes = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.teleport = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowstic').learnset.moonblast = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowsticf').learnset.waterpulse = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowsticf').learnset.earthpower = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowsticf').learnset.teleport = ['9L1']; // ZA addition
    this.modData('Learnsets', 'meowsticf').learnset.moonblast = ['9L1']; // ZA addition
    this.modData('Learnsets', 'aegislash').learnset.zenheadbutt = ['9L1']; // ZA addition
    this.modData('Learnsets', 'aromatisse').learnset.healblock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'aromatisse').learnset.hypnosis = ['9L1']; // ZA addition
    this.modData('Learnsets', 'slurpuff').learnset.swordsdance = ['9L1']; // ZA addition
    this.modData('Learnsets', 'slurpuff').learnset.selfdestruct = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'heliolisk').learnset.morningsun = ['9L1']; // ZA addition
    this.modData('Learnsets', 'heliolisk').learnset.shedtail = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'aurorus').learnset.icehammer = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sylveon').learnset.sparklyswirl = ['9L1'];
    this.modData('Learnsets', 'sylveon').learnset.taunt = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'goodra').learnset.gigadrain = ['9L1']; // ZA addition
    this.modData('Learnsets', 'goodrahisui').learnset.recover = ['9L1'];
    this.modData('Learnsets', 'goodrahisui').learnset.steelroller = ['9L1'];
    this.modData('Learnsets', 'goodrahisui').learnset.irondefense = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'gourgeist').learnset.hypnosis = ['9L1']; // ZA addition
    this.modData('Learnsets', 'gourgeist').learnset.firespin = ['9L1']; // ZA addition
    this.modData('Learnsets', 'gourgeist').learnset.selfdestruct = ['9L1']; // ZA addition
    this.modData('Learnsets', 'gourgeist').learnset.shadowclaw = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'avalugghisui').learnset.hydropump = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'crabrawler').learnset.machpunch = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'crabominable').learnset.machpunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'crabominable').learnset.firstimpression = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'oranguru').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'passimian').learnset.courtchange = ['9L1'];
    this.modData('Learnsets', 'golisopod').learnset.uturn = ['9L1']; // ZA addition
    this.modData('Learnsets', 'palossand').learnset.knockoff = ['9L1'];
    this.modData('Learnsets', 'palossand').learnset.fakeout = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'drampa').learnset.bodyslam = ['9L1']; // ZA addition
    this.modData('Learnsets', 'drampa').learnset.whirlwind = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'buzzwole').learnset.bodypress = ['9L1'];
    ...
    this.modData('Learnsets', 'magearna').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'magearnaoriginal').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'stakataka').learnset.zawalludo = ['9L1'];
    ...
    this.modData('Learnsets', 'zeraora').learnset.vacuumwave = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'drednaw').learnset.scaredyshell = ['9L1'];
    ...
    this.modData('Learnsets', 'toxtricitylowkey').learnset.poweruppunch = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'centiskorch').learnset.dragonrush = ['9L1'];
    this.modData('Learnsets', 'centiskorch').learnset.outrage = ['9L1'];
    this.modData('Learnsets', 'centiskorch').learnset.dragonclaw = ['9L1'];
    this.modData('Learnsets', 'centiskorch').learnset.dragonpulse = ['9L1'];
    this.modData('Learnsets', 'clobbopus').learnset.machpunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grapploct').learnset.stormthrow = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grapploct').learnset.circlethrow = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grapploct').learnset.bulletpunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grapploct').learnset.machpunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grapploct').learnset.poweruppunch = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grapploct').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grapploct').learnset.knockoff = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'perrserker').learnset.versatiledance = ['9L1'];
    this.modData('Learnsets', 'cursola').learnset.trickroom = ['9L1'];
    this.modData('Learnsets', 'sirfetchd').learnset.roost = ['9L1'];
    this.modData('Learnsets', 'sirfetchd').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'mrrime').learnset.chillyreception = ['9L1'];
    this.modData('Learnsets', 'mrrime').learnset.stealthrock = ['9L1']; // ZA addition
    this.modData('Learnsets', 'mrrime').learnset.firstimpression = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'stonjourner').learnset.allyswitch = ['9L1'];
    this.modData('Learnsets', 'stonjourner').learnset.quickguard = ['9L1'];
    this.modData('Learnsets', 'indeedee').learnset.moonlight = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedee').learnset.moonblast = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedee').learnset.wish = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedee').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedeef').learnset.moonlight = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedeef').learnset.moonblast = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedeef').learnset.wish = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedeef').learnset.vacuumwave = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'overqwil').learnset.mortalspin = ['9L1']; // ZA addition
    this.modData('Learnsets', 'overqwil').learnset.thunderwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'overqwil').learnset.partingshot = ['9L1'];
    ...
    this.modData('Learnsets', 'squawkabilly').learnset.partingshot = ['9L1']; // ZA addition
    this.modData('Learnsets', 'squawkabilly').learnset.ironhead = ['9L1']; // ZA addition
    this.modData('Learnsets', 'squawkabilly').learnset.knockoff = ['9L1']; // ZA addition
    this.modData('Learnsets', 'charcadet').learnset.agility = ['9L1'];
    ...
    this.modData('Learnsets', 'mabosstiff').learnset.knockoff = ['9L1']; // ZA addition
    this.modData('Learnsets', 'shroodle').learnset.firstimpression = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'tinkaton').learnset.woodhammer = ['9L1']; // ZA addition
    this.modData('Learnsets', 'tinkaton').learnset.bulkup = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'flamigo').learnset.tripleaxel = ['9L1']; // ZA addition
    this.modData('Learnsets', 'flamigo').learnset.knockoff = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'gholdengo').learnset.surf = ['9L1']; // ZA addition
