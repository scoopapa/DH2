...
const suspectTests = JSON.parse(_fs.FS.call(void 0, SUSPECTS_FILE).readIfExistsSync() || "{}");

function saveSuspectTests() {
	_fs.FS.call(void 0, SUSPECTS_FILE).writeUpdate(() => JSON.stringify(suspectTests));
}
