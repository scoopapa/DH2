...
// Gen 9 Mons
	...
	taurospaldeablaze: {
		...
		gender: "M",
		baseStats: {hp: 75, atk: 110, def: 105, spa: 30, spd: 70, spe: 100},
		abilities: {0: "Intimidate", 1: "Anger Point", H: "Tough Claws"},
		heightm: 1.4,
		weightkg: 88.4,
		color: "Black",
		eggGroups: ["Field"],
	...
	arboliva: {
		...
		name: "Arboliva",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 98, atk: 69, def: 90, spa: 125, spd: 109, spe: 39},
	...
	bellibolt: {
		...
		name: "Bellibolt",
		types: ["Electric"],
		baseStats: {hp: 120, atk: 64, def: 91, spa: 103, spd: 83, spe: 45},
		abilities: {0: "Electromorphosis", 1: "Electric Surge", H: "Damp"},
		heightm: 1.2,
		weightkg: 113,
		color: "Green",
		prevo: "Tadbulb",
	...
	toedscruel: {
		...
		name: "Toedscruel",
		types: ["Ground", "Grass"],
		baseStats: {hp: 80, atk: 70, def: 65, spa: 80, spd: 140, spe: 100},
		abilities: {0: "Mycelium Might"},
		heightm: 1.9,
		weightkg: 58,
		color: "Black",
	...
	bombirdier: {
		...
		name: "Bombirdier",
		types: ["Flying", "Dark"],
		baseStats: {hp: 90, atk: 103, def: 85, spa: 60, spd: 85, spe: 82},
		abilities: {0: "Prankster", 1: "Keen Eye", H: "Rocky Payload"},
		heightm: 1.5,
		weightkg: 42.9,
		color: "White",
		eggGroups: ["Flying"],
	...
	flamigo: {
		...
		abilities: {0: "Scrappy", 1: "Speed Boost", H: "Costar"},
		heightm: 1.6,
		weightkg: 37,
		color: "Pink",
		eggGroups: ["Flying"],
	...
	tatsugiri: {
		...
		baseForme: "Curly",
		types: ["Dragon", "Water"],
		baseStats: {hp: 68, atk: 50, def: 60, spa: 120, spd: 95, spe: 102},
