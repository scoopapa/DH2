export const Scripts: {[k: string]: ModdedBattleScriptsData} = {
	init: function () {
		...
		this.modData('Learnsets', 'sawsbuck').learnset.moonblast = ['7L1'];     // spring
		this.modData('Learnsets', 'sawsbuck').learnset.petalblizzard = ['7L1']; // spring
		this.modData('Learnsets', 'sawsbuck').learnset.playrough = ['7L1'];     // spring
		this.modData('Learnsets', 'sawsbuck').learnset.flameburst = ['7L1'];    // summer
		this.modData('Learnsets', 'sawsbuck').learnset.flamethrower = ['7L1'];  // summer
		this.modData('Learnsets', 'sawsbuck').learnset.growth = ['7L1'];        // summer
		this.modData('Learnsets', 'sawsbuck').learnset.leafstorm = ['7L1'];     // summer
		this.modData('Learnsets', 'sawsbuck').learnset.overheat = ['7L1'];      // summer
		this.modData('Learnsets', 'sawsbuck').learnset.poltergeist = ['7L1'];   // autumn
		this.modData('Learnsets', 'sawsbuck').learnset.shadowsneak = ['7L1'];   // autumn
		this.modData('Learnsets', 'sawsbuck').learnset.strengthsap = ['7L1'];   // autumn
		this.modData('Learnsets', 'sawsbuck').learnset.trickortreat = ['7L1'];  // autumn
		this.modData('Learnsets', 'sawsbuck').learnset.blizzard = ['7L1'];      // winter
		this.modData('Learnsets', 'sawsbuck').learnset.freezedry = ['7L1'];     // winter
		this.modData('Learnsets', 'sawsbuck').learnset.icebeam = ['7L1'];       // winter
		this.modData('Learnsets', 'sawsbuck').learnset.iceshard = ['7L1'];      // winter
		this.modData('Learnsets', 'sawsbuck').learnset.iciclecrash = ['7L1'];   // winter
