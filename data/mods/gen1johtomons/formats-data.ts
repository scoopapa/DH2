...
// Old Mons	
	...
	beedrill: {
		randomBattleMoves: ["twineedle", "earthquake", "swordsdance"],
		exclusiveMoves: ["doubleedge", "megadrain", "hyperbeam"],
		comboMoves: ["twineedle", "earthquake", "swordsdance", "agility"],
		tier: "UU",
	},
	pidgey: {
	...
	dewgong: {
		randomBattleMoves: ["surf", "blizzard", "amnesia"],
		exclusiveMoves: ["rest", "reflect", "rest", "hyperbeam"],
		tier: "UU",
	},
	grimer: {
	...
	onix: {
		randomBattleMoves: ["blizzard", "explosion", "rockslide", "surf"],
		tier: "UU",
	},
	drowzee: {
	...
	flareon: {
		randomBattleMoves: ["fireblast", "thunder", "hyperbeam", "jumpkick"],
		tier: "UU",
	},
	porygon: {
