export const Learnsets = {
	...
	ogerponcostar: {
		...
		eventData: [
			{generation: 9, level: 20, nature: "Bashful", ivs: {hp: 31, atk: 31, def: 20, spa: 20, spd: 20, spe: 31}, moves: ["ivycudgel", "slam", "growth", "vinewhip"]},
			{generation: 9, level: 70, nature: "Bashful", ivs: {hp: 31, atk: 31, def: 20, spa: 20, spd: 20, spe: 31}, moves: ["ivycudgel", "lowkick", "slam", "grassyterrain"]},
		],
		eventOnly: true,
	},
};
