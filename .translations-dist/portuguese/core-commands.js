"use strict";Object.defineProperty(exports, "__esModule", {value: true});
 ...
 const translations = {
	strings: {
		...
		"Player must be set to \"p1\" or \"p2\", not \"${target}\".": "O jogador deve ser estabelecido como \"p1\" ou \"p2\", não como \"${target}\".",
		"User ${name} not found.": "Usuário ${name} não encontrado.",
		"User ${name} must be in the battle room already.": "O usuário ${name} já deve estar na sala de batalha.",
		...
		"${name} was added to the battle as Player ${playerNum} by ${user.name}.": "${name} foi adicionado à batalha como jogador ${playerNum} por ${user.name}.",
		"Player 2": "Jogador 2",
		...
		"${targetUser.name} was kicked from a battle by ${user.name} ${displayTarget}": "${targetUser.name} foi expulso de uma batalha por ${user.name} ${displayTarget}",
		...
		"The user '${targetUsername}' was not found.": "O usuário '${targetUsername}' não foi encontrado.",
		"You are locked and cannot challenge unlocked users.": "Você está locked e não pode desafiar usuários unlocked.",
