...
exports.BattleScripts = {
	...
	init: function () {
		this.modData('Learnsets', 'bulbasaur').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'ivysaur').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'venusaur').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'charmander').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'charmeleon').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'charizard').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'squirtle').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'wartortle').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'blastoise').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'butterfree').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'beedrill').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'pidgey').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'pidgeotto').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'pidgeot').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'rattata').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'raticate').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'spearow').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'fearow').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'ekans').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'arbok').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'pikachu').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'raichu').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'sandshrew').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'sandslash').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'nidoranf').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'nidorina').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'nidoqueen').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'nidoranm').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'nidorino').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'nidoking').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'clefairy').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'clefable').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'vulpix').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'ninetales').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'jigglypuff').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'wigglytuff').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'zubat').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'golbat').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'oddish').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'gloom').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'vileplume').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'paras').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'parasect').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'venonat').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'venomoth').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'diglett').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'dugtrio').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'meowth').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'persian').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'psyduck').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'golduck').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'mankey').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'primeape').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'growlithe').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'arcanine').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'poliwag').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'poliwhirl').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'poliwrath').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'abra').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'kadabra').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'alakazam').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'machop').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'machoke').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'machamp').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'bellsprout').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'weepinbell').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'victreebel').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'tentacool').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'tentacruel').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'geodude').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'graveler').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'golem').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'ponyta').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'rapidash').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'slowpoke').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'slowbro').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'magnemite').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'magneton').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'farfetchd').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'doduo').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'dodrio').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'seel').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'dewgong').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'grimer').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'muk').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'shellder').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'cloyster').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'gastly').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'haunter').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'gengar').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'onix').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'drowzee').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'hypno').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'krabby').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'kingler').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'voltorb').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'electrode').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'exeggcute').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'exeggutor').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'cubone').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'marowak').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'hitmonchan').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'hitmonlee').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'lickitung').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'koffing').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'weezing').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'rhyhorn').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'rhydon').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'chansey').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'tangela').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'kangaskhan').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'horsea').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'seadra').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'goldeen').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'seaking').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'staryu').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'starmie').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'mrmime').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'scyther').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'jynx').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'electabuzz').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'magmar').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'pinsir').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'tauros').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'gyarados').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'lapras').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'eevee').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'vaporeon').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'jolteon').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'flareon').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'porygon').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'omanyte').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'omastar').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'kabuto').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'kabutops').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'aerodactyl').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'snorlax').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'articuno').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'zapdos').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'moltres').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'dratini').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'dragonair').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'dragonite').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'mewtwo').learnset.hiddenpower = ['1L1'];
		this.modData('Learnsets', 'mew').learnset.hiddenpower = ['1L1'];
	},
