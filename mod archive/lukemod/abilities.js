...
exports.BattleAbilities = {
	...
	"battlearmor": {
		shortDesc: "Halves damage taken from attacks at full HP.",
   ...
   onModifyMovePriority: -5,
	...
	"cursedbody": {
		desc: "If this Pokemon is hit by an attack, there is a 30% chance that move gets disabled unless one of the attacker's moves is already disabled. Allows Poison typed moves to hit Steel and Poison type mons neutrally.",
		shortDesc: "If this Pokemon is hit by an attack, there is a 30% chance that move gets disabled. Allows Poison typed moves to hit Steel and Poison type mons neutrally.",
		onAfterDamage: function (damage, target, source, move) {
	...
	"earlybird": {
		shortDesc: "Has a 20% chance of granting +1 priority to any move used by the user.",
		id: "earlybird",
		name: "Early Bird",
	...
	"healer": {
		desc: "Heals 1/16th of Max HP every turn.",
		shortDesc: "Heals 1/16th of Max HP every turn.",
		id: "healer",
		name: "Healer",
		onResidualOrder: 5,
   ...
   onStart: function(source) {
	...
	"powerofalchemy": {
		desc: "Copies the ability of the last fainted Pokemon on the field.",
		shortDesc: "Copies the ability of the last fainted Pokemon on the field.",
	...
	"receiver": {
		desc: "This Pokemon copies the Ability of the last fainted Pokemon. Abilities that cannot be copied are Flower Gift, Forecast, Illusion, Imposter, Multitype, Stance Change, Trace, Wonder Guard, and Zen Mode.",
		desc: "Copies the ability of the last fainted Pokemon on the field.",
		shortDesc: "Copies the ability of the last fainted Pokemon on the field.",
		onFaint: function (target) {
			if (!this.effectData.target.hp) return;
	...
	"reckless": {
		desc: "Grants recoil based moves +1 Priority.",
		shortDesc: "Grants recoil based moves +1 Priority.",
		onBasePowerPriority: 8,
		onBasePower: function (basePower, attacker, defender, move) {
	...
	"surgesurfer": {
		shortDesc: "Doubles speed in all Terrain.",
		onModifySpe: function (spe) {
	...
	"vitalspirit": {
		shortDesc: "Boosts Speed by 2 stages if any stat is lowered by the opponent.",
		onAfterEachBoost: function (boost, target, source) {
			if (!source || target.side === source.side) {
				return;
			}
