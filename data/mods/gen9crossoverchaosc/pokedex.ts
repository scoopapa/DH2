export const Pokedex: {[k: string]: ModdednameData} = {
	...
	pit: {
		...
		gender: "M",
		types: ["Flying", "Fairy"],
		baseStats: {hp: 80, atk: 85, def: 80, spa: 80, spd: 85, spe: 115},
		abilities: {0: "Justified", 1: "Reckless", H: "Sheer Force"},
		weightkg: 80,
	...
	pitmega: {
		...
		forme: "Mega",
		types: ["Steel", "Fairy"],
		baseStats: {hp: 80, atk: 120, def: 120, spa: 100, spd: 110, spe: 95},
	...
	medic: {
		...
		abilities: {0: "Healer", 1: "Prankster", H: "Triage"},
		weightkg: 80,
	},
	plaguerat: {
		num: 30,
	...
	bowser: {
		...
		gender: "M",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 80, atk: 110, def: 120, spa: 110, spd: 90, spe: 50},
		abilities: {0: "Pressure", 1: "Mold Breaker", H: "Stamina"},
		weightkg: 432,
