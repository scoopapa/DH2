export const Formats: {[k: string]: FormatData} = {
	megadatamod: {
		...
		onBegin() {
			...
			this.add('-message', `Right now, we're working on giving new Mega Evolutions to a variety of Pokémon in a Kalos Pokédex-based format. The only Mega Evolutions allowed are our new ones!`);
