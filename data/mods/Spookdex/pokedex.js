...
let BattlePokedex = {
	bulbasaur: {
		...
		abilities: {0: "Overgrow", H: "Chlorophyll", S: "Leaf Guard"},
		heightm: 0.7,
		weightkg: 6.9,
		color: "Green",
		evos: ["ivysaur"],
	...
	venusaur: {
		...
		evoLevel: 32,
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["venusaurmegay", "venusaurmegax"],
	},
	venusaurmegay: {
		num: 3,
	...
	venusaurmegax: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 112, def: 113, spa: 130, spd: 110, spe: 80},
		abilities: {0: "Berserk"},
		heightm: 2.4,
		weightkg: 155.5,
		color: "Green",
	...
	charmander: {
		...
		abilities: {0: "Blaze", H: "Solar Power", S: "Flame Body"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "Red",
		evos: ["charmeleon"],
	...
	squirtle: {
		...
		abilities: {0: "Torrent", H: "Rain Dish", S: "Shell Armor"},
		heightm: 0.5,
		weightkg: 9,
		color: "Blue",
		evos: ["wartortle"],
	...
	blastoise: {
		...
		evoLevel: 36,
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["blastoisemegay", "blastoisemegax"],
	},
	blastoisemegay: {
		num: 9,
		...
		types: ["Water", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 79, atk: 93, def: 140, spa: 115, spd: 155, spe: 48},
	...
	caterpie: {
		...
		abilities: {0: "Shield Dust", H: "Run Away", S: "Competitive"},
		heightm: 0.3,
		weightkg: 2.9,
		color: "Green",
		evos: ["metapod"],
	...
	metapod: {
		...
		abilities: {0: "Shed Skin", S: "Competitive"},
		heightm: 0.7,
		weightkg: 9.9,
		color: "Green",
		prevo: "caterpie",
	...
	butterfree: {
		...
		abilities: {0: "Compound Eyes", H: "Tinted Lens", S: "Competitive"},
		heightm: 1.1,
		weightkg: 32,
		color: "White",
		prevo: "metapod",
	...
	weedle: {
		...
		abilities: {0: "Shield Dust", H: "Run Away", S: "Defiant"},
		heightm: 0.3,
		weightkg: 3.2,
		color: "Brown",
		evos: ["kakuna"],
	...
	kakuna: {
		...
		abilities: {0: "Shed Skin", S: "Defiant"},
		heightm: 0.6,
		weightkg: 10,
		color: "Yellow",
		prevo: "weedle",
	...
	beedrill: {
		...
		species: "Beedrill",
		types: ["Bug", "Poison"],
		baseStats: {hp: 65, atk: 100, def: 40, spa: 45, spd: 80, spe: 105},
		abilities: {0: "Swarm", H: "Sniper", S: "Defiant"},
		heightm: 1,
		weightkg: 29.5,
		color: "Yellow",
		prevo: "kakuna",
	...
	beedrillmega: {
		...
		formeLetter: "M",
		types: ["Bug", "Poison"],
		baseStats: {hp: 65, atk: 150, def: 50, spa: 60, spd: 80, spe: 145},
	...
	pidgey: {
		...
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Big Pecks", S: "Dazzling"},
		heightm: 0.3,
		weightkg: 1.8,
		color: "Brown",
		evos: ["pidgeotto"],
	...
	rattata: {
		...
		abilities: {0: "Run Away", 1: "Guts", H: "Hustle", S: "Strong Jaw"},
		heightm: 0.3,
		weightkg: 3.5,
		color: "Purple",
		evos: ["raticate"],
	...
	rattataalola: {
		...
		types: ["Dark", "Normal"],
		baseStats: {hp: 30, atk: 56, def: 35, spa: 25, spd: 35, spe: 72},
		abilities: {0: "Gluttony", 1: "Hustle", H: "Thick Fat", S: "Cheek Pouch"},
		heightm: 0.3,
		weightkg: 3.8,
		color: "Black",
		evos: ["raticatealola"],
	...
	spearow: {
		...
		abilities: {0: "Keen Eye", H: "Sniper", S: "Mold Breaker"},
		heightm: 0.3,
		weightkg: 2,
		color: "Brown",
		evos: ["fearow"],
	...
	ekans: {
		...
		abilities: {0: "Intimidate", 1: "Shed Skin", H: "Tough Grip", S: "Sand Rush"},
		heightm: 2,
		weightkg: 6.9,
		color: "Purple",
		evos: ["arbok"],
	...
	pikachu: {
		...
		abilities: {0: "Static", H: "Lightning Rod", S: "Cute Charm"},
		heightm: 0.4,
		weightkg: 6,
		color: "Yellow",
		prevo: "pichu",
	...
	sandshrew: {
		...
		abilities: {0: "Sand Veil", H: "Sand Rush", S: "Sand Force"},
		heightm: 0.6,
		weightkg: 12,
		color: "Yellow",
		evos: ["sandslash"],
	...
	sandshrewalola: {
		...
		abilities: {0: "Snow Cloak", H: "Slush Rush", S: "Hyper Cutter"},
		heightm: 0.7,
		weightkg: 40,
		color: "White",
		evos: ["sandslashalola"],
	...
	nidoranf: {
		...
		abilities: {0: "Poison Point", 1: "Rivalry", H: "Hustle", S: "Queenly Majesty"},
		heightm: 0.4,
		weightkg: 7,
		color: "Blue",
		evos: ["nidorina"],
	...
	nidoqueen: {
		...
		abilities: {0: "Poison Point", 1: "Rivalry", H: "Sheer Force", S: "Queenly Majesty"},
		heightm: 1.3,
		weightkg: 60,
		color: "Blue",
		prevo: "nidorina",
	...
	nidoranm: {
		...
		abilities: {0: "Poison Point", 1: "Rivalry", H: "Hustle", S: "Tough Claws"},
		heightm: 0.5,
		weightkg: 9,
		color: "Purple",
		evos: ["nidorino"],
	...
	nidoking: {
		...
		abilities: {0: "Poison Point", 1: "Rivalry", H: "Sheer Force", S: "Tough Claws"},
		heightm: 1.4,
		weightkg: 62,
		color: "Purple",
		prevo: "nidorino",
	...
	clefable: {
		...
		abilities: {0: "Cute Charm", 1: "Magic Guard", H: "Unaware", S: "Super Luck"},
		heightm: 1.3,
		weightkg: 40,
		color: "Pink",
		prevo: "clefairy",
	...
	vulpix: {
		...
		abilities: {0: "Flash Fire", H: "Drought", S: "Serene Grace"},
		heightm: 0.6,
		weightkg: 9.9,
		color: "Brown",
		evos: ["ninetales"],
	...
	vulpixalola: {
		...
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 38, atk: 41, def: 40, spa: 50, spd: 65, spe: 65},
		abilities: {0: "Snow Cloak", H: "Snow Warning", S: "Serene Grace"},
		heightm: 0.6,
		weightkg: 9.9,
		color: "White",
		evos: ["ninetalesalola"],
	...
	jigglypuff: {
		...
		abilities: {0: "Cute Charm", 1: "Competitive", H: "Friend Guard", S: "Thick Fat"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Pink",
		prevo: "igglybuff",
	...
	wigglytuff: {
		...
		abilities: {0: "Cute Charm", 1: "Competitive", H: "Frisk", S: "Thick Fat"},
		heightm: 1,
		weightkg: 12,
		color: "Pink",
		prevo: "jigglypuff",
	...
	zubat: {
		...
		abilities: {0: "Inner Focus", H: "Infiltrator", S: "Merciless"},
		heightm: 0.8,
		weightkg: 7.5,
		color: "Purple",
		evos: ["golbat"],
	...
	oddish: {
		...
		abilities: {0: "Chlorophyll", H: "Run Away", S: "Insomnia"},
		heightm: 0.5,
		weightkg: 5.4,
		color: "Blue",
		evos: ["gloom"],
	...
	gloom: {
		...
		abilities: {0: "Chlorophyll", H: "Stench", S: "Insomnia"},
		heightm: 0.8,
		weightkg: 8.6,
		color: "Blue",
		prevo: "oddish",
	...
	vileplume: {
		...
		abilities: {0: "Chlorophyll", H: "Effect Spore", S: "Insomnia"},
		heightm: 1.2,
		weightkg: 18.6,
		color: "Red",
		prevo: "gloom",
	...
	vileplumemega: {
		...
		baseStats: {hp: 75, atk: 95, def: 110, spa: 120, spd: 130, spe: 60},
		abilities: {0: "Stench"},
		heightm: 1.2,
		weightkg: 18.6,
		color: "Red",
	...
	paras: {
		...
		abilities: {0: "Effect Spore", 1: "Dry Skin", H: "Damp", S: "Heatproof"},
		heightm: 0.3,
		weightkg: 5.4,
		color: "Red",
		evos: ["parasect"],
	...
	parasect: {
		...
		abilities: {0: "Effect Spore", 1: "Dry Skin", H: "Mossy Growth", S: "Heatproof"},
		heightm: 1,
		weightkg: 29.5,
		color: "Red",
		prevo: "paras",
	...
	venonat: {
		...
		abilities: {0: "Compound Eyes", 1: "Tinted Lens", H: "Run Away", S: "Unnerve"},
		heightm: 1,
		weightkg: 30,
		color: "Purple",
		evos: ["venomoth"],
	...
	venomoth: {
		...
		abilities: {0: "Shield Dust", 1: "Tinted Lens", H: "Wonder Skin", S: "Unnerve"},
		heightm: 1.5,
		weightkg: 12.5,
		color: "Purple",
		prevo: "venonat",
	...
	diglett: {
		...
		abilities: {0: "Sand Veil", 1: "Arena Trap", H: "Sand Force", S: "Sturdy"},
		heightm: 0.2,
		weightkg: 0.8,
		color: "Brown",
		evos: ["dugtrio"],
	...
	diglettalola: {
		...
		abilities: {0: "Sand Veil", 1: "Tangling Hair", H: "Sand Force", S: "Sturdy"},
		heightm: 0.2,
		weightkg: 1,
		color: "Brown",
		evos: ["dugtrioalola"],
	...
	meowth: {
		...
		abilities: {0: "Pickup", 1: "Technician", H: "Unnerve", S: "Scrappy"},
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		evos: ["persian"],
	...
	meowthalola: {
		...
		abilities: {0: "Pickup", 1: "Technician", H: "Rattled", S: "Truant"},
		heightm: 0.4,
		weightkg: 4.2,
		color: "Blue",
		evos: ["persianalola"],
	...
	persian: {
		...
		abilities: {0: "Limber", 1: "Technician", H: "Unnerve", S: "Scrappy"},
		heightm: 1,
		weightkg: 32,
		color: "Yellow",
		prevo: "meowth",
	...
	persianalola: {
		...
		abilities: {0: "Fur Coat", 1: "Technician", H: "Rattled", S: "Truant"},
		heightm: 1.1,
		weightkg: 33,
		color: "Blue",
		prevo: "meowthalola",
	...
	psyduck: {
		...
		abilities: {0: "Damp", 1: "Cloud Nine", H: "Swift Swim", S: "Own Tempo"},
		heightm: 0.8,
		weightkg: 19.6,
		color: "Yellow",
		evos: ["golduck"],
	...
	mankey: {
		...
		abilities: {0: "Vital Spirit", 1: "Anger Point", H: "Defiant", S: "Static"},
		heightm: 0.5,
		weightkg: 28,
		color: "Brown",
		evos: ["primeape"],
	...
	growlithe: {
		...
		abilities: {0: "Intimidate", 1: "Flash Fire", H: "Justified", S: "Frisk"},
		heightm: 0.7,
		weightkg: 19,
		color: "Brown",
		evos: ["arcanine"],
	...
	poliwag: {
		...
		abilities: {0: "Water Absorb", 1: "Damp", H: "Swift Swim", S: "Quick Feet"},
		heightm: 0.6,
		weightkg: 12.4,
		color: "Blue",
		evos: ["poliwhirl"],
	...
	poliwrath: {
		...
		abilities: {0: "Water Absorb", 1: "Contrary", H: "Swift Swim", S: "Iron Fist"},
		heightm: 1.3,
		weightkg: 54,
		color: "Blue",
		prevo: "poliwhirl",
	...
	abra: {
		...
		abilities: {0: "Synchronize", 1: "Inner Focus", H: "Magic Guard", S: "Telepathy"},
		heightm: 0.9,
		weightkg: 19.5,
		color: "Brown",
		evos: ["kadabra"],
	...
	alakazam: {
		...
		types: ["Psychic"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 55, atk: 60, def: 45, spa: 135, spd: 95, spe: 120},
		abilities: {0: "Synchronize", 1: "Inner Focus", H: "Magic Guard", S: "Telepathy"},
		heightm: 1.5,
		weightkg: 48,
		color: "Brown",
	...
	alakazammega: {
		...
		types: ["Psychic"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 55, atk: 60, def: 65, spa: 175, spd: 105, spe: 150},
		abilities: {0: "Trace"},
		heightm: 1.2,
		weightkg: 48,
		color: "Brown",
	...
	machop: {
		...
		abilities: {0: "Guts", 1: "No Guard", H: "Steadfast", S: "Inner Focus"},
		heightm: 0.8,
		weightkg: 19.5,
		color: "Gray",
		evos: ["machoke"],
	...
	machampmega: {
		...
		types: ["Fighting"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 90, atk: 165, def: 110, spa: 65, spd: 95, spe: 80},
	...
	bellsprout: {
		...
		abilities: {0: "Chlorophyll", H: "Gluttony", S: "Sap Sipper"},
		heightm: 0.7,
		weightkg: 4,
		color: "Green",
		evos: ["weepinbell"],
	...
	victreebel: {
		...
		abilities: {0: "Chlorophyll", 1: "Flytrap", H: "Gluttony", S: "Sap Sipper"},
		heightm: 1.7,
		weightkg: 15.5,
		color: "Green",
		prevo: "weepinbell",
	...
	tentacool: {
		...
		abilities: {0: "Clear Body", 1: "Liquid Ooze", H: "Rain Dish", S: "Suction Cups"},
		heightm: 0.9,
		weightkg: 45.5,
		color: "Blue",
		evos: ["tentacruel"],
	...
	geodude: {
		...
		abilities: {0: "Rock Head", 1: "Sturdy", H: "Sand Veil", S: "Weak Armor"},
		heightm: 0.4,
		weightkg: 20,
		color: "Brown",
		evos: ["graveler"],
	...
	geodudealola: {
		...
		types: ["Rock", "Electric"],
		baseStats: {hp: 40, atk: 80, def: 100, spa: 30, spd: 30, spe: 20},
		abilities: {0: "Magnet Pull", 1: "Sturdy", H: "Galvanize", S: "Weak Armor"},
		heightm: 0.4,
		weightkg: 20.3,
		color: "Gray",
		evos: ["graveleralola"],
	...
	golem: {
		...
		abilities: {0: "Rock Head", 1: "Sturdy", H: "Sand Veil", S: "Sand Stream"},
		heightm: 1.4,
		weightkg: 300,
		color: "Brown",
		prevo: "graveler",
	...
	golemalola: {
		...
		types: ["Rock", "Electric"],
		baseStats: {hp: 80, atk: 120, def: 130, spa: 55, spd: 65, spe: 45},
		abilities: {0: "Magnet Pull", 1: "Sturdy", H: "Galvanize", S: "Mega Launcher"},
		heightm: 1.7,
		weightkg: 316,
		color: "Gray",
		prevo: "graveleralola",
	...
	ponyta: {
		...
		abilities: {0: "Run Away", 1: "Flash Fire", H: "Flame Body", S: "Infiltrator"},
		heightm: 1,
		weightkg: 30,
		color: "Yellow",
		evos: ["rapidash"],
	...
	slowpoke: {
		...
		abilities: {0: "Oblivious", 1: "Own Tempo", H: "Regenerator", S: "Unaware"},
		heightm: 1.2,
		weightkg: 36,
		color: "Pink",
	...
	farfetchd: {
		...
		species: "Farfetch'd",
		types: ["Normal", "Flying"],
		baseStats: {hp: 62, atk: 90, def: 80, spa: 58, spd: 90, spe: 110},
		abilities: {0: "Keen Eye", 1: "Inner Focus", H: "Defiant", S: "Technician"},
		heightm: 0.8,
		weightkg: 15,
		color: "Brown",
	...
	doduo: {
		...
		abilities: {0: "Run Away", 1: "Early Bird", H: "Tangled Feet", S: "Quick Feet"},
		heightm: 1.4,
		weightkg: 39.2,
		color: "Brown",
		evos: ["dodrio"],
	...
	seel: {
		...
		abilities: {0: "Thick Fat", 1: "Hydration", H: "Ice Body", S: "Swift Swim"},
		heightm: 1.1,
		weightkg: 90,
		color: "White",
		evos: ["dewgong"],
	...
	grimeralola: {
		...
		types: ["Poison", "Dark"],
		baseStats: {hp: 80, atk: 80, def: 50, spa: 40, spd: 50, spe: 25},
		abilities: {0: "Poison Touch", 1: "Gluttony", H: "Power of Alchemy", S: "Liquid Ooze"},
		heightm: 0.7,
		weightkg: 42,
		color: "Green",
		evos: ["mukalola"],
	...
	shellder: {
		...
		abilities: {0: "Shell Armor", 1: "Skill Link", H: "Overcoat", S: "Weak Armor"},
		heightm: 0.3,
		weightkg: 4,
		color: "Purple",
		evos: ["cloyster"],
	...
	gastly: {
		...
		abilities: {0: "Levitate", S: "Prankster"},
		heightm: 1.3,
		weightkg: 0.1,
		color: "Purple",
		evos: ["haunter"],
	...
	gengar: {
		...
		abilities: {0: "Cursed Body", S: "Prankster"},
		heightm: 1.5,
		weightkg: 40.5,
		color: "Purple",
		prevo: "haunter",
	...
	onix: {
		...
		abilities: {0: "Rock Head", 1: "Sturdy", H: "Weak Armor", S: "Solid Rock"},
		heightm: 8.8,
		weightkg: 210,
		color: "Gray",
		evos: ["steelix"],
	...
	drowzee: {
		...
		abilities: {0: "Insomnia", 1: "Forewarn", H: "Inner Focus", S: "Unnerve"},
		heightm: 1,
		weightkg: 32.4,
		color: "Yellow",
		evos: ["hypno"],
	...
	hypno: {
		...
		species: "Hypno",
		types: ["Psychic", "Dark"],
		baseStats: {hp: 85, atk: 100, def: 70, spa: 73, spd: 115, spe: 67},
		abilities: {0: "Insomnia", 1: "Forewarn", H: "Inner Focus", S: "Unnerve"},
		heightm: 1.6,
		weightkg: 75.6,
		color: "Yellow",
	...
	krabby: {
		...
		abilities: {0: "Hyper Cutter", 1: "Shell Armor", H: "Sheer Force", S: "Technician"},
		heightm: 0.4,
		weightkg: 6.5,
		color: "Red",
		evos: ["kingler"],
	...
	voltorb: {
		...
		abilities: {0: "Soundproof", 1: "Static", H: "Aftermath", S: "Volatile"},
		heightm: 0.5,
		weightkg: 10.4,
		color: "Red",
		evos: ["electrode"],
	...
	electrode: {
		...
		evoLevel: 30,
		eggGroups: ["Mineral"],
		otherFormes: ["electrodemega"],
	},
	electrodemega: {
		num: 15,
		species: "Electrode-Mega",
		baseSpecies: "Electrode",
		forme: "Mega",
		formeLetter: "M",
		types: ["Electric", "Steel"],
		baseStats: {hp: 60, atk: 50, def: 85, spa: 130, spd: 95, spe: 170},
	...
	exeggcute: {
		...
		abilities: {0: "Chlorophyll", H: "Harvest", S: "Solar Power"},
		heightm: 0.4,
		weightkg: 2.5,
		color: "Pink",
	...
	exeggutoralola: {
		...
		abilities: {0: "Frisk", H: "Harvest", S: "Limber"},
		heightm: 10.9,
		weightkg: 415.6,
		color: "Yellow",
		prevo: "exeggcute",
	...
	cubone: {
		...
		abilities: {0: "Rock Head", 1: "Lightning Rod", H: "Battle Armor", S: "Technician"},
		heightm: 0.4,
		weightkg: 6.5,
		color: "Brown",
	...
	marowakalola: {
		...
		types: ["Fire", "Ghost"],
		baseStats: {hp: 60, atk: 80, def: 110, spa: 50, spd: 80, spe: 45},
		abilities: {0: "Cursed Body", 1: "Lightning Rod", H: "Rock Head", S: "Anger Point"},
		heightm: 1,
		weightkg: 34,
		color: "Purple",
		prevo: "cubone",
	...
	hitmonlee: {
		...
		abilities: {0: "Iron Leg", 1: "Reckless", H: "Unburden", S: "Steadfast"},
		heightm: 1.5,
		weightkg: 49.8,
		color: "Brown",
		prevo: "tyrogue",
	...
	hitmonchan: {
		...
		abilities: {0: "Keen Eye", 1: "Iron Fist", H: "Inner Focus", S: "Steadfast"},
		heightm: 1.4,
		weightkg: 50.2,
		color: "Brown",
		prevo: "tyrogue",
	...
	lickitung: {
		...
		abilities: {0: "Own Tempo", 1: "Oblivious", H: "Cloud Nine", S: "Thick Fat"},
		heightm: 1.2,
		weightkg: 65.5,
		color: "Pink",
		evos: ["lickilicky"],
	...
	koffing: {
		...
		abilities: {0: "Levitate", H: "Volatile", S: "White Smoke"},
		heightm: 0.6,
		weightkg: 1,
		color: "Purple",
		evos: ["weezing"],
	...
	rhyhorn: {
		...
		abilities: {0: "Lightning Rod", 1: "Rock Head", H: "Reckless", S: "Rough Skin"},
		heightm: 1,
		weightkg: 115,
		color: "Gray",
		evos: ["rhydon"],
	...
	chansey: {
		...
		abilities: {0: "Natural Cure", 1: "Serene Grace", H: "Healer", S: "Thick Fat"},
		heightm: 1.1,
		weightkg: 34.6,
		color: "Pink",
		prevo: "happiny",
	...
	tangela: {
		...
		abilities: {0: "Chlorophyll", 1: "Mossy Growth", H: "Regenerator", S: "Natural Cure"},
		heightm: 1,
		weightkg: 35,
		color: "Blue",
		evos: ["tangrowth"],
	...
	kangaskhan: {
		...
		abilities: {0: "Early Bird", 1: "Scrappy", H: "Inner Focus", S: "Infiltrator"},
		heightm: 2.2,
		weightkg: 80,
		color: "Brown",
		eggGroups: ["Monster"],
	...
	horsea: {
		...
		abilities: {0: "Swift Swim", 1: "Sniper", H: "Damp", S: "Regenerator"},
		heightm: 0.4,
		weightkg: 8,
		color: "Blue",
		evos: ["seadra"],
	...
	seadra: {
		...
		abilities: {0: "Poison Point", 1: "Sniper", H: "Damp", S: "Regenerator"},
		heightm: 1.2,
		weightkg: 25,
		color: "Blue",
		prevo: "horsea",
	...
	goldeen: {
		...
		abilities: {0: "Swift Swim", 1: "Water Veil", H: "Lightning Rod", S: "Hydration"},
		heightm: 0.6,
		weightkg: 15,
		color: "Red",
		evos: ["seaking"],
	...
	staryu: {
		...
		abilities: {0: "Illuminate", 1: "Natural Cure", H: "Analytic", S: "Clear Body"},
		heightm: 0.8,
		weightkg: 34.5,
		color: "Brown",
		evos: ["starmie"],
	...
	mrmime: {
		...
		abilities: {0: "Soundproof", 1: "Filter", H: "Technician", S: "Trace"},
		heightm: 1.3,
		weightkg: 54.5,
		color: "Pink",
		prevo: "mimejr",
	...
	scyther: {
		...
		abilities: {0: "Swarm", 1: "Technician", H: "Steadfast", S: "Hyper Cutter"},
		heightm: 1.5,
		weightkg: 56,
		color: "Green",
		evos: ["scizor"],
	...
	jynx: {
		...
		abilities: {0: "Oblivious", 1: "Forewarn", H: "Dry Skin", S: "Competitive"},
		heightm: 1.4,
		weightkg: 40.6,
		color: "Red",
		prevo: "smoochum",
	...
	electabuzz: {
		...
		abilities: {0: "Static", H: "Vital Spirit", S: "Galvanize"},
		heightm: 1.1,
		weightkg: 30,
		color: "Yellow",
		prevo: "elekid",
	...
	magmar: {
		...
		abilities: {0: "Flame Body", H: "Vital Spirit", S: "White Smoke"},
		heightm: 1.3,
		weightkg: 44.5,
		color: "Red",
		prevo: "magby",
	...
	pinsir: {
		...
		abilities: {0: "Hyper Cutter", 1: "Mold Breaker", H: "Moxie", S: "Tough Claws"},
		heightm: 1.5,
		weightkg: 55,
		color: "Brown",
		eggGroups: ["Bug"],
	...
	tauros: {
		...
		abilities: {0: "Intimidate", 1: "Anger Point", H: "Sheer Force", S: "Reckless"},
		heightm: 1.4,
		weightkg: 88.4,
		color: "Brown",
		eggGroups: ["Field"],
	...
	magikarp: {
		...
		abilities: {0: "Swift Swim", H: "Rattled", S: "Rain Dish"},
		heightm: 0.9,
		weightkg: 10,
		color: "Red",
		evos: ["gyarados"],
	...
	gyarados: {
		...
		abilities: {0: "Intimidate", H: "Moxie", S: "Rain Dish"},
		heightm: 6.5,
		weightkg: 235,
		color: "Blue",
		prevo: "magikarp",
	...
	lapras: {
		...
		abilities: {0: "Water Absorb", 1: "Shell Armor", H: "Hydration", S: "Swift Swim"},
		heightm: 2.5,
		weightkg: 220,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	ditto: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 100, atk: 75, def: 75, spa: 75, spd: 75, spe: 75},
		abilities: {0: "Synchronize", H: "Imposter", S: "Run Away"},
		heightm: 0.3,
		weightkg: 4,
		color: "Purple",
		eggGroups: ["Ditto"],
	...
	eevee: {
		...
		abilities: {0: "Run Away", 1: "Adaptability", H: "Anticipation", S: "Cute Charm"},
		heightm: 0.3,
		weightkg: 6.5,
		color: "Brown",
	...
	vaporeon: {
		...
		abilities: {0: "Water Absorb", H: "Hydration", S: "Adaptability"},
		heightm: 1,
		weightkg: 29,
		color: "Blue",
		prevo: "eevee",
	...
	jolteon: {
		...
		abilities: {0: "Volt Absorb", H: "Cloud Chaser", S: "Adaptability"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: "eevee",
	...
	flareon: {
		...
		abilities: {0: "Flash Fire", H: "Guts" , S: "Adaptability"},
		heightm: 0.9,
		weightkg: 25,
		color: "Red",
		prevo: "eevee",
	...
	omanyte: {
		...
		abilities: {0: "Swift Swim", 1: "Shell Armor", H: "Weak Armor", S: "Suction Cups"},
		heightm: 0.4,
		weightkg: 7.5,
		color: "Blue",
		evos: ["omastar"],
	...
	kabuto: {
		...
		abilities: {0: "Swift Swim", 1: "Battle Armor", H: "Weak Armor", S: "Technician"},
		heightm: 0.5,
		weightkg: 11.5,
		color: "Brown",
		evos: ["kabutops"],
	...
	aerodactyl: {
		...
		abilities: {0: "Rock Head", 1: "Pressure", H: "Unnerve", S: "Strong Jaw"},
		heightm: 1.8,
		weightkg: 59,
		color: "Purple",
		eggGroups: ["Flying"],
	...
	articuno: {
		...
		abilities: {0: "Pressure", H: "Snow Cloak", S: "Water Absorb"},
		heightm: 1.7,
		weightkg: 55.4,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	zapdos: {
		...
		abilities: {0: "Pressure", H: "Cloud Chaser", S: "Lightning Rod"},
		heightm: 1.6,
		weightkg: 52.6,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	moltres: {
		...
		abilities: {0: "Pressure", H: "Flame Body", S: "Flash Fire"},
		heightm: 2,
		weightkg: 60,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	dratini: {
		...
		abilities: {0: "Shed Skin", H: "Marvel Scale", S: "Unnerve"},
		heightm: 1.8,
		weightkg: 3.3,
		color: "Blue",
		evos: ["dragonair"],
	...
	dragonite: {
		...
		abilities: {0: "Inner Focus", H: "Multiscale", S: "Unnerve"},
		heightm: 2.2,
		weightkg: 210,
		color: "Brown",
		prevo: "dragonair",
	...
	mewtwo: {
		...
		abilities: {0: "Pressure", H: "Unnerve", S: "Telepathy"},
		heightm: 2,
		weightkg: 122,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	mew: {
		...
		abilities: {0: "Synchronize", S: "Trace"},
		heightm: 0.4,
		weightkg: 4,
		color: "Pink",
		eggGroups: ["Undiscovered"],
	...
	chikorita: {
		...
		abilities: {0: "Overgrow", H: "Leaf Guard", S: "Analytic"},
		heightm: 0.9,
		weightkg: 6.4,
		color: "Green",
		evos: ["bayleef"],
	...
	cyndaquil: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 39, atk: 52, def: 43, spa: 60, spd: 50, spe: 65},
		abilities: {0: "Blaze", H: "Flash Fire", S: "White Smoke"},
		heightm: 0.5,
		weightkg: 7.9,
		color: "Yellow",
		evos: ["quilava"],
	...
	totodile: {
		...
		abilities: {0: "Torrent", H: "Sheer Force", S: "Strong Jaw"},
		heightm: 0.6,
		weightkg: 9.5,
		color: "Blue",
		evos: ["croconaw"],
	...
	sentret: {
		...
		abilities: {0: "Run Away", 1: "Keen Eye", H: "Frisk", S: "Fluffy"},
		heightm: 0.8,
		weightkg: 6,
		color: "Brown",
		evos: ["furret"],
	...
	hoothoot: {
		...
		abilities: {0: "Insomnia", 1: "Keen Eye", H: "Tinted Lens", S: "No Guard"},
		heightm: 0.7,
		weightkg: 21.2,
		color: "Brown",
		evos: ["noctowl"],
	...
	ledyba: {
		...
		abilities: {0: "Swarm", 1: "Early Bird", H: "Rattled", S: "Justified"},
		heightm: 1,
		weightkg: 10.8,
		color: "Red",
		evos: ["ledian"],
	...
	ledian: {
		...
		species: "Ledian",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 55, atk: 95, def: 50, spa: 55, spd: 110, spe: 85},
		abilities: {0: "Swarm", 1: "Early Bird", H: "Iron Fist", S: "Justified"},
		heightm: 1.4,
		weightkg: 35.6,
		color: "Red",
		prevo: "ledyba",
	...
	spinarak: {
		...
		abilities: {0: "Swarm", 1: "Insomnia", H: "Sniper", S: "Silk Sifter"},
		heightm: 0.5,
		weightkg: 8.5,
		color: "Green",
		evos: ["ariados"],
	...
	chinchou: {
		...
		abilities: {0: "Volt Absorb", 1: "Illuminate", H: "Water Absorb", S: "Lightning Rod"},
		heightm: 0.5,
		weightkg: 12,
		color: "Blue",
		evos: ["lanturn"],
	...
	cleffa: {
		...
		abilities: {0: "Cute Charm", 1: "Magic Guard", H: "Friend Guard", S: "Cute Charm"},
		heightm: 0.3,
		weightkg: 3,
		color: "Pink",
		evos: ["clefairy"],
	...
	igglybuff: {
		...
		abilities: {0: "Cute Charm", 1: "Competitive", H: "Friend Guard", S: "Cute Charm"},
		heightm: 0.3,
		weightkg: 1,
		color: "Pink",
		evos: ["jigglypuff"],
	...
	togepi: {
		...
		abilities: {0: "Hustle", 1: "Serene Grace", H: "Super Luck", S: "Shell Armor"},
		heightm: 0.3,
		weightkg: 1.5,
		color: "White",
		evos: ["togetic"],
	...
	togetic: {
		...
		abilities: {0: "Hustle", 1: "Serene Grace", H: "Super Luck", S: "Aerilate"},
		heightm: 0.6,
		weightkg: 3.2,
		color: "White",
		prevo: "togepi",
	...
	natu: {
		...
		abilities: {0: "Synchronize", 1: "Early Bird", H: "Magic Bounce", S: "Forewarn"},
		heightm: 0.2,
		weightkg: 2,
		color: "Green",
		evos: ["xatu"],
	...
	mareep: {
		...
		abilities: {0: "Static", H: "Plus", S: "Lightning Rod"},
		heightm: 0.6,
		weightkg: 7.8,
		color: "White",
		evos: ["flaaffy"],
	...
	bellossom: {
		...
		abilities: {0: "Chlorophyll", H: "Healer", S: "Dancer"},
		heightm: 0.4,
		weightkg: 5.8,
		color: "Green",
		prevo: "gloom",
	...
	marill: {
		...
		abilities: {0: "Thick Fat", 1: "Huge Power", H: "Sap Sipper", S: "Gluttony"},
		heightm: 0.4,
		weightkg: 8.5,
		color: "Blue",
		prevo: "azurill",
	...
	sudowoodomega: {
		...
		types: ["Rock", "Steel"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 70, atk: 135, def: 155, spa: 35, spd: 90, spe: 25},
	...
	politoed: {
		...
		abilities: {0: "Water Absorb", 1: "Damp", H: "Drizzle", S: "Dancer"},
		heightm: 1.1,
		weightkg: 33.9,
		color: "Green",
		prevo: "poliwhirl",
	...
	hoppip: {
		...
		abilities: {0: "Chlorophyll", 1: "Leaf Guard", H: "Infiltrator", S: "Aerilate"},
		heightm: 0.4,
		weightkg: 0.5,
		color: "Pink",
		evos: ["skiploom"],
	...
	jumpluffmega: {
		...
		formeLetter: "M",
		types: ["Grass", "Flying"],
		baseStats: {hp: 75, atk: 75, def: 70, spa: 75, spd: 95, spe: 170},
		abilities: {0: "Fluffy"},
		heightm: 0.8,
		weightkg: 3,
		color: "Blue",
	...
	aipom: {
		...
		abilities: {0: "Run Away", 1: "Pickup", H: "Skill Link", S: "Prankster"},
		heightm: 0.8,
		weightkg: 11.5,
		color: "Purple",
		evos: ["ambipom"],
	...
	yanma: {
		...
		abilities: {0: "Speed Boost", 1: "Compound Eyes", H: "Frisk", S: "Swarm"},
		heightm: 1.2,
		weightkg: 38,
		color: "Red",
		evos: ["yanmega"],
	...
	wooper: {
		...
		abilities: {0: "Damp", 1: "Water Absorb", H: "Unaware", S: "Own Tempo"},
		heightm: 0.4,
		weightkg: 8.5,
		color: "Blue",
		evos: ["quagsire"],
	...
	espeon: {
		...
		abilities: {0: "Synchronize", H: "Magic Bounce", S: "Adaptability"},
		heightm: 0.9,
		weightkg: 26.5,
		color: "Purple",
		prevo: "eevee",
	...
	umbreon: {
		...
		abilities: {0: "Synchronize", H: "Inner Focus", S: "Adaptability"},
		heightm: 1,
		weightkg: 27,
		color: "Black",
		prevo: "eevee",
	...
	murkrow: {
		...
		abilities: {0: "Insomnia", 1: "Super Luck", H: "Prankster", S: "Big Pecks"},
		heightm: 0.5,
		weightkg: 2.1,
		color: "Black",
		evos: ["honchkrow"],
	...
	slowking: {
		...
		abilities: {0: "Oblivious", 1: "Own Tempo", H: "Regenerator", S: "Magic Bounce"},
		heightm: 2,
		weightkg: 79.5,
		color: "Pink",
		prevo: "slowpoke",
	...
	misdreavus: {
		...
		abilities: {0: "Levitate", S: "Magician"},
		heightm: 0.7,
		weightkg: 1,
		color: "Gray",
		evos: ["mismagius"],
	...
	wobbuffet: {
		...
		abilities: {0: "Shadow Tag", H: "Telepathy", S: "Contrary"},
		heightm: 1.3,
		weightkg: 28.5,
		color: "Blue",
		prevo: "wynaut",
	...
	girafarig: {
		...
		abilities: {0: "Inner Focus", 1: "Early Bird", H: "Sap Sipper", S: "Own Tempo"},
		heightm: 1.5,
		weightkg: 41.5,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	pineco: {
		...
		abilities: {0: "Sturdy", H: "Overcoat", S: "Filter"},
		heightm: 0.6,
		weightkg: 7.2,
		color: "Gray",
		evos: ["forretress"],
	...
	dunsparce: {
		...
		abilities: {0: "Serene Grace", 1: "Run Away", H: "Rattled", S: "Sand Veil"},
		heightm: 1.5,
		weightkg: 14,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	gligar: {
		...
		abilities: {0: "Hyper Cutter", 1: "Sand Veil", H: "Immunity", S: "Prankster"},
		heightm: 1.1,
		weightkg: 64.8,
		color: "Purple",
		evos: ["gliscor"],
	...
	steelix: {
		...
		abilities: {0: "Rock Head", 1: "Sturdy", H: "Sheer Force", S: "Heatproof"},
		heightm: 9.2,
		weightkg: 400,
		color: "Gray",
		prevo: "onix",
	...
	snubbull: {
		...
		abilities: {0: "Intimidate", 1: "Run Away", H: "Rattled", S: "Strong Jaw"},
		heightm: 0.6,
		weightkg: 7.8,
		color: "Pink",
		evos: ["granbull"],
	...
	granbull: {
		...
		abilities: {0: "Intimidate", 1: "Quick Feet", H: "Rattled", S: "Strong Jaw"},
		heightm: 1.4,
		weightkg: 48.7,
		color: "Purple",
		prevo: "snubbull",
	...
	qwilfish: {
		...
		abilities: {0: "Poison Point", 1: "Swift Swim", H: "Intimidate", S: "Water Absorb"},
		heightm: 0.5,
		weightkg: 3.9,
		color: "Gray",
		eggGroups: ["Water 2"],
	...
	scizor: {
		...
		abilities: {0: "Swarm", 1: "Technician", H: "Light Metal", S: "Hyper Cutter"},
		heightm: 1.8,
		weightkg: 118,
		color: "Red",
		prevo: "scyther",
	...
	shuckle: {
		...
		abilities: {0: "Sturdy", 1: "Gluttony", H: "Contrary", S: "Weak Armor"},
		heightm: 0.6,
		weightkg: 20.5,
		color: "Yellow",
		eggGroups: ["Bug"],
	...
	heracross: {
		...
		abilities: {0: "Swarm", 1: "Guts", H: "Moxie", S: "Inner Focus"},
		heightm: 1.5,
		weightkg: 54,
		color: "Blue",
		eggGroups: ["Bug"],
	...
	sneasel: {
		...
		abilities: {0: "Inner Focus", 1: "Keen Eye", H: "Pickpocket", S: "Unnerve"},
		heightm: 0.9,
		weightkg: 28,
		color: "Black",
		evos: ["weavile"],
	...
	teddiursa: {
		...
		abilities: {0: "Pickup", 1: "Quick Feet", H: "Honey Gather", S: "Cute Charm"},
		heightm: 0.6,
		weightkg: 8.8,
		color: "Brown",
		evos: ["ursaring"],
	...
	ursaring: {
		...
		abilities: {0: "Guts", 1: "Quick Feet", H: "Unnerve", S: "Tough Claws"},
		heightm: 1.8,
		weightkg: 125.8,
		color: "Brown",
		prevo: "teddiursa",
	...
	slugma: {
		...
		abilities: {0: "Magma Armor", 1: "Flame Body", H: "Weak Armor", S: "Drought"},
		heightm: 0.7,
		weightkg: 35,
		color: "Red",
		evos: ["magcargo"],
	...
	swinub: {
		...
		abilities: {0: "Oblivious", 1: "Snow Cloak", H: "Thick Fat", S: "Ice Body"},
		heightm: 0.4,
		weightkg: 6.5,
		color: "Brown",
		evos: ["piloswine"],
	...
	corsola: {
		...
		abilities: {0: "Hustle", 1: "Natural Cure", H: "Regenerator", S: "Quick Feet"},
		heightm: 0.6,
		weightkg: 5,
		color: "Pink",
		eggGroups: ["Water 1", "Water 3"],
	...
	remoraid: {
		...
		abilities: {0: "Hustle", 1: "Sniper", H: "Moody", S: "Speed Boost"},
		heightm: 0.6,
		weightkg: 12,
		color: "Gray",
		evos: ["octillery"],
	...
	octillery: {
		...
		abilities: {0: "Suction Cups", 1: "Sniper", H: "Moody", S: "Mega Launcher"},
		heightm: 0.9,
		weightkg: 28.5,
		color: "Red",
		prevo: "remoraid",
	...
	delibird: {
		...
		abilities: {0: "Vital Spirit", 1: "Hustle", H: "Insomnia", S: "Prankster"},
		heightm: 0.9,
		weightkg: 16,
		color: "Red",
		eggGroups: ["Water 1", "Field"],
	...
	mantine: {
		...
		abilities: {0: "Wind Surfer", 1: "Water Absorb", H: "Water Veil", S: "Hydration"},
		heightm: 2.1,
		weightkg: 220,
		color: "Purple",
		prevo: "mantyke",
	...
	skarmory: {
		...
		abilities: {0: "Keen Eye", 1: "Sturdy", H: "Weak Armor", S: "Light Metal"},
		heightm: 1.7,
		weightkg: 50.5,
		color: "Gray",
		eggGroups: ["Flying"],
	...
	houndour: {
		...
		abilities: {0: "Early Bird", 1: "Flash Fire", H: "Unnerve", S: "Intimidate"},
		heightm: 0.6,
		weightkg: 10.8,
		color: "Black",
		evos: ["houndoom"],
	...
	houndoom: {
		...
		abilities: {0: "Early Bird", 1: "Flash Fire", H: "Unnerve", S: "Toxin Absorb"},
		heightm: 1.4,
		weightkg: 35,
		color: "Black",
		prevo: "houndour",
	...
	phanpy: {
		...
		abilities: {0: "Pickup", H: "Sand Veil", S: "Bulletproof"},
		heightm: 0.5,
		weightkg: 33.5,
		color: "Blue",
		evos: ["donphan"],
	...
	donphan: {
		...
		abilities: {0: "Sturdy", H: "Sand Veil", S: "Bulletproof"},
		heightm: 1.1,
		weightkg: 120,
		color: "Gray",
		prevo: "phanpy",
	...
	stantler: {
		...
		abilities: {0: "Intimidate", 1: "Frisk", H: "Sap Sipper", S: "Inner Focus"},
		heightm: 1.4,
		weightkg: 71.2,
		color: "Brown",
		eggGroups: ["Field"],
	...
	smeargle: {
		...
		abilities: {0: "Own Tempo", 1: "Technician", H: "Moody", S: "Inner Focus"},
		heightm: 1.2,
		weightkg: 58,
		color: "White",
		eggGroups: ["Field"],
	...
	tyrogue: {
		...
		abilities: {0: "Guts", 1: "Steadfast", H: "Vital Spirit", S: "Cute Charm"},
		heightm: 0.7,
		weightkg: 21,
		color: "Purple",
	...
	hitmontop: {
		...
		abilities: {0: "Intimidate", 1: "Technician", H: "Steadfast", S: "Sturdy"},
		heightm: 1.4,
		weightkg: 48,
		color: "Brown",
		prevo: "tyrogue",
	...
	smoochum: {
		...
		abilities: {0: "Oblivious", 1: "Forewarn", H: "Hydration", S: "Cute Charm"},
		heightm: 0.4,
		weightkg: 6,
		color: "Pink",
		evos: ["jynx"],
	...
	elekid: {
		...
		abilities: {0: "Static", H: "Vital Spirit", S: "Cute Charm"},
		heightm: 0.6,
		weightkg: 23.5,
		color: "Yellow",
		evos: ["electabuzz"],
	...
	magby: {
		...
		abilities: {0: "Flame Body", H: "Vital Spirit", S: "Cute Charm"},
		heightm: 0.7,
		weightkg: 21.4,
		color: "Red",
		evos: ["magmar"],
	...
	miltank: {
		...
		abilities: {0: "Thick Fat", 1: "Scrappy", H: "Sap Sipper", S: "Immunity"},
		heightm: 1.2,
		weightkg: 75.5,
		color: "Pink",
		eggGroups: ["Field"],
	...
	raikou: {
		...
		abilities: {0: "Pressure", H: "Inner Focus", S: "Unnerve"},
		heightm: 1.9,
		weightkg: 178,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	larvitar: {
		...
		abilities: {0: "Guts", H: "Sand Veil", S: "Intimidate"},
		heightm: 0.6,
		weightkg: 72,
		color: "Green",
		evos: ["pupitar"],
	...
	pupitar: {
		...
		abilities: {0: "Shed Skin", S: "Intimidate"},
		heightm: 1.2,
		weightkg: 152,
		color: "Gray",
		prevo: "larvitar",
	...
	lugia: {
		...
		abilities: {0: "Pressure", H: "Multiscale", S: "Swift Swim"},
		heightm: 5.2,
		weightkg: 216,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	hooh: {
		...
		abilities: {0: "Pressure", H: "Regenerator", S: "Serene Grace"},
		heightm: 3.8,
		weightkg: 199,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	celebi: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Natural Cure", S: "Healer"},
		heightm: 0.6,
		weightkg: 5,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	treecko: {
		...
		abilities: {0: "Overgrow", H: "Unburden", S: "Justified"},
		heightm: 0.5,
		weightkg: 5,
		color: "Green",
		evos: ["grovyle"],
	...
	torchic: {
		...
		abilities: {0: "Blaze", H: "Speed Boost", S: "Iron Leg"},
		heightm: 0.4,
		weightkg: 2.5,
		color: "Red",
		evos: ["combusken"],
	...
	mudkip: {
		...
		abilities: {0: "Torrent", H: "Damp", S: "Swift Swim"},
		heightm: 0.4,
		weightkg: 7.6,
		color: "Blue",
		evos: ["marshtomp"],
	...
	poochyena: {
		...
		abilities: {0: "Run Away", 1: "Quick Feet", H: "Rattled", S: "Guts"},
		heightm: 0.5,
		weightkg: 13.6,
		color: "Gray",
		evos: ["mightyena"],
	...
	mightyena: {
		...
		abilities: {0: "Intimidate", 1: "Quick Feet", H: "Moxie", S: "Guts"},
		heightm: 1,
		weightkg: 37,
		color: "Gray",
		prevo: "poochyena",
	...
	zigzagoon: {
		...
		abilities: {0: "Pickup", 1: "Gluttony", H: "Quick Feet", S: "Speed boost"},
		heightm: 0.4,
		weightkg: 17.5,
		color: "Brown",
		evos: ["linoone"],
	...
	wurmple: {
		...
		abilities: {0: "Shield Dust", H: "Run Away", S: "Compound Eyes"},
		heightm: 0.3,
		weightkg: 3.6,
		color: "Red",
	...
	silcoon: {
		...
		abilities: {0: "Shed Skin", S: "Tinted Lens"},
		heightm: 0.6,
		weightkg: 10,
		color: "White",
		prevo: "wurmple",
	...
	beautifly: {
		...
		abilities: {0: "Swarm", H: "Rivalry", S: "Tinted Lens"},
		heightm: 1,
		weightkg: 28.4,
		color: "Yellow",
		prevo: "silcoon",
	...
	cascoon: {
		...
		types: ["Bug"],
		baseStats: {hp: 50, atk: 35, def: 55, spa: 25, spd: 25, spe: 15},
		abilities: {0: "Shed Skin", S: "Merciless"},
		heightm: 0.7,
		weightkg: 11.5,
		color: "Purple",
		prevo: "wurmple",
	...
	dustox: {
		...
		abilities: {0: "Shield Dust", H: "Compound Eyes", S: "Merciless"},
		heightm: 1.2,
		weightkg: 31.6,
		color: "Green",
		prevo: "cascoon",
	...
	lotad: {
		...
		abilities: {0: "Swift Swim", 1: "Rain Dish", H: "Own Tempo", S: "Klutz"},
		heightm: 0.5,
		weightkg: 2.6,
		color: "Green",
		evos: ["lombre"],
	...
	ludicolo: {
		...
		abilities: {0: "Swift Swim", 1: "Rain Dish", H: "Own Tempo", S: "Dancer"},
		heightm: 1.5,
		weightkg: 55,
		color: "Green",
		prevo: "lombre",
	...
	seedot: {
		...
		abilities: {0: "Chlorophyll", 1: "Early Bird", H: "Pickpocket", S: "Leaf Guard"},
		heightm: 0.5,
		weightkg: 4,
		color: "Brown",
		evos: ["nuzleaf"],
	...
	taillow: {
		...
		abilities: {0: "Guts", H: "Scrappy", S: "Unburden"},
		heightm: 0.3,
		weightkg: 2.3,
		color: "Blue",
		evos: ["swellow"],
	...
	wingull: {
		...
		abilities: {0: "Keen Eye", 1: "Hydration", H: "Rain Dish", S: "Hustle"},
		heightm: 0.6,
		weightkg: 9.5,
		color: "White",
		evos: ["pelipper"],
	...
	pelipper: {
		...
		abilities: {0: "Keen Eye", 1: "Drizzle", H: "Rain Dish", S: "Hustle"},
		heightm: 1.2,
		weightkg: 28,
		color: "Yellow",
		prevo: "wingull",
	...
	ralts: {
		...
		abilities: {0: "Synchronize", 1: "Trace", H: "Telepathy", S: "Friend Guard"},
		heightm: 0.4,
		weightkg: 6.6,
		color: "White",
		evos: ["kirlia"],
	...
	surskit: {
		...
		abilities: {0: "Swift Swim", H: "Rain Dish", S: "Water Veil"},
		heightm: 0.5,
		weightkg: 1.7,
		color: "Blue",
		evos: ["masquerain"],
	...
	masquerain: {
		...
		species: "Masquerain",
		types: ["Bug", "Flying"],
		baseStats: {hp: 70, atk: 60, def: 62, spa: 100, spd: 122, spe: 80},
		abilities: {0: "Intimidate", H: "Unnerve", S: "Water Veil"},
		heightm: 0.8,
		weightkg: 3.6,
		color: "Blue",
		prevo: "surskit",
	...
	shroomish: {
		...
		abilities: {0: "Effect Spore", 1: "Poison Heal", H: "Quick Feet", S: "Grass Pelt"},
		heightm: 0.4,
		weightkg: 4.5,
		color: "Brown",
		evos: ["breloom"],
	...
	breloom: {
		...
		abilities: {0: "Effect Spore", 1: "Poison Heal", H: "Technician", S: "Grass Pelt"},
		heightm: 1.2,
		weightkg: 39.2,
		color: "Green",
		prevo: "shroomish",
	...
	vigoroth: {
		...
		abilities: {0: "Vital Spirit", S: "Unnerve"},
		heightm: 1.4,
		weightkg: 46.5,
		color: "White",
		prevo: "slakoth",
	...
	nincada: {
		...
		abilities: {0: "Compound Eyes", H: "Run Away", S: "Swarm"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Gray",
	...
	ninjask: {
		...
		abilities: {0: "Speed Boost", H: "Infiltrator", S: "Swarm"},
		heightm: 0.8,
		weightkg: 12,
		color: "Yellow",
		prevo: "nincada",
	...
	whismur: {
		...
		abilities: {0: "Soundproof", H: "Rattled", S: "Anticipation"},
		heightm: 0.6,
		weightkg: 16.3,
		color: "Pink",
		evos: ["loudred"],
	...
	loudred: {
		...
		abilities: {0: "Soundproof", H: "Scrappy", S: "Anticipation"},
		heightm: 1,
		weightkg: 40.5,
		color: "Blue",
		prevo: "whismur",
	...
	makuhita: {
		...
		abilities: {0: "Thick Fat", 1: "Guts", H: "Sheer Force", S: "Vital Spirit"},
		heightm: 1,
		weightkg: 86.4,
		color: "Yellow",
		evos: ["hariyama"],
	...
	azurill: {
		...
		abilities: {0: "Thick Fat", 1: "Huge Power", H: "Sap Sipper", S: "Cute Charm"},
		heightm: 0.2,
		weightkg: 2,
		color: "Blue",
		evos: ["marill"],
	...
	nosepass: {
		...
		abilities: {0: "Sturdy", 1: "Magnet Pull", H: "Sand Force", S: "Sand Stream"},
		heightm: 1,
		weightkg: 97,
		color: "Gray",
		evos: ["probopass"],
	...
	skitty: {
		...
		abilities: {0: "Cute Charm", 1: "Normalize", H: "Wonder Skin", S: "Friend Guard"},
		heightm: 0.6,
		weightkg: 11,
		color: "Pink",
		evos: ["delcatty"],
	...
	sableye: {
		...
		abilities: {0: "Keen Eye", 1: "Stall", H: "Prankster", S: "Dazzling"},
		heightm: 0.5,
		weightkg: 11,
		color: "Purple",
		eggGroups: ["Human-Like"],
	...
	mawile: {
		...
		abilities: {0: "Hyper Cutter", 1: "Intimidate", H: "Sheer Force", S: "Strong Jaw"},
		heightm: 0.6,
		weightkg: 11.5,
		color: "Black",
		eggGroups: ["Field", "Fairy"],
	...
	aron: {
		...
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Heavy Metal", S: "Battle Armor"},
		heightm: 0.4,
		weightkg: 60,
		color: "Gray",
		evos: ["lairon"],
	...
	meditite: {
		...
		abilities: {0: "Pure Power", H: "Telepathy", S: "Inner Focus"},
		heightm: 0.6,
		weightkg: 11.2,
		color: "Blue",
		evos: ["medicham"],
	...
	plusle: {
		...
		abilities: {0: "Plus", H: "Lightning Rod", S: "Static"},
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	minun: {
		...
		abilities: {0: "Minus", H: "Volt Absorb", S: "Static"},
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	volbeat: {
		...
		abilities: {0: "Illuminate", 1: "Swarm", H: "Prankster", S: "Minus"},
		heightm: 0.7,
		weightkg: 17.7,
		color: "Gray",
	...
	illumise: {
		...
		abilities: {0: "Oblivious", 1: "Tinted Lens", H: "Prankster", S: "Plus"},
		heightm: 0.6,
		weightkg: 17.7,
		color: "Purple",
		eggGroups: ["Bug", "Human-Like"],
	...
	roselia: {
		...
		abilities: {0: "Natural Cure", 1: "Poison Point", H: "Leaf Guard", S: "Merciless"},
		heightm: 0.3,
		weightkg: 2,
		color: "Green",
		prevo: "budew",
	...
	gulpin: {
		...
		abilities: {0: "Liquid Ooze", 1: "Sticky Hold", H: "Gluttony", S: "Corrosion"},
		heightm: 0.4,
		weightkg: 10.3,
		color: "Green",
		evos: ["swalot"],
	...
	carvanha: {
		...
		abilities: {0: "Rough Skin", H: "Speed Boost", S: "Swift Swim"},
		heightm: 0.8,
		weightkg: 20.8,
		color: "Red",
		evos: ["sharpedo"],
	...
	wailmer: {
		...
		abilities: {0: "Water Veil", 1: "Oblivious", H: "Pressure", S: "Thick Fat"},
		heightm: 2,
		weightkg: 130,
		color: "Blue",
		evos: ["wailord"],
	...
	numel: {
		...
		abilities: {0: "Oblivious", 1: "Simple", H: "Own Tempo", S: "Truant"},
		heightm: 0.7,
		weightkg: 24,
		color: "Yellow",
		evos: ["camerupt"],
	...
	camerupt: {
		...
		abilities: {0: "Magma Armor", 1: "Solid Rock", H: "Anger Point", S: "Water Absorb"},
		heightm: 1.9,
		weightkg: 220,
		color: "Red",
		prevo: "numel",
	...
	torkoal: {
		...
		abilities: {0: "White Smoke", 1: "Drought", H: "Shell Armor", S: "Flash Fire"},
		heightm: 0.5,
		weightkg: 80.4,
		color: "Brown",
		eggGroups: ["Field"],
	...
	spoink: {
		...
		abilities: {0: "Thick Fat", 1: "Own Tempo", H: "Gluttony", S: "Oblivious"},
		heightm: 0.7,
		weightkg: 30.6,
		color: "Black",
		evos: ["grumpig"],
	...
	spinda: {
		...
		abilities: {0: "Own Tempo", 1: "Tangled Feet", H: "Contrary", S: "Scrappy"},
		heightm: 1.1,
		weightkg: 5,
		color: "Brown",
	...
	trapinch: {
		...
		abilities: {0: "Hyper Cutter", 1: "Arena Trap", H: "Sheer Force", S: "Sand Veil"},
		heightm: 0.7,
		weightkg: 15,
		color: "Brown",
		evos: ["vibrava"],
	...
	vibrava: {
		...
		abilities: {0: "Levitate", S: "Arena Trap"},
		heightm: 1.1,
		weightkg: 15.3,
		color: "Green",
		prevo: "trapinch",
	...
	cacnea: {
		...
		abilities: {0: "Sand Veil", H: "Water Absorb", S: "Rough Skin"},
		heightm: 0.4,
		weightkg: 51.3,
		color: "Green",
		evos: ["cacturne"],
	...
	swablu: {
		...
		abilities: {0: "Natural Cure", H: "Cloud Nine", S: "Filter"},
		heightm: 0.4,
		weightkg: 1.2,
		color: "Blue",
		evos: ["altaria"],
	...
	zangoose: {
		...
		abilities: {0: "Immunity", H: "Toxic Boost", S: "Poison Heal"},
		heightm: 1.3,
		weightkg: 40.3,
		color: "White",
		eggGroups: ["Field"],
	...
	seviper: {
		...
		abilities: {0: "Shed Skin", H: "Infiltrator", S: "Mold Breaker"},
		heightm: 2.7,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field", "Dragon"],
	...
	lunatone: {
		...
		abilities: {0: "Levitate", S: "Shadow Tag"},
		heightm: 1,
		weightkg: 168,
		color: "Yellow",
		eggGroups: ["Mineral"],
	...
	solrock: {
		...
		abilities: {0: "Levitate", S: "Solar Power"},
		heightm: 1.2,
		weightkg: 154,
		color: "Red",
		eggGroups: ["Mineral"],
	...
	barboach: {
		...
		abilities: {0: "Oblivious", 1: "Anticipation", H: "Hydration", S: "Water Veil"},
		heightm: 0.4,
		weightkg: 1.9,
		color: "Gray",
		evos: ["whiscash"],
	...
	corphish: {
		...
		abilities: {0: "Hyper Cutter", 1: "Shell Armor", H: "Adaptability", S: "Moxie"},
		heightm: 0.6,
		weightkg: 11.5,
		color: "Red",
		evos: ["crawdaunt"],
	...
	baltoy: {
		...
		abilities: {0: "Levitate", S: "Magic Guard"},
		heightm: 0.5,
		weightkg: 21.5,
		color: "Brown",
		evos: ["claydol"],
	...
	lileep: {
		...
		abilities: {0: "Suction Cups", H: "Storm Drain", S: "Regenerator"},
		heightm: 1,
		weightkg: 23.8,
		color: "Purple",
		evos: ["cradily"],
	...
	anorith: {
		...
		abilities: {0: "Battle Armor", H: "Swift Swim", S: "Weak Armor"},
		heightm: 0.7,
		weightkg: 12.5,
		color: "Gray",
		evos: ["armaldo"],
	...
	feebas: {
		...
		abilities: {0: "Swift Swim", 1: "Oblivious", H: "Adaptability", S: "Rain Dish"},
		heightm: 0.6,
		weightkg: 7.4,
		color: "Brown",
		evos: ["milotic"],
	...
	milotic: {
		...
		abilities: {0: "Marvel Scale", 1: "Competitive", H: "Queenly Majesty", S: "Serene Grace"},
		heightm: 6.2,
		weightkg: 162,
		color: "Pink",
		prevo: "feebas",
	...
	castform: {
		...
		abilities: {0: "Forecast", S: "Prankster"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Gray",
		eggGroups: ["Fairy", "Amorphous"],
		otherFormes: ["castformsunny", "castformrainy", "castformsnowy", "castformsandy", "castformgloomy"],
	},
	castformsunny: {
		num: 351,
	...
	kecleon: {
		...
		abilities: {0: "Color Change", H: "Protean", S: "Normalize"},
		heightm: 1,
		weightkg: 22,
		color: "Green",
		eggGroups: ["Field"],
	...
	duskull: {
		...
		abilities: {0: "Levitate", H: "Frisk", S: "Shadow Tag"},
		heightm: 0.8,
		weightkg: 15,
		color: "Black",
		evos: ["dusclops"],
	...
	tropius: {
		...
		abilities: {0: "Chlorophyll", 1: "Solar Power", H: "Harvest", S: "Leaf Guard"},
		heightm: 2,
		weightkg: 100,
		color: "Green",
		eggGroups: ["Monster", "Grass"],
	...
	chimecho: {
		...
		abilities: {0: "Levitate", S: "Magic Bounce"},
		heightm: 0.6,
		weightkg: 1,
		color: "Blue",
		prevo: "chingling",
	...
	chimechomega: {
		...
		formeLetter: "M",
		types: ["Psychic"],
		baseStats: {hp: 75, atk: 90, def: 110, spa: 135, spd: 100, spe: 45},
	...
	absol: {
		...
		abilities: {0: "Stormbringer", 1: "Super Luck", H: "Justified", S: "Forewarn"},
		heightm: 1.2,
		weightkg: 47,
		color: "White",
		eggGroups: ["Field"],
	...
	snorunt: {
		...
		abilities: {0: "Inner Focus", 1: "Ice Body", H: "Moody", S: "Snow Warning"},
		heightm: 0.7,
		weightkg: 16.8,
		color: "Gray",
	...
	spheal: {
		...
		abilities: {0: "Thick Fat", 1: "Ice Body", H: "Oblivious", S: "Snow Cloak"},
		heightm: 0.8,
		weightkg: 39.5,
		color: "Blue",
		evos: ["sealeo"],
	...
	clamperl: {
		...
		abilities: {0: "Shell Armor", H: "Rattled", S: "Adaptability"},
		heightm: 0.4,
		weightkg: 52.5,
		color: "Blue",
	...
	huntail: {
		...
		abilities: {0: "Swift Swim", H: "Water Veil", S: "Strong Jaw"},
		heightm: 1.7,
		weightkg: 27,
		color: "Blue",
		prevo: "clamperl",
	...
	gorebyss: {
		...
		abilities: {0: "Swift Swim", H: "Hydration", S: "Triage"},
		heightm: 1.8,
		weightkg: 22.6,
		color: "Pink",
		prevo: "clamperl",
	...
	relicanth: {
		...
		abilities: {0: "Swift Swim", 1: "Rock Head", H: "Sturdy", S: "Regenerator"},
		heightm: 1,
		weightkg: 23.4,
		color: "Gray",
		eggGroups: ["Water 1", "Water 2"],
	...
	luvdisc: {
		...
		abilities: {0: "Swift Swim", H: "Hydration", S: "Prankster"},
		heightm: 0.6,
		weightkg: 8.7,
		color: "Pink",
		eggGroups: ["Water 2"],
	...
	bagon: {
		...
		abilities: {0: "Rock Head", H: "Sheer Force", S: "Mold Breaker"},
		heightm: 0.6,
		weightkg: 42.1,
		color: "Blue",
		evos: ["shelgon"],
	...
	shelgon: {
		...
		abilities: {0: "Rock Head", H: "Overcoat", S: "Mold Breaker"},
		heightm: 1.1,
		weightkg: 110.5,
		color: "White",
		prevo: "bagon",
	...
	salamence: {
		...
		abilities: {0: "Intimidate", H: "Moxie", S: "Mold Breaker"},
		heightm: 1.5,
		weightkg: 102.6,
		color: "Blue",
		prevo: "shelgon",
	...
	beldum: {
		...
		abilities: {0: "Clear Body", H: "Light Metal", S: "Inner Focus"},
		heightm: 0.6,
		weightkg: 95.2,
		color: "Blue",
		evos: ["metang"],
	...
	regirock: {
		...
		abilities: {0: "Clear Body", H: "Sturdy", S: "Sheer Force"},
		heightm: 1.7,
		weightkg: 230,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	regice: {
		...
		abilities: {0: "Clear Body", H: "Ice Body", S: "Regenerator"},
		heightm: 1.8,
		weightkg: 175,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	registeel: {
		...
		abilities: {0: "Clear Body", H: "Light Metal", S: "Volt Absorb"},
		heightm: 1.9,
		weightkg: 205,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	kyogre: {
		...
		abilities: {0: "Drizzle", S: "Swift Swim"},
		heightm: 4.5,
		weightkg: 352,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	groudon: {
		...
		abilities: {0: "Drought", S: "Solar Power"},
		heightm: 3.5,
		weightkg: 950,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	rayquaza: {
		...
		abilities: {0: "Air Lock", S: "Mold Breaker"},
		heightm: 7,
		weightkg: 206.5,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	jirachi: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Serene Grace", S: "Clear Body"},
		heightm: 0.3,
		weightkg: 1.1,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	deoxys: {
		...
		abilities: {0: "Pressure", S: "Unnerve"},
		heightm: 1.7,
		weightkg: 60.8,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	deoxysattack: {
		...
		abilities: {0: "Pressure", S: "Analytic"},
		heightm: 1.7,
		weightkg: 60.8,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	turtwig: {
		...
		abilities: {0: "Overgrow", H: "Shell Armor", S: "Harvest"},
		heightm: 0.4,
		weightkg: 10.2,
		color: "Green",
		evos: ["grotle"],
	...
	chimchar: {
		...
		abilities: {0: "Blaze", H: "Iron Fist", S: "Steadfast"},
		heightm: 0.5,
		weightkg: 6.2,
		color: "Brown",
		evos: ["monferno"],
	...
	piplup: {
		...
		abilities: {0: "Torrent", H: "Defiant", S: "Clear Body"},
		heightm: 0.4,
		weightkg: 5.2,
		color: "Blue",
		evos: ["prinplup"],
	...
	starly: {
		...
		abilities: {0: "Keen Eye", H: "Reckless", S: "Defiant"},
		heightm: 0.3,
		weightkg: 2,
		color: "Brown",
		evos: ["staravia"],
	...
	staravia: {
		...
		abilities: {0: "Intimidate", H: "Reckless", S: "Defiant"},
		heightm: 0.6,
		weightkg: 15.5,
		color: "Brown",
		prevo: "starly",
	...
	bidoof: {
		...
		abilities: {0: "Simple", 1: "Unaware", H: "Moody", S: "Swift Swim"},
		heightm: 0.5,
		weightkg: 20,
		color: "Brown",
		evos: ["bibarel"],
	...
	kricketot: {
		...
		abilities: {0: "Shed Skin", H: "Run Away", S: "Soundproof"},
		heightm: 0.3,
		weightkg: 2.2,
		color: "Red",
		evos: ["kricketune"],
	...
	kricketune: {
		...
		abilities: {0: "Swarm", H: "Technician", S: "Soundproof"},
		heightm: 1,
		weightkg: 25.5,
		color: "Red",
		prevo: "kricketot",
	...
	shinx: {
		...
		abilities: {0: "Rivalry", 1: "Intimidate", H: "Guts", S: "Illuminate"},
		heightm: 0.5,
		weightkg: 9.5,
		color: "Blue",
		evos: ["luxio"],
	...
	budew: {
		...
		abilities: {0: "Natural Cure", 1: "Poison Point", H: "Leaf Guard", S: "Cute Charm"},
		heightm: 0.2,
		weightkg: 1.2,
		color: "Green",
		evos: ["roselia"],
	...
	roserade: {
		...
		abilities: {0: "Natural Cure", 1: "Poison Point", H: "Technician", S: "Merciless"},
		heightm: 0.9,
		weightkg: 14.5,
		color: "Green",
		prevo: "roselia",
	...
	cranidos: {
		...
		abilities: {0: "Mold Breaker", H: "Sheer Force", S: "Rock Head"},
		heightm: 0.9,
		weightkg: 31.5,
		color: "Blue",
		evos: ["rampardos"],
	...
	shieldon: {
		...
		abilities: {0: "Sturdy", H: "Soundproof", S: "Bulletproof"},
		heightm: 0.5,
		weightkg: 57,
		color: "Gray",
		evos: ["bastiodon"],
	...
	burmy: {
		...
		abilities: {0: "Shed Skin", H: "Overcoat", S: "Run Away"},
		heightm: 0.2,
		weightkg: 3.4,
		color: "Green",
	...
	wormadam: {
		...
		abilities: {0: "Anticipation", H: "Overcoat", S: "Chlorophyll"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Green",
		prevo: "burmy",
	...
	wormadamtrash: {
		...
		abilities: {0: "Anticipation", H: "Overcoat", S: "Tangling Hair"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Red",
		prevo: "burmy",
	...
	mothim: {
		...
		abilities: {0: "Swarm", H: "Tinted Lens", S: "Compound Eyes"},
		heightm: 0.9,
		weightkg: 23.3,
		color: "Yellow",
		prevo: "burmy",
	...
	combee: {
		...
		abilities: {0: "Honey Gather", H: "Hivemind", S: "Klutz"},
		heightm: 0.3,
		weightkg: 5.5,
		color: "Yellow",
		evos: ["vespiquen"],
	...
	vespiquen: {
		...
		abilities: {0: "Pressure", H: "Unnerve", S: "Swarm"},
		heightm: 1.2,
		weightkg: 38.5,
		color: "Yellow",
		prevo: "combee",
	...
	buizel: {
		...
		abilities: {0: "Swift Swim", H: "Water Veil", S: "Rivalry"},
		heightm: 0.7,
		weightkg: 29.5,
		color: "Brown",
		evos: ["floatzel"],
	...
	cherubi: {
		...
		abilities: {0: "Chlorophyll", S: "Rattled"},
		heightm: 0.4,
		weightkg: 3.3,
		color: "Pink",
		evos: ["cherrim"],
	...
	cherrim: {
		...
		abilities: {0: "Flower Gift", S: "Overcoat"},
		heightm: 0.5,
		weightkg: 9.3,
		color: "Purple",
		prevo: "cherubi",
	...
	shellos: {
		...
		abilities: {0: "Sticky Hold", 1: "Storm Drain", H: "Sand Force", S: "Poison Heal"},
		heightm: 0.3,
		weightkg: 6.3,
		color: "Purple",
		evos: ["gastrodon"],
	...
	ambipom: {
		...
		abilities: {0: "Technician", 1: "Pickup", H: "Skill Link", S: "Scrappy"},
		heightm: 1.2,
		weightkg: 20.3,
		color: "Purple",
		prevo: "aipom",
	...
	drifloon: {
		...
		abilities: {0: "Aftermath", 1: "Unburden", H: "Flare Boost", S: "Aerilate"},
		heightm: 0.4,
		weightkg: 1.2,
		color: "Purple",
		evos: ["drifblim"],
	...
	buneary: {
		...
		abilities: {0: "Run Away", 1: "Klutz", H: "Limber", S: "Fluffy"},
		heightm: 0.4,
		weightkg: 5.5,
		color: "Brown",
		evos: ["lopunny"],
	...
	lopunny: {
		...
		abilities: {0: "Cute Charm", 1: "Klutz", H: "Limber", S: "Fluffy"},
		heightm: 1.2,
		weightkg: 33.3,
		color: "Brown",
		prevo: "buneary",
	...
	honchkrow: {
		...
		abilities: {0: "Insomnia", 1: "Super Luck", H: "Moxie", S: "Big Pecks"},
		heightm: 0.9,
		weightkg: 27.3,
		color: "Black",
		prevo: "murkrow",
	...
	chingling: {
		...
		abilities: {0: "Levitate", S: "Cute Charm"},
		heightm: 0.2,
		weightkg: 0.6,
		color: "Yellow",
		evos: ["chimecho"],
	...
	stunky: {
		...
		abilities: {0: "Stench", 1: "Aftermath", H: "Keen Eye", S: "Moxie"},
		heightm: 0.4,
		weightkg: 19.2,
		color: "Purple",
		evos: ["skuntank"],
	...
	bronzor: {
		...
		abilities: {0: "Levitate", 1: "Heatproof", H: "Heavy Metal", S: "Clear Body"},
		heightm: 0.5,
		weightkg: 60.5,
		color: "Green",
		evos: ["bronzong"],
	...
	bonsly: {
		...
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Rattled", S: "Cute Charm"},
		heightm: 0.5,
		weightkg: 15,
		color: "Brown",
		evos: ["sudowoodo"],
	...
	mimejr: {
		...
		abilities: {0: "Soundproof", 1: "Filter", H: "Technician", S: "Cute Charm"},
		heightm: 0.6,
		weightkg: 13,
		color: "Pink",
		evos: ["mrmime"],
	...
	happiny: {
		...
		abilities: {0: "Natural Cure", 1: "Serene Grace", H: "Friend Guard", S: "Cute Charm"},
		heightm: 0.6,
		weightkg: 24.4,
		color: "Pink",
		evos: ["chansey"],
	...
	chatot: {
		...
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Big Pecks", S: "Soundproof"},
		heightm: 0.5,
		weightkg: 1.9,
		color: "Black",
		eggGroups: ["Flying"],
	...
	spiritomb: {
		...
		abilities: {0: "Pressure", H: "Infiltrator", S: "Arena Trap"},
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	gible: {
		...
		abilities: {0: "Sand Veil", H: "Rough Skin", S: "Sand Rush"},
		heightm: 0.7,
		weightkg: 20.5,
		color: "Blue",
		evos: ["gabite"],
	...
	munchlax: {
		...
		abilities: {0: "Pickup", 1: "Thick Fat", H: "Gluttony", S: "Cute Charm"},
		heightm: 0.6,
		weightkg: 105,
		color: "Black",
		evos: ["snorlax"],
	...
	riolu: {
		...
		abilities: {0: "Steadfast", 1: "Inner Focus", H: "Prankster", S: "Cute Charm"},
		heightm: 0.7,
		weightkg: 20.2,
		color: "Blue",
		evos: ["lucario"],
	...
	lucario: {
		...
		abilities: {0: "Steadfast", 1: "Inner Focus", H: "Justified", S: "Aura Break"},
		heightm: 1.2,
		weightkg: 54,
		color: "Blue",
		prevo: "riolu",
	...
	hippopotas: {
		...
		abilities: {0: "Sand Stream", H: "Sand Force", S: "Sand Veil"},
		heightm: 0.8,
		weightkg: 49.5,
		color: "Brown",
		evos: ["hippowdon"],
	...
	skorupi: {
		...
		abilities: {0: "Battle Armor", 1: "Sniper", H: "Keen Eye", S: "Compound Eyes"},
		heightm: 0.8,
		weightkg: 12,
		color: "Purple",
		evos: ["drapion"],
	...
	drapion: {
		...
		abilities: {0: "Battle Armor", 1: "Sniper", H: "Keen Eye", S: "Merciless"},
		heightm: 1.3,
		weightkg: 61.5,
		color: "Purple",
		prevo: "skorupi",
	...
	croagunk: {
		...
		abilities: {0: "Anticipation", 1: "Dry Skin", H: "Poison Touch", S: "Inner Focus"},
		heightm: 0.7,
		weightkg: 23,
		color: "Blue",
		evos: ["toxicroak"],
	...
	toxicroak: {
		...
		abilities: {0: "Anticipation", 1: "Dry Skin", H: "Poison Touch", S: "Merciless"},
		heightm: 1.3,
		weightkg: 44.4,
		color: "Blue",
		prevo: "croagunk",
	...
	carnivine: {
		...
		species: "Carnivine",
		types: ["Grass", "Dark"],
		baseStats: {hp: 74, atk: 130, def: 72, spa: 90, spd: 72, spe: 46},
		abilities: {0: "Levitate", H: "Flytrap", S: "Arena Trap"},
		heightm: 1.4,
		weightkg: 27,
		color: "Green",
		eggGroups: ["Grass"],
	...
	finneon: {
		...
		abilities: {0: "Swift Swim", 1: "Storm Drain", H: "Water Veil", S: "Levitate"},
		heightm: 0.4,
		weightkg: 7,
		color: "Blue",
		evos: ["lumineon"],
	...
	mantyke: {
		...
		abilities: {0: "Swift Swim", 1: "Water Absorb", H: "Water Veil", S: "Cute Charm"},
		heightm: 1,
		weightkg: 65,
		color: "Blue",
		evos: ["mantine"],
	...
	snover: {
		...
		abilities: {0: "Snow Warning", H: "Soundproof", S: "Ice Body"},
		heightm: 1,
		weightkg: 50.5,
		color: "White",
		evos: ["abomasnow"],
	...
	weavile: {
		...
		abilities: {0: "Pressure", H: "Pickpocket", S: "Unnerve"},
		heightm: 1.1,
		weightkg: 34,
		color: "Black",
		prevo: "sneasel",
	...
	rhyperior: {
		...
		abilities: {0: "Lightning Rod", 1: "Solid Rock", H: "Reckless", S: "Rough Skin"},
		heightm: 2.4,
		weightkg: 282.8,
		color: "Gray",
		prevo: "rhydon",
	...
	electivire: {
		...
		abilities: {0: "Motor Drive", H: "Vital Spirit", S: "Galvanize"},
		heightm: 1.8,
		weightkg: 138.6,
		color: "Yellow",
		prevo: "electabuzz",
	...
	yanmega: {
		...
		abilities: {0: "Speed Boost", 1: "Tinted Lens", H: "Frisk", S: "Sniper"},
		heightm: 1.9,
		weightkg: 51.5,
		color: "Green",
		prevo: "yanma",
	...
	leafeon: {
		...
		abilities: {0: "Leaf Guard", H: "Chlorophyll", S: "Adaptability"},
		heightm: 1,
		weightkg: 25.5,
		color: "Green",
		prevo: "eevee",
	...
	glaceon: {
		...
		abilities: {0: "Snow Cloak", H: "Ice Body", S: "Adaptability"},
		heightm: 0.8,
		weightkg: 25.9,
		color: "Blue",
		prevo: "eevee",
	...
	gliscor: {
		...
		abilities: {0: "Hyper Cutter", 1: "Sand Veil", H: "Poison Heal", S: "Toxin Absorb"},
		heightm: 2,
		weightkg: 42.5,
		color: "Purple",
		prevo: "gligar",
	...
	porygonz: {
		...
		abilities: {0: "Adaptability", 1: "Download", H: "Analytic", S: "Levitate"},
		heightm: 0.9,
		weightkg: 34,
		color: "Red",
		prevo: "porygon2",
	...
	porygonzmega: {
		...
		formeLetter: "M",
		types: ["Normal"],
		baseStats: {hp: 85, atk: 105, def: 135, spa: 125, spd: 135, spe: 50},
		abilities: {0: "Thick Fat"},
		heightm: 1.2,
		weightkg: 94,
		color: "Red",
	...
	gallade: {
		...
		abilities: {0: "Steadfast", H: "Justified", S: "Inner Focus"},
		heightm: 1.6,
		weightkg: 52,
		color: "White",
		prevo: "kirlia",
	...
	froslass: {
		...
		abilities: {0: "Snow Cloak", H: "Cursed Body", S: "Snow Warning"},
		heightm: 1.3,
		weightkg: 26.6,
		color: "White",
		prevo: "snorunt",
	...
	rotom: {
		...
		gender: "N",
		baseStats: {hp: 50, atk: 50, def: 77, spa: 95, spd: 77, spe: 117},
		abilities: {0: "Levitate", H: "Download", S: "Volt Absorb"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["rotomheat", "rotomwash", "rotomfrost", "rotomfan", "rotommow", "rotomblend"],
	},
	rotomheat: {
		num: 479,
		species: "Rotom-Heat",
		...
		types: ["Electric", "Fire"],
		gender: "N",
		baseStats: {hp: 50, atk: 65, def: 107, spa: 105, spd: 117, spe: 86},
		abilities: {0: "Levitate", H: "Download", S: "Volt Absorb"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	rotomwash: {
		...
		gender: "N",
		baseStats: {hp: 50, atk: 65, def: 117, spa: 105, spd: 107, spe: 86},
		abilities: {0: "Levitate", H: "Download", S: "Volt Absorb"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	dialga: {
		...
		abilities: {0: "Pressure", H: "Telepathy", S: "Clear Body"},
		heightm: 5.4,
		weightkg: 683,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	palkia: {
		...
		abilities: {0: "Pressure", H: "Telepathy", S: "Water Veil"},
		heightm: 4.2,
		weightkg: 336,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	heatran: {
		...
		abilities: {0: "Flash Fire", H: "Flame Body", S: "Magma Armor"},
		heightm: 1.7,
		weightkg: 430,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	giratina: {
		...
		abilities: {0: "Pressure", H: "Telepathy", S: "Cursed Body"},
		heightm: 4.5,
		weightkg: 750,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	giratinaorigin: {
		...
		abilities: {0: "Levitate", S: "Cursed Body"},
		heightm: 6.9,
		weightkg: 650,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	cresselia: {
		...
		abilities: {0: "Levitate", S: "Wonder Skin"},
		heightm: 1.5,
		weightkg: 85.6,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	phione: {
		...
		gender: "N",
		baseStats: {hp: 80, atk: 80, def: 80, spa: 80, spd: 80, spe: 80},
		abilities: {0: "Hydration", S: "Water Absorb"},
		heightm: 0.4,
		weightkg: 3.1,
		color: "Blue",
		eggGroups: ["Water 1", "Fairy"],
	...
	darkrai: {
		...
		abilities: {0: "Bad Dreams", S: "Sharp Shadow"},
		heightm: 1.5,
		weightkg: 50.5,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	shaymin: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Natural Cure", S: "Justified"},
		heightm: 0.2,
		weightkg: 2.1,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	shayminsky: {
		...
		abilities: {0: "Serene Grace", S: "Justified"},
		heightm: 0.4,
		weightkg: 5.2,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	victini: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Victory Star", S: "Flame Body"},
		heightm: 0.4,
		weightkg: 4,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	snivy: {
		...
		abilities: {0: "Overgrow", H: "Contrary", S: "Regenerator"},
		heightm: 0.6,
		weightkg: 8.1,
		color: "Green",
		evos: ["servine"],
	...
	tepig: {
		...
		abilities: {0: "Blaze", H: "Thick Fat", S: "Reckless"},
		heightm: 0.5,
		weightkg: 9.9,
		color: "Red",
		evos: ["pignite"],
	...
	oshawott: {
		...
		abilities: {0: "Torrent", H: "Shell Armor", S: "Justified"},
		heightm: 0.5,
		weightkg: 5.9,
		color: "Blue",
		evos: ["dewott"],
	...
	patrat: {
		...
		abilities: {0: "Run Away", 1: "Keen Eye", H: "Analytic", S: "No Guard"},
		heightm: 0.5,
		weightkg: 11.6,
		color: "Brown",
		evos: ["watchog"],
	...
	lillipup: {
		...
		abilities: {0: "Vital Spirit", 1: "Pickup", H: "Run Away", S: "Fluffy"},
		heightm: 0.4,
		weightkg: 4.1,
		color: "Brown",
		evos: ["herdier"],
	...
	herdier: {
		...
		species: "Herdier",
		types: ["Normal"],
		baseStats: {hp: 65, atk: 80, def: 65, spa: 35, spd: 65, spe: 60, S: "Fluffy"},
	...
	stoutland: {
		...
		abilities: {0: "Intimidate", 1: "Sand Rush", H: "Scrappy", S: "Thick Fat"},
		heightm: 1.2,
		weightkg: 61,
		color: "Gray",
		prevo: "herdier",
	...
	purrloin: {
		...
		abilities: {0: "Limber", 1: "Unburden", H: "Prankster", S: "Keen Eye"},
		heightm: 0.4,
		weightkg: 10.1,
		color: "Purple",
		evos: ["liepard"],
	...
	pansage: {
		...
		abilities: {0: "Gluttony", H: "Overgrow", S: "Chlorophyll"},
		heightm: 0.6,
		weightkg: 10.5,
		color: "Green",
		evos: ["simisage"],
	...
	pansear: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 50, atk: 53, def: 48, spa: 53, spd: 48, spe: 64},
		abilities: {0: "Gluttony", H: "Blaze", S: "Solar Power"},
		heightm: 0.6,
		weightkg: 11,
		color: "Red",
		evos: ["simisear"],
	...
	panpour: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 50, atk: 53, def: 48, spa: 53, spd: 48, spe: 64},
		abilities: {0: "Gluttony", H: "Torrent", S: "Swift Swim"},
		heightm: 0.6,
		weightkg: 13.5,
		color: "Blue",
		evos: ["simipour"],
	...
	munna: {
		...
		abilities: {0: "Forewarn", 1: "Synchronize", H: "Telepathy", S: "Levitate"},
		heightm: 0.6,
		weightkg: 23.3,
		color: "Pink",
		evos: ["musharna"],
	...
	musharna: {
		...
		abilities: {0: "Forewarn", 1: "Synchronize", H: "Bad Dreams", S: "Levitate"},
		heightm: 1.1,
		weightkg: 60.5,
		color: "Pink",
		prevo: "munna",
	...
	pidove: {
		...
		abilities: {0: "Big Pecks", 1: "Super Luck", H: "Rivalry", S: "Serene Grace"},
		heightm: 0.3,
		weightkg: 2.1,
		color: "Gray",
		evos: ["tranquill"],
	...
	blitzle: {
		...
		abilities: {0: "Lightning Rod", 1: "Motor Drive", H: "Sap Sipper", S: "Volt Absorb"},
		heightm: 0.8,
		weightkg: 29.8,
		color: "Black",
		evos: ["zebstrika"],
	...
	roggenrola: {
		...
		abilities: {0: "Sturdy", 1: "Weak Armor", H: "Sand Force", S: "Sand Veil"},
		heightm: 0.4,
		weightkg: 18,
		color: "Blue",
		evos: ["boldore"],
	...
	gigalith: {
		...
		abilities: {0: "Sturdy", 1: "Sand Stream", H: "Sand Force", S: "Sand Veil"},
		heightm: 1.7,
		weightkg: 260,
		color: "Blue",
		prevo: "boldore",
	...
	woobat: {
		...
		abilities: {0: "Unaware", 1: "Klutz", H: "Simple", S: "No Guard"},
		heightm: 0.4,
		weightkg: 2.1,
		color: "Blue",
		evos: ["swoobat"],
	...
	drilbur: {
		...
		abilities: {0: "Sand Rush", 1: "Sand Force", H: "Mold Breaker", S: "Sheer Force"},
		heightm: 0.3,
		weightkg: 8.5,
		color: "Gray",
		evos: ["excadrill"],
	...
	audino: {
		...
		abilities: {0: "Healer", 1: "Regenerator", H: "Klutz", S: "Natural Cure"},
		heightm: 1.1,
		weightkg: 31,
		color: "Pink",
		eggGroups: ["Fairy"],
	...
	timburr: {
		...
		abilities: {0: "Guts", 1: "Sheer Force", H: "Iron Fist", S: "Chlorophyll"},
		heightm: 0.6,
		weightkg: 12.5,
		color: "Gray",
		evos: ["gurdurr"],
	...
	gurdurr: {
		...
		abilities: {0: "Guts", 1: "Sheer Force", H: "Iron Fist", S: "Filter"},
		heightm: 1.2,
		weightkg: 40,
		color: "Gray",
		prevo: "timburr",
	...
	conkeldurr: {
		...
		abilities: {0: "Guts", 1: "Sheer Force", H: "Iron Fist", S: "Solid Rock"},
		heightm: 1.4,
		weightkg: 87,
		color: "Brown",
		prevo: "gurdurr",
	...
	tympole: {
		...
		abilities: {0: "Swift Swim", 1: "Hydration", H: "Water Absorb", S: "Soundproof"},
		heightm: 0.5,
		weightkg: 4.5,
		color: "Blue",
		evos: ["palpitoad"],
	...
	seismitoad: {
		...
		abilities: {0: "Swift Swim", 1: "Poison Touch", H: "Water Absorb", S: "Soundproof"},
		heightm: 1.5,
		weightkg: 62,
		color: "Blue",
		prevo: "palpitoad",
	...
	throh: {
		...
		abilities: {0: "Guts", 1: "Inner Focus", H: "Mold Breaker", S: "Thick Fat"},
		heightm: 1.3,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
	...
	sawk: {
		...
		abilities: {0: "Sturdy", 1: "Inner Focus", H: "Mold Breaker", S: "Limber"},
		heightm: 1.4,
		weightkg: 51,
		color: "Blue",
		eggGroups: ["Human-Like"],
	...
	sewaddle: {
		...
		abilities: {0: "Swarm", 1: "Chlorophyll", H: "Overcoat", S: "Serene Grace"},
		heightm: 0.3,
		weightkg: 2.5,
		color: "Yellow",
		evos: ["swadloon"],
	...
	swadloon: {
		...
		abilities: {0: "Leaf Guard", 1: "Chlorophyll", H: "Overcoat", S: "Serene Grace"},
		heightm: 0.5,
		weightkg: 7.3,
		color: "Green",
		prevo: "sewaddle",
	...
	cottonee: {
		...
		abilities: {0: "Prankster", 1: "Infiltrator", H: "Chlorophyll", S: "Wind Surfer"},
		heightm: 0.3,
		weightkg: 0.6,
		color: "Green",
		evos: ["whimsicott"],
	...
	petilil: {
		...
		abilities: {0: "Chlorophyll", 1: "Own Tempo", H: "Leaf Guard", S: "Dancer"},
		heightm: 0.5,
		weightkg: 6.6,
		color: "Green",
		evos: ["lilligant"],
	...
	basculin: {
		...
		abilities: {0: "Reckless", 1: "Adaptability", H: "Mold Breaker", S: "Sheer Force"},
		heightm: 1,
		weightkg: 18,
		color: "Green",
		eggGroups: ["Water 2"],
	...
	basculinbluestriped: {
		...
		types: ["Water"],
		baseStats: {hp: 70, atk: 92, def: 65, spa: 80, spd: 55, spe: 98},
		abilities: {0: "Rock Head", 1: "Adaptability", H: "Mold Breaker", S: "Sheer Force"},
		heightm: 1,
		weightkg: 18,
		color: "Green",
		eggGroups: ["Water 2"],
	...
	sandile: {
		...
		abilities: {0: "Intimidate", 1: "Moxie", H: "Anger Point", S: "Sand Veil"},
		heightm: 0.7,
		weightkg: 15.2,
		color: "Brown",
		evos: ["krokorok"],
	...
	darumaka: {
		...
		abilities: {0: "Hustle", H: "Inner Focus", S: "Prankster"},
		heightm: 0.6,
		weightkg: 37.5,
		color: "Red",
		evos: ["darmanitan"],
	...
	darmanitan: {
		...
		abilities: {0: "Sheer Force", H: "Zen Mode", S: "Iron Fist"},
		heightm: 1.3,
		weightkg: 92.9,
		color: "Red",
		prevo: "darumaka",
	...
	maractus: {
		...
		abilities: {0: "Water Absorb", 1: "Chlorophyll", H: "Storm Drain", S: "Rough Skin"},
		heightm: 1,
		weightkg: 28,
		color: "Green",
		eggGroups: ["Grass"],
	...
	dwebble: {
		...
		abilities: {0: "Sturdy", 1: "Shell Armor", H: "Weak Armor", S: "Solid Rock"},
		heightm: 0.3,
		weightkg: 14.5,
		color: "Red",
		evos: ["crustle"],
	...
	scraggy: {
		...
		abilities: {0: "Shed Skin", 1: "Moxie", H: "Intimidate", S: "Rock Head"},
		heightm: 0.6,
		weightkg: 11.8,
		color: "Yellow",
		evos: ["scrafty"],
	...
	sigilyph: {
		...
		abilities: {0: "Wonder Skin", 1: "Magic Guard", H: "Tinted Lens", S: "Magic Bounce"},
		heightm: 1.4,
		weightkg: 14,
		color: "Black",
		prevo: "unown",
	...
	yamask: {
		...
		abilities: {0: "Mummy", S: "Adaptability"},
		heightm: 0.5,
		weightkg: 1.5,
		color: "Black",
		evos: ["cofagrigus"],
	...
	tirtouga: {
		...
		abilities: {0: "Solid Rock", 1: "Sturdy", H: "Swift Swim", S: "Sheer Force"},
		heightm: 0.7,
		weightkg: 16.5,
		color: "Blue",
		evos: ["carracosta"],
	...
	archen: {
		...
		abilities: {0: "Defeatist", S: "Early Bird"},
		heightm: 0.5,
		weightkg: 9.5,
		color: "Yellow",
		evos: ["archeops"],
	...
	trubbish: {
		...
		abilities: {0: "Stench", 1: "Sticky Hold", H: "Aftermath", S: "Sheer Force"},
		heightm: 0.6,
		weightkg: 31,
		color: "Green",
		evos: ["garbodor"],
	...
	garbodor: {
		...
		abilities: {0: "Stench", 1: "Weak Armor", H: "Aftermath", S: "Sheer Force"},
		heightm: 1.9,
		weightkg: 107.3,
		color: "Green",
		prevo: "trubbish",
	...
	zorua: {
		...
		abilities: {0: "Illusion", S: "Prankster"},
		heightm: 0.7,
		weightkg: 12.5,
		color: "Gray",
		evos: ["zoroark"],
	...
	minccino: {
		...
		abilities: {0: "Cute Charm", 1: "Technician", H: "Skill Link", S: "Fur Coat"},
		heightm: 0.4,
		weightkg: 5.8,
		color: "Gray",
		evos: ["cinccino"],
	...
	gothita: {
		...
		abilities: {0: "Frisk", 1: "Competitive", H: "Shadow Tag", S: "Trace"},
		heightm: 0.4,
		weightkg: 5.8,
		color: "Purple",
		evos: ["gothorita"],
	...
	solosis: {
		...
		abilities: {0: "Overcoat", 1: "Magic Guard", H: "Regenerator", S: "Gooey"},
		heightm: 0.3,
		weightkg: 1,
		color: "Green",
		evos: ["duosion"],
	...
	ducklett: {
		...
		abilities: {0: "Keen Eye", 1: "Big Pecks", H: "Hydration", S: "Swift Swim"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Blue",
		evos: ["swanna"],
	...
	vanillite: {
		...
		abilities: {0: "Ice Body", 1: "Snow Cloak", H: "Weak Armor", S: "Slush Rush"},
		heightm: 0.4,
		weightkg: 5.7,
		color: "White",
		evos: ["vanillish"],
	...
	vanilluxe: {
		...
		abilities: {0: "Ice Body", 1: "Snow Warning", H: "Weak Armor", S: "Slush Rush"},
		heightm: 1.3,
		weightkg: 57.5,
		color: "White",
		prevo: "vanillish",
	...
	deerling: {
		...
		abilities: {0: "Chlorophyll", 1: "Sap Sipper", H: "Serene Grace", S: "Leaf Guard"},
		heightm: 0.6,
		weightkg: 19.5,
		color: "Pink",
		evos: ["sawsbuck"],
	...
	sawsbuck: {
		...
		abilities: {0: "Chlorophyll", 1: "Sap Sipper", H: "Serene Grace", S: "Leaf Blade"},
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
		prevo: "deerling",
	...
	emolga: {
		...
		abilities: {0: "Static", 1: "Wind Surfer", H: "Motor Drive", S: "Cute Charm"},
		heightm: 0.4,
		weightkg: 5,
		color: "White",
		eggGroups: ["Field"],
	...
	karrablast: {
		...
		abilities: {0: "Swarm", 1: "Shed Skin", H: "No Guard", S: "Rattled"},
		heightm: 0.5,
		weightkg: 5.9,
		color: "Blue",
		evos: ["escavalier"],
	...
	escavalier: {
		...
		abilities: {0: "Swarm", 1: "Shell Armor", H: "Overcoat", S: "Justified"},
		heightm: 1,
		weightkg: 33,
		color: "Gray",
		prevo: "karrablast",
	...
	foongus: {
		...
		abilities: {0: "Effect Spore", H: "Regenerator", S: "Moxie"},
		heightm: 0.2,
		weightkg: 1,
		color: "White",
		evos: ["amoonguss"],
	...
	frillish: {
		...
		abilities: {0: "Water Absorb", 1: "Cursed Body", H: "Damp", S: "Sticky Hold"},
		heightm: 1.2,
		weightkg: 33,
		color: "White",
		evos: ["jellicent"],
	...
	alomomola: {
		...
		abilities: {0: "Healer", 1: "Hydration", H: "Regenerator", S: "Swift Swim"},
		heightm: 1.2,
		weightkg: 31.6,
		color: "Pink",
		eggGroups: ["Water 1", "Water 2"],
	...
	joltik: {
		...
		abilities: {0: "Compound Eyes", 1: "Unnerve", H: "Swarm", S: "Silk Sifter"},
		heightm: 0.1,
		weightkg: 0.6,
		color: "Yellow",
		evos: ["galvantula"],
	...
	ferroseed: {
		...
		abilities: {0: "Iron Barbs", S: "Light Metal"},
		heightm: 0.6,
		weightkg: 18.8,
		color: "Gray",
		evos: ["ferrothorn"],
	...
	ferrothorn: {
		...
		abilities: {0: "Iron Barbs", H: "Anticipation", S: "Light Metal"},
		heightm: 1,
		weightkg: 110,
		color: "Gray",
		prevo: "ferroseed",
	...
	tynamo: {
		...
		abilities: {0: "Levitate", S: "Run Away"},
		heightm: 0.2,
		weightkg: 0.3,
		color: "White",
		evos: ["eelektrik"],
	...
	eelektrik: {
		...
		abilities: {0: "Levitate", S: "Poison Touch"},
		heightm: 1.2,
		weightkg: 22,
		color: "Blue",
		prevo: "tynamo",
	...
	eelektross: {
		...
		abilities: {0: "Levitate", S: "Poison Tough"},
		heightm: 2.1,
		weightkg: 80.5,
		color: "Blue",
		prevo: "eelektrik",
	...
	elgyem: {
		...
		abilities: {0: "Telepathy", 1: "Synchronize", H: "Analytic", S: "Compound Eyes"},
		heightm: 0.5,
		weightkg: 9,
		color: "Blue",
		evos: ["beheeyem"],
	...
	litwick: {
		...
		abilities: {0: "Flash Fire", 1: "Flame Body", H: "Infiltrator", S: "Gooey"},
		heightm: 0.3,
		weightkg: 3.1,
		color: "White",
		evos: ["lampent"],
	...
	axew: {
		...
		abilities: {0: "Rivalry", 1: "Mold Breaker", H: "Unnerve", S: "Moxie"},
		heightm: 0.6,
		weightkg: 18,
		color: "Green",
		evos: ["fraxure"],
	...
	cubchoo: {
		...
		abilities: {0: "Snow Cloak", 1: "Slush Rush", H: "Rattled", S: "Honey Gather"},
		heightm: 0.5,
		weightkg: 8.5,
		color: "White",
		evos: ["beartic"],
	...
	beartic: {
		...
		abilities: {0: "Snow Cloak", 1: "Slush Rush", H: "Swift Swim", S: "Intimidate"},
		heightm: 2.6,
		weightkg: 260,
		color: "White",
		prevo: "cubchoo",
	...
	cryogonal: {
		...
		abilities: {0: "Levitate", S: "Ice Body"},
		heightm: 1.1,
		weightkg: 148,
		color: "Blue",
		eggGroups: ["Mineral"],
		otherFormes: ["cryogonalmega"],
	},
	cryogonalmega: {
		num: 615,
		...
		formeLetter: "M",
		types: ["Ice", "Steel"],
		baseStats: {hp: 80, atk: 90, def: 100, spa: 105, spd: 135, spe: 105},
	...
	shelmet: {
		...
		abilities: {0: "Hydration", 1: "Shell Armor", H: "Overcoat", S: "Battle Armor"},
		heightm: 0.4,
		weightkg: 7.7,
		color: "Red",
		evos: ["accelgor"],
	...
	mienfoo: {
		...
		abilities: {0: "Inner Focus", 1: "Regenerator", H: "Reckless", S: "Mold Breaker"},
		heightm: 0.9,
		weightkg: 20,
		color: "Yellow",
		evos: ["mienshao"],
	...
	druddigon: {
		...
		abilities: {0: "Rough Skin", 1: "Sheer Force", H: "Mold Breaker", S: "Tough Claws"},
		heightm: 1.6,
		weightkg: 139,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	golett: {
		...
		abilities: {0: "Iron Fist", 1: "Klutz", H: "No Guard", S: "Cursed Body"},
		heightm: 1,
		weightkg: 92,
		color: "Green",
		evos: ["golurk"],
	...
	pawniard: {
		...
		abilities: {0: "Defiant", 1: "Inner Focus", H: "Pressure", S: "Clear Body"},
		heightm: 0.5,
		weightkg: 10.2,
		color: "Red",
		evos: ["bisharp"],
	...
	bouffalant: {
		...
		abilities: {0: "Reckless", 1: "Sap Sipper", H: "Soundproof", S: "Rock Head"},
		heightm: 1.6,
		weightkg: 94.6,
		color: "Brown",
		eggGroups: ["Field"],
	...
	rufflet: {
		...
		abilities: {0: "Keen Eye", 1: "Sheer Force", H: "Hustle", S: "Justified"},
		heightm: 0.5,
		weightkg: 10.5,
		color: "White",
		evos: ["braviary"],
	...
	braviary: {
		...
		abilities: {0: "Keen Eye", 1: "Sheer Force", H: "Defiant", S: "Justified"},
		heightm: 1.5,
		weightkg: 41,
		color: "Red",
		prevo: "rufflet",
	...
	vullaby: {
		...
		abilities: {0: "Big Pecks", 1: "Overcoat", H: "Weak Armor", S: "Battle Armor"},
		heightm: 0.5,
		weightkg: 9,
		color: "Brown",
		evos: ["mandibuzz"],
	...
	mandibuzz: {
		...
		abilities: {0: "Stormbringer", 1: "Overcoat", H: "Weak Armor", S: "Battle Armor"},
		heightm: 1.2,
		weightkg: 39.5,
		color: "Brown",
		prevo: "vullaby",
	...
	heatmor: {
		...
		abilities: {0: "Gluttony", 1: "Flash Fire", H: "White Smoke", S: "Adaptability"},
		heightm: 1.4,
		weightkg: 58,
		color: "Red",
		eggGroups: ["Field"],
	...
	heatmormega: {
		...
		formeLetter: "M",
		types: ["Fire"],
		baseStats: {hp: 85, atk: 117, def: 96, spa: 120, spd: 96, spe: 70},
		abilities: {0: "Flytrap"},
		heightm: 1.4,
		weightkg: 58,
		color: "Red",
	...
	durant: {
		...
		abilities: {0: "Swarm", 1: "Hustle", H: "Truant", S: "Heatproof"},
		heightm: 0.3,
		weightkg: 33,
		color: "Gray",
		eggGroups: ["Bug"],
	...
	deino: {
		...
		abilities: {0: "Hustle", S: "Intimidate"},
		heightm: 0.8,
		weightkg: 17.3,
		color: "Blue",
		evos: ["zweilous"],
	...
	hydreigon: {
		...
		abilities: {0: "Levitate", S: "Intimidate"},
		heightm: 1.8,
		weightkg: 160,
		color: "Blue",
		prevo: "zweilous",
	...
	larvesta: {
		...
		abilities: {0: "Flame Body", H: "Swarm", S: "Flash Fire"},
		heightm: 1.1,
		weightkg: 28.8,
		color: "White",
		evos: ["volcarona"],
	...
	cobalion: {
		...
		abilities: {0: "Justified", S: "Heatproof"},
		heightm: 2.1,
		weightkg: 250,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	terrakion: {
		...
		abilities: {0: "Justified", S: "Rock Head"},
		heightm: 1.9,
		weightkg: 260,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	virizion: {
		...
		abilities: {0: "Justified", S: "Leaf Guard"},
		heightm: 2,
		weightkg: 200,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	tornadus: {
		...
		abilities: {0: "Prankster", H: "Defiant", S: "Air Lock"},
		heightm: 1.5,
		weightkg: 63,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	tornadustherian: {
		...
		abilities: {0: "Regenerator", S: "Air Lock"},
		heightm: 1.4,
		weightkg: 63,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	thundurus: {
		...
		gender: "M",
		baseStats: {hp: 79, atk: 115, def: 70, spa: 125, spd: 80, spe: 111},
		abilities: {0: "Prankster", H: "Defiant", S: "No Guard"},
		heightm: 1.5,
		weightkg: 61,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	thundurustherian: {
		...
		abilities: {0: "Volt Absorb", S: "No Guard"},
		heightm: 3,
		weightkg: 61,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	reshiram: {
		...
		abilities: {0: "Turboblaze", S: "Flash Fire"},
		heightm: 3.2,
		weightkg: 330,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	zekrom: {
		...
		abilities: {0: "Teravolt", S: "Volt Absorb"},
		heightm: 2.9,
		weightkg: 345,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	landorus: {
		...
		abilities: {0: "Sand Force", H: "Sheer Force", S: "Sand Stream"},
		heightm: 1.5,
		weightkg: 68,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	landorustherian: {
		...
		abilities: {0: "Intimidate", S: "Sand Stream"},
		heightm: 1.3,
		weightkg: 68,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	kyurem: {
		...
		abilities: {0: "Pressure", S: "Clear Body"},
		heightm: 3,
		weightkg: 325,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	keldeo: {
		...
		abilities: {0: "Justified", S: "Rain Dish"},
		heightm: 1.4,
		weightkg: 48.5,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	meloetta: {
		...
		abilities: {0: "Serene Grace", S: "Soundproof"},
		heightm: 0.6,
		weightkg: 6.5,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	genesect: {
		...
		abilities: {0: "Download", 1: "Metallic Bond", S: "Analytic"},
		heightm: 1.5,
		weightkg: 82.5,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	genesectdouse: {
		...
		gender: "N",
		baseStats: {hp: 71, atk: 120, def: 95, spa: 120, spd: 95, spe: 99},
		abilities: {0: "Download", S: "Analytic"},
		heightm: 1.5,
		weightkg: 82.5,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	chespin: {
		...
		abilities: {0: "Overgrow", H: "Bulletproof", S: "Sheer Force"},
		heightm: 0.4,
		weightkg: 9,
		color: "Green",
		evos: ["quilladin"],
	...
	fennekin: {
		...
		abilities: {0: "Blaze", H: "Magician", S: "Dazzling"},
		heightm: 0.4,
		weightkg: 9.4,
		color: "Red",
		evos: ["braixen"],
	...
	froakie: {
		...
		abilities: {0: "Torrent", H: "Protean", S: "Sticky Hold"},
		heightm: 0.3,
		weightkg: 7,
		color: "Blue",
		evos: ["frogadier"],
	...
	greninja: {
		...
		abilities: {0: "Torrent", 1: "Battle Bond", H: "Protean", S: "Sticky Hold"},
		heightm: 1.5,
		weightkg: 40,
		color: "Blue",
		prevo: "frogadier",
	...
	bunnelby: {
		...
		abilities: {0: "Pickup", 1: "Cheek Pouch", H: "Huge Power", S: "Thick Fat"},
		heightm: 0.4,
		weightkg: 5,
		color: "Brown",
		evos: ["diggersby"],
	...
	fletchling: {
		...
		abilities: {0: "Big Pecks", H: "Gale Wings", S: "Keen Eye"},
		heightm: 0.3,
		weightkg: 1.7,
		color: "Red",
		evos: ["fletchinder"],
	...
	fletchinder: {
		...
		abilities: {0: "Flame Body", H: "Gale Wings", S: "Reckless"},
		heightm: 0.7,
		weightkg: 16,
		color: "Red",
		prevo: "fletchling",
	...
	scatterbug: {
		...
		abilities: {0: "Shield Dust", 1: "Compound Eyes", H: "Friend Guard", S: "Dazzling"},
		heightm: 0.3,
		weightkg: 2.5,
		color: "Black",
		evos: ["spewpa"],
	...
	spewpa: {
		...
		abilities: {0: "Shed Skin", H: "Friend Guard", S: "Dazzling"},
		heightm: 0.3,
		weightkg: 8.4,
		color: "Black",
		prevo: "scatterbug",
	...
	vivillonfancy: {
		...
		types: ["Bug", "Fairy"],
		baseStats: {hp: 80, atk: 52, def: 50, spa: 90, spd: 50, spe: 89},
		abilities: {0: "Shield Dust", 1: "Compound Eyes", S: "Dazzling"},
		heightm: 1.2,
		weightkg: 17,
		color: "Black",
		eggGroups: ["Bug"],
	...
	litleo: {
		...
		abilities: {0: "Rivalry", 1: "Unnerve", H: "Moxie", S: "Flame Body"},
		heightm: 0.6,
		weightkg: 13.5,
		color: "Brown",
		evos: ["pyroar"],
	...
	flabebe: {
		...
		abilities: {0: "Flower Veil", H: "Symbiosis", S: "Serene Grace"},
		heightm: 0.1,
		weightkg: 0.1,
		color: "White",
		evos: ["floette"],
	...
	skiddo: {
		...
		abilities: {0: "Sap Sipper", H: "Grass Pelt", S: "Triage"},
		heightm: 0.9,
		weightkg: 31,
		color: "Brown",
		evos: ["gogoat"],
	...
	gogoat: {
		...
		abilities: {0: "Sap Sipper", 1: "Rock Head", H: "Grass Pelt", S: "Triage"},
		heightm: 1.7,
		weightkg: 91,
		color: "Brown",
		prevo: "skiddo",
	...
	pancham: {
		...
		abilities: {0: "Iron Fist", 1: "Mold Breaker", H: "Scrappy", S: "Thick Fat"},
		heightm: 0.6,
		weightkg: 8,
		color: "White",
		evos: ["pangoro"],
	...
	furfroudandy: {
		...
		types: ["Normal", "Grass"],
		baseStats: {hp: 75, atk: 80, def: 60, spa: 65, spd: 90, spe: 102},
		abilities: {0: "Fur Coat", S: "Mold Breaker"},
		heightm: 1.2,
		weightkg: 28,
		color: "White",
		eggGroups: ["Field"],
	...
	espurr: {
		...
		abilities: {0: "Keen Eye", 1: "Infiltrator", H: "Own Tempo", S: "Forewarn"},
		heightm: 0.3,
		weightkg: 3.5,
		color: "Gray",
		evos: ["meowstic"],
	...
	meowstic: {
		...
		abilities: {0: "Keen Eye", 1: "Infiltrator", H: "Prankster", S: "Forewarn"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "Blue",
		prevo: "espurr",
	...
	meowsticf: {
		...
		gender: "F",
		baseStats: {hp: 74, atk: 48, def: 76, spa: 83, spd: 81, spe: 104},
		abilities: {0: "Keen Eye", 1: "Infiltrator", H: "Competitive", S: "Forewarn"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "White",
		prevo: "espurr",
	...
	honedge: {
		...
		abilities: {0: "No Guard", S: "Justified"},
		heightm: 0.8,
		weightkg: 2,
		color: "Brown",
		evos: ["doublade"],
	...
	aegislash: {
		...
		abilities: {0: "Stance Change", S: "Justified"},
		heightm: 1.7,
		weightkg: 53,
		color: "Brown",
		prevo: "doublade",
	...
	spritzee: {
		...
		abilities: {0: "Healer", H: "Aroma Veil", S: "Dazzling"},
		heightm: 0.2,
		weightkg: 0.5,
		color: "Pink",
		evos: ["aromatisse"],
	...
	swirlix: {
		...
		abilities: {0: "Sweet Veil", H: "Unburden", S: "Gooey"},
		heightm: 0.4,
		weightkg: 3.5,
		color: "White",
		evos: ["slurpuff"],
	...
	inkay: {
		...
		abilities: {0: "Contrary", 1: "Suction Cups", H: "Infiltrator", S: "Prankster"},
		heightm: 0.4,
		weightkg: 3.5,
		color: "Blue",
		evos: ["malamar"],
	...
	binacle: {
		...
		abilities: {0: "Tough Claws", 1: "Sniper", H: "Pickpocket", S: "Iron Fist"},
		heightm: 0.5,
		weightkg: 31,
		color: "Brown",
		evos: ["barbaracle"],
	...
	skrelp: {
		...
		abilities: {0: "Poison Point", 1: "Poison Touch", H: "Adaptability", S: "Sheer Force"},
		heightm: 0.5,
		weightkg: 7.3,
		color: "Brown",
		evos: ["dragalge"],
	...
	clauncher: {
		...
		abilities: {0: "Mega Launcher", S: "Sheer Force"},
		heightm: 0.5,
		weightkg: 8.3,
		color: "Blue",
		evos: ["clawitzer"],
	...
	helioptile: {
		...
		abilities: {0: "Dry Skin", 1: "Sand Veil", H: "Solar Power", S: "Slush Rush"},
		heightm: 0.5,
		weightkg: 6,
		color: "Yellow",
		evos: ["heliolisk"],
	...
	tyrunt: {
		...
		abilities: {0: "Strong Jaw", H: "Sturdy", S: "Anger Point"},
		heightm: 0.8,
		weightkg: 26,
		color: "Brown",
		evos: ["tyrantrum"],
	...
	tyrantrum: {
		...
		abilities: {0: "Strong Jaw", H: "Rock Head", S: "Anger Point"},
		heightm: 2.5,
		weightkg: 270,
		color: "Red",
		prevo: "tyrunt",
	...
	amaura: {
		...
		abilities: {0: "Refrigerate", H: "Snow Warning", S: "Ice Body"},
		heightm: 1.3,
		weightkg: 25.2,
		color: "Blue",
		evos: ["aurorus"],
	...
	sylveon: {
		...
		abilities: {0: "Cute Charm", H: "Pixilate", S: "Adaptability"},
		heightm: 1,
		weightkg: 23.5,
		color: "Pink",
		prevo: "eevee",
	...
	hawlucha: {
		...
		abilities: {0: "Limber", 1: "Unburden", H: "Mold Breaker", S: "Justified"},
		heightm: 0.8,
		weightkg: 21.5,
		color: "Green",
		eggGroups: ["Human-Like"],
	...
	dedenne: {
		...
		abilities: {0: "Cheek Pouch", 1: "Pickup", H: "Plus", S: "Lightning Rod"},
		heightm: 0.2,
		weightkg: 2.2,
		color: "Yellow",
		eggGroups: ["Field", "Fairy"],
	...
	carbink: {
		...
		types: ["Rock", "Fairy"],
		gender: "N",
		baseStats: {hp: 50, atk: 50, def: 100, spa: 50, spd: 100, spe: 50},
		abilities: {0: "Clear Body", H: "Sturdy", S: "Pixilate"},
		heightm: 0.3,
		weightkg: 5.7,
		color: "Gray",
		evos: ["diancie"],
	...
	goomy: {
		...
		abilities: {0: "Sap Sipper", 1: "Hydration", H: "Gooey", S: "Sticky Hold"},
		heightm: 0.3,
		weightkg: 2.8,
		color: "Purple",
		evos: ["sliggoo"],
	...
	klefki: {
		...
		abilities: {0: "Prankster", H: "Magician", S: "Pickpocket"},
		heightm: 0.2,
		weightkg: 3,
		color: "Gray",
		eggGroups: ["Mineral"],
	...
	klefkimega: {
		...
		formeLetter: "M",
		types: ["Steel", "Dark"],
		baseStats: {hp: 57, atk: 100, def: 113, spa: 120, spd: 125, spe: 55},
		abilities: {0: "Triage"},
		heightm: 0.5,
		weightkg: 10,
		color: "Gray",
	...
	phantump: {
		...
		abilities: {0: "Natural Cure", 1: "Frisk", H: "Harvest", S: "Sap Sipper"},
		heightm: 0.4,
		weightkg: 7,
		color: "Brown",
		evos: ["trevenant"],
	...
	pumpkaboo: {
		...
		abilities: {0: "Pickup", 1: "Frisk", H: "Insomnia", S: "Flash Fire"},
		heightm: 0.4,
		weightkg: 5,
		color: "Brown",
		evos: ["gourgeist"],
	...
	bergmite: {
		...
		abilities: {0: "Own Tempo", 1: "Ice Body", H: "Sturdy", S: "Snow Cloak"},
		heightm: 1,
		weightkg: 99.5,
		color: "Blue",
		evos: ["avalugg"],
	...
	noibat: {
		...
		abilities: {0: "Frisk", 1: "Infiltrator", H: "Telepathy", S: "Scrappy"},
		heightm: 0.5,
		weightkg: 8,
		color: "Purple",
		evos: ["noivern"],
	...
	xerneas: {
		...
		abilities: {0: "Fairy Aura", S: "Serene Grace"},
		heightm: 3,
		weightkg: 215,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	yveltal: {
		...
		gender: "N",
		baseStats: {hp: 126, atk: 131, def: 95, spa: 131, spd: 98, spe: 99},
		abilities: {0: "Dark Aura", S: "Sheer Force"},
		heightm: 5.8,
		weightkg: 203,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	zygarde: {
		...
		abilities: {0: "Aura Break", H: "Power Construct", S: "Inner Focus"},
		heightm: 5,
		weightkg: 305,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	zygardecomplete: {
		...
		abilities: {0: "Power Construct", S: "Inner Focus"},
		heightm: 4.5,
		weightkg: 610,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	diancie: {
		...
		abilities: {0: "Clear Body", S: "Pixilate"},
		heightm: 0.7,
		weightkg: 8.8,
		color: "Pink",
		prevo: "carbink",
	...
	hoopa: {
		...
		abilities: {0: "Magician", S: "Prankster"},
		heightm: 0.5,
		weightkg: 9,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	volcanion: {
		...
		abilities: {0: "Water Absorb", S: "Flash Fire"},
		heightm: 1.7,
		weightkg: 195,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	rowlet: {
		...
		abilities: {0: "Overgrow", H: "Long Reach", S: "No Guard"},
		heightm: 0.3,
		weightkg: 1.5,
		color: "Brown",
		evos: ["dartrix"],
	...
	litten: {
		...
		abilities: {0: "Blaze", H: "Intimidate", S: "Iron Fist"},
		heightm: 0.4,
		weightkg: 4.3,
		color: "Red",
		evos: ["torracat"],
	...
	popplio: {
		...
		abilities: {0: "Torrent", H: "Liquid Voice", S: "Soundproof"},
		heightm: 0.4,
		weightkg: 7.5,
		color: "Blue",
		evos: ["brionne"],
	...
	pikipek: {
		...
		abilities: {0: "Keen Eye", 1: "Skill Link", H: "Pickup", S: "Big Pecks"},
		heightm: 0.3,
		weightkg: 1.2,
		color: "Black",
		evos: ["trumbeak"],
	...
	toucannon: {
		...
		abilities: {0: "Keen Eye", 1: "Skill Link", H: "Sheer Force", S: "Anger Point"},
		heightm: 1.1,
		weightkg: 26,
		color: "Black",
		prevo: "trumbeak",
	...
	yungoos: {
		...
		abilities: {0: "Stakeout", 1: "Strong Jaw", H: "Adaptability", S: "Pickup"},
		heightm: 0.4,
		weightkg: 6,
		color: "Brown",
		evos: ["gumshoos"],
	...
	gumshoos: {
		...
		abilities: {0: "Stakeout", 1: "Strong Jaw", H: "Adaptability", S: "Sheer Force"},
		heightm: 0.7,
		weightkg: 14.2,
		color: "Brown",
		prevo: "yungoos",
	...
	charjabug: {
		...
		abilities: {0: "Battery", S: "Galvanize"},
		heightm: 0.5,
		weightkg: 10.5,
		color: "Green",
		prevo: "grubbin",
	...
	vikavolt: {
		...
		species: "Vikavolt",
		types: ["Bug", "Electric"],
		baseStats: {hp: 77, atk: 50, def: 80, spa: 135, spd: 75, spe: 83},
		abilities: {0: "Levitate", 1: "Cloud Chaser", S: "Galvanize"},
		heightm: 1.5,
		weightkg: 45,
		color: "Blue",
		prevo: "charjabug",
	...
	crabrawler: {
		...
		abilities: {0: "Hyper Cutter", 1: "Iron Fist", H: "Anger Point", S: "Ice Body"},
		heightm: 0.6,
		weightkg: 7,
		color: "Purple",
		evos: ["crabominable"],
	...
	oricorio: {
		...
		abilities: {0: "Dancer", S: "Flame Body"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Red",
		eggGroups: ["Flying"],
	...
	oricoriopau: {
		...
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 75, atk: 70, def: 70, spa: 98, spd: 70, spe: 93},
		abilities: {0: "Dancer", S: "Telepathy"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Pink",
		eggGroups: ["Flying"],
	...
	oricoriosensu: {
		...
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 75, atk: 70, def: 70, spa: 98, spd: 70, spe: 93},
		abilities: {0: "Dancer", S: "Shadow Tag"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Purple",
		eggGroups: ["Flying"],
	...
	oricoriofreestyle: {
		...
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 75, atk: 70, def: 70, spa: 98, spd: 70, spe: 93},
		abilities: {0: "Dancer", S: "Soundproof"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Blue",
		eggGroups: ["Flying"],
	...
	cutiefly: {
		...
		abilities: {0: "Hivemind", 1: "Shield Dust", H: "Sweet Veil", S: "Tinted Lens"},
		heightm: 0.1,
		weightkg: 0.2,
		color: "Yellow",
		evos: ["ribombee"],
	...
	lycanroc: {
		...
		abilities: {0: "Keen Eye", 1: "Sand Rush", H: "Steadfast", S: "Justified"},
		heightm: 0.8,
		weightkg: 25,
		color: "Brown",
		prevo: "rockruff",
	...
	lycanrocmidnight: {
		...
		abilities: {0: "Keen Eye", 1: "Vital Spirit", H: "No Guard", S: "Intimidate"},
		heightm: 1.1,
		weightkg: 25,
		color: "Red",
		prevo: "rockruff",
	...
	lycanrocdusk: {
		...
		abilities: {0: "Tough Claws", S: "Technician"},
		heightm: 0.8,
		weightkg: 25,
		color: "Brown",
		prevo: "rockruff",
	...
	wishiwashi: {
		...
		abilities: {0: "Schooling", S: "Rattled"},
		heightm: 0.2,
		weightkg: 0.3,
		color: "Blue",
		eggGroups: ["Water 2"],
	...
	mareanie: {
		...
		abilities: {0: "Merciless", 1: "Tough Grip", H: "Regenerator", S: "Poison Point"},
		heightm: 0.4,
		weightkg: 8,
		color: "Blue",
		evos: ["toxapex"],
	...
	mudbray: {
		...
		abilities: {0: "Own Tempo", 1: "Stamina", H: "Inner Focus", S: "Oblivious"},
		heightm: 1,
		weightkg: 110,
		color: "Brown",
		evos: ["mudsdale"],
	...
	dewpider: {
		...
		abilities: {0: "Water Bubble", H: "Water Absorb", S: "Water Veil"},
		heightm: 0.3,
		weightkg: 4,
		color: "Green",
		evos: ["araquanid"],
	...
	fomantis: {
		...
		abilities: {0: "Leaf Guard", H: "Contrary", S: "Natural Cure"},
		heightm: 0.3,
		weightkg: 1.5,
		color: "Pink",
		evos: ["lurantis"],
	...
	lurantis: {
		...
		abilities: {0: "Leaf Guard", 1: "Flytrap", H: "Contrary", S: "Natural Cure"},
		heightm: 0.9,
		weightkg: 18.5,
		color: "Pink",
		prevo: "fomantis",
	...
	morelull: {
		...
		abilities: {0: "Illuminate", 1: "Effect Spore", H: "Rain Dish", S: "Regenerator"},
		heightm: 0.2,
		weightkg: 1.5,
		color: "Purple",
		evos: ["shiinotic"],
	...
	salandit: {
		...
		abilities: {0: "Corrosion", H: "Oblivious", S: "Rivalry"},
		heightm: 0.6,
		weightkg: 4.8,
		color: "Black",
		evos: ["salazzle"],
	...
	salazzle: {
		...
		abilities: {0: "Corrosion", 1: "Toxin Absorb", H: "Oblivious", S: "Rivalry"},
		heightm: 1.2,
		weightkg: 22.2,
		color: "Black",
		prevo: "salandit",
	...
	stufful: {
		...
		abilities: {0: "Fluffy", 1: "Klutz", H: "Cute Charm", S: "Sheer Force"},
		heightm: 0.5,
		weightkg: 6.8,
		color: "Pink",
		evos: ["bewear"],
	...
	bewear: {
		...
		abilities: {0: "Fluffy", 1: "Klutz", H: "Unnerve", S: "Sheer Force"},
		heightm: 2.1,
		weightkg: 135,
		color: "Pink",
		prevo: "stufful",
	...
	bounsweet: {
		...
		abilities: {0: "Leaf Guard", 1: "Oblivious", H: "Sweet Veil", S: "Chlorophyll"},
		heightm: 0.3,
		weightkg: 3.2,
		color: "Purple",
		evos: ["steenee"],
	...
	tsareena: {
		...
		abilities: {0: "Leaf Guard", 1: "Queenly Majesty", H: "Iron Leg", S: "Chlorophyll"},
		heightm: 1.2,
		weightkg: 21.4,
		color: "Purple",
		prevo: "steenee",
	...
	comfey: {
		...
		abilities: {0: "Flower Veil", 1: "Triage", H: "Natural Cure", S: "Healer"},
		heightm: 0.1,
		weightkg: 0.3,
		color: "Green",
		eggGroups: ["Grass"],
	...
	oranguru: {
		...
		abilities: {0: "Inner Focus", 1: "Telepathy", H: "Symbiosis", S: "Filter"},
		heightm: 1.5,
		weightkg: 76,
		color: "White",
		eggGroups: ["Field"],
	...
	passimian: {
		...
		abilities: {0: "Receiver", H: "Defiant", S: "Reckless"},
		heightm: 2,
		weightkg: 82.8,
		color: "White",
		eggGroups: ["Field"],
	...
	wimpod: {
		...
		abilities: {0: "Wimp Out", S: "Shell Armor"},
		heightm: 0.5,
		weightkg: 12,
		color: "Gray",
		evos: ["golisopod"],
	...
	golisopod: {
		...
		abilities: {0: "Emergency Exit", S: "Shell Armor"},
		heightm: 2,
		weightkg: 108,
		color: "Gray",
		prevo: "wimpod",
	...
	sandygast: {
		...
		abilities: {0: "Water Compaction", H: "Sand Veil", S: "Water Absorb"},
		heightm: 0.5,
		weightkg: 70,
		color: "Brown",
		evos: ["palossand"],
	...
	pyukumuku: {
		...
		abilities: {0: "Innards Out", H: "Unaware", S: "Rain Dish"},
		heightm: 0.3,
		weightkg: 1.2,
		color: "Black",
		eggGroups: ["Water 1"],
	...
	turtonator: {
		...
		abilities: {0: "Shell Armor", S: "Rough Skin"},
		heightm: 2,
		weightkg: 212,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	togedemaru: {
		...
		abilities: {0: "Iron Barbs", 1: "Lightning Rod", H: "Sturdy", S: "Cute Charm"},
		heightm: 0.3,
		weightkg: 3.3,
		color: "Gray",
		eggGroups: ["Field", "Fairy"],
	...
	bruxish: {
		...
		abilities: {0: "Dazzling", 1: "Strong Jaw", H: "Wonder Skin", S: "Marvel Scale"},
		heightm: 0.9,
		weightkg: 19,
		color: "Pink",
		eggGroups: ["Water 2"],
	...
	drampa: {
		...
		abilities: {0: "Berserk", 1: "Sap Sipper", H: "Cloud Nine", S: "Soundproof"},
		heightm: 3,
		weightkg: 185,
		color: "White",
		eggGroups: ["Monster", "Dragon"],
	...
	dhelmise: {
		...
		abilities: {0: "Steelworker", 1: "Mossy Growth", S: "Sap Sipper"},
		heightm: 3.9,
		weightkg: 210,
		color: "Green",
		eggGroups: ["Mineral"],
	...
	jangmoo: {
		...
		abilities: {0: "Bulletproof", 1: "Soundproof", H: "Overcoat", S: "Iron Fist"},
		heightm: 0.6,
		weightkg: 29.7,
		color: "Gray",
		evos: ["hakamoo"],
	...
	tapukoko: {
		...
		abilities: {0: "Electric Surge", H: "Telepathy", S: "Berserk"},
		heightm: 1.8,
		weightkg: 20.5,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	tapulele: {
		...
		abilities: {0: "Psychic Surge", H: "Telepathy", S: "Healer"},
		heightm: 1.2,
		weightkg: 18.6,
		color: "Pink",
		eggGroups: ["Undiscovered"],
	...
	tapubulu: {
		...
		abilities: {0: "Grassy Surge", H: "Telepathy", S: "Reckless"},
		heightm: 1.9,
		weightkg: 45.5,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	tapufini: {
		...
		abilities: {0: "Misty Surge", H: "Telepathy", S: "Water Veil"},
		heightm: 1.3,
		weightkg: 21.2,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	solgaleo: {
		...
		abilities: {0: "Full Metal Body", S: "Pressure"},
		heightm: 3.4,
		weightkg: 230,
		color: "White",
		prevo: "cosmoem",
	...
	lunala: {
		...
		abilities: {0: "Shadow Shield", S: "Pressure"},
		heightm: 4,
		weightkg: 120,
		color: "Purple",
		prevo: "cosmoem",
	...
	nihilego: {
		...
		abilities: {0: "Beast Boost", S: "Liquid Ooze"},
		heightm: 1.2,
		weightkg: 55.5,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	buzzwole: {
		...
		abilities: {0: "Beast Boost", S: "Big Pecks"},
		heightm: 2.4,
		weightkg: 333.6,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	pheromosa: {
		...
		abilities: {0: "Beast Boost", S: "Dazzling"},
		heightm: 1.8,
		weightkg: 25,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	xurkitree: {
		...
		abilities: {0: "Beast Boost", S: "Lightning Rod"},
		heightm: 3.8,
		weightkg: 100,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	celesteela: {
		...
		abilities: {0: "Beast Boost", S: "Heavy Metal"},
		heightm: 9.2,
		weightkg: 999.9,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	kartana: {
		...
		abilities: {0: "Beast Boost", S: "Light Metal"},
		heightm: 0.3,
		weightkg: 0.1,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	guzzlord: {
		...
		types: ["Poison", "Dragon"],
		gender: "N",
		baseStats: {hp: 223, atk: 53, def: 53, spa: 101, spd: 97, spe: 43},
		abilities: {0: "Beast Boost", S: "Gluttony"},
		heightm: 5.5,
		weightkg: 888,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	necrozma: {
		...
		abilities: {0: "Prism Armor", S: "Pressure"},
		heightm: 2.4,
		weightkg: 230,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	necrozmaduskmane: {
		...
		abilities: {0: "Prism Armor", S: "Full Metal Body"},
		heightm: 3.8,
		weightkg: 460,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	necrozmadawnwings: {
		...
		abilities: {0: "Prism Armor", S: "Shadow Shield"},
		heightm: 4.2,
		weightkg: 350,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	magearna: {
		...
		abilities: {0: "Soul-Heart", S: "Friend Guard"},
		heightm: 1,
		weightkg: 80.5,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	marshadow: {
		...
		abilities: {0: "Technician", S: "Iron Fist"},
		heightm: 0.7,
		weightkg: 22.2,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	poipole: {
		...
		abilities: {0: "Beast Boost", S: "Sniper"},
		heightm: 0.6,
		weightkg: 1.8,
		color: "Purple",
		evos: ["naganadel"],
	...
	stakataka: {
		...
		abilities: {0: "Beast Boost", S: "Sturdy"},
		heightm: 5.5,
		weightkg: 820,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	blacephalon: {
		...
		abilities: {0: "Beast Boost", S: "Volatile"},
		heightm: 1.8,
		weightkg: 13,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	zeraora: {
		...
		abilities: {0: "Volt Absorb", S: "Iron Fist"},
		heightm: 1.5,
		weightkg: 44.5,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
