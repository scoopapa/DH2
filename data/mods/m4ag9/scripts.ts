...
const megaViabilityList9 = [
	"araquanidmega", "arbolivamega", "armarougemega", "bastiodonmega", "bibarelmega", "butterfreemega", "chandeluremegam", "charizardmegay", "cinderacemega", "clefablemegam", 
	"conkeldurrmega", "corviknightmega", "dhelmisemega", "dianciemega", "dodriomega", "dragalgemegam",	"eelektrossmegam", "empoleonmega", "falinksmega", "flygonmega", 
	"froslassmegam", "garbodormega", "grumpigmega", "hawluchamega", "honchkrowmega", "hydreigonmega", "infernapemega", "inteleonmega", "kleavormega", "krookodilemega", "lanturnmega", 
	...
	"skeledirgemega", "slowkingmega", "slowkinggalarmega", "staraptormega", "starmiemegam", "stoutlandmega", "sylveonmega", "talonflamemega", "typhlosionmega", "tyrantrummega", 
