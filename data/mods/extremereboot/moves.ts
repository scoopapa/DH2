export const Moves: {[k: string]: ModdedMoveData} = {
	...
	cottonfield: {
		...
		pp: 10,
		type: "Spring",
		shortDesc: "Terrain. Entry Dmg: 1/16, -2 Eva. Immune: Storm, Winter.",
		priority: 0,
		flags: {nonsky: 1},
		terrain: 'cottonfield',
		condition: {
	...
	pumpkinfield: {
		...
		pp: 10,
		type: "Autumn",
		shortDesc: "Terrain. Entry Dmg: 1/16, Curses after 3 turns. Immune: Folklore, Night. Blocks sunburns.",
		priority: 0,
		flags: {nonsky: 1},
	...
	ricefield: {
		...
		pp: 10,
		type: "Spring",
		shortDesc: "Terrain. Entry Dmg: 1/16, Heals 25% after 3 turns. 50% for Serenity, Sea.",
		priority: 0,
		flags: {nonsky: 1},
		terrain: 'ricefield',
		condition: {
	...
	sunflowerfield: {
		...
		pp: 10,
		type: "Autumn",
		shortDesc: "Terrain. Entry Dmg: 1/16, Sunburns after 3 turns. Immune: Summer. Blocks curses.",
		priority: 0,
		flags: {nonsky: 1},
