...
export const Scripts: ModdedBattleScriptsData = {
	...
	init: function () {
		...
		this.modData('Learnsets', 'tangela').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'lickitung').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'bellsprout').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'dratini').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'deino').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'bulbasaur').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'ekans').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'pinsir').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'persian').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'gyarados').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'mew').learnset.lashout = ['8L1'];
		this.modData('Learnsets', 'growlithe').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'charmander').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'flareon').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'magmar').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'vulpix').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'ponyta').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'spiritomb').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'moltres').learnset.sunsteelstrike = ['8L1'];
		this.modData('Learnsets', 'clefairy').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'jigglypuff').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'magnemite').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'drowzee').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'voltorb').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'mr.mime').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'ralts').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'porygon').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'mew').learnset.craftyshield = ['8L1'];
		this.modData('Learnsets', 'mewtwo').learnset.craftyshield = ['8L1'];
	},
};
