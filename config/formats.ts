...
export const Formats: FormatList = [
	...
	/*{
		...
		banlist: ['Altarianite', 'Revival Blessing', 'Shed Tail', 'Last Respects', 'Swampertite', 'Mawilite', 'Alakazite', 'Baton Pass', 'Light Clay',
			//oh boy just slapping "FEOU" here DID exclude these mons from the teambuilder... but an error ('Nothing matches "FEOU"') was thrown in dex-formats on the server side
			//So I'll have do do all these manually
			...
			'Muktaria-Mega', 'Mawlakazam-Mega-X', 'Mawlakazam-Mega-Y', 'Goopert-Hisui-Mega'
		],
		onValidateTeam(team, format) {
			/**@type {{[k: string]: true}}* /
			let speciesTable = {};
 ...
 */
  ...
  //	{
	...
	},
	{
		...
		mod: 'colosseumyb',
		ruleset: ['Standard', 'Data Mod', 'Mega Data Mod', 'Terastal Clause', 'Shadow Adapter Mod'],
	...
	},
	{
		...
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Min Source Gen = 9', 'VGC Timer',
					 'Open Team Sheets', 'Data Mod', 'Mega Data Mod', 'Terastal Clause', 'Limit Two Restricted', 'Shadow Adapter Mod'],
