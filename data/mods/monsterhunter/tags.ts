...
export const Tags: {[id: IDEntry]: TagData} = {
	...
	lynian: {
		name: "Lynian",
		speciesFilter: species => species.tags.includes("Lynian"),
	},
	neopteron: {
		name: "Neopteron",
		speciesFilter: species => species.tags.includes("Neopteron"),
	},
	temnoceran: {
		name: "Temnoceran",
		speciesFilter: species => species.tags.includes("Temnoceran"),
	},
	birdwyvern: {
		name: "Bird Wyvern",
		speciesFilter: species => species.tags.includes("Bird Wyvern"),
	},
	flyingwyvern: {
		name: "Flying Wyvern",
		speciesFilter: species => species.tags.includes("Flying Wyvern"),
	},
	piscinewyvern: {
		name: "Piscine Wyvern",
		speciesFilter: species => species.tags.includes("Piscine Wyvern"),
	},
	carapaceon: {
		name: "Carapaceon",
		speciesFilter: species => species.tags.includes("Carapaceon"),
	},
	amphibian: {
		name: "Amphibian",
		speciesFilter: species => species.tags.includes("Amphibian"),
	},
	fangedbeast: {
		name: "Fanged Beast",
		speciesFilter: species => species.tags.includes("Fanged Beast"),
	},
	leviathan: {
		name: "Leviathan",
		speciesFilter: species => species.tags.includes("Leviathan"),
	},
	snakewyvern: {
		name: "Snake Wyvern",
		speciesFilter: species => species.tags.includes("Snake Wyvern"),
	},
	brutewyvern: {
		name: "Brute Wyvern",
		speciesFilter: species => species.tags.includes("Brute Wyvern"),
	},
	fangedwyvern: {
		name: "Fanged Wyvern",
		speciesFilter: species => species.tags.includes("Fanged Wyvern"),
	},
	cephalopod: {
		name: "Cephalopod",
		speciesFilter: species => species.tags.includes("Cephalopod"),
	},
	construct: {
		name: "Construct",
		speciesFilter: species => species.tags.includes("Construct"),
	},
	unclassified: {
		name: "Unclassified",
		speciesFilter: species => species.tags.includes("Unclassified"),
	},
	endemic: {
		name: "Endemic",
		speciesFilter: species => species.tags.includes("Endemic"),
	},
	demielder: {
		name: "Demi-Elder",
		speciesFilter: species => species.tags.includes("Demi-Elder"),
	},
	elderdragon: {
		name: "Elder Dragon",
		speciesFilter: species => species.tags.includes("Elder Dragon"),
	},
