export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	aknosom: {
		...
		name: "Aknosom",
		types: ["Fire", "Flying"],
		baseStats: {hp: 100, atk: 62, def: 90, spa: 90, spd: 80, spe: 88},
		abilities: {0: "Big Pecks", 1: "Dancer", H: "Wind Rider"},
		heightm: 1.4,
		weightkg: 39.2,
		color: "White",
		eggGroups: ["Flying"],
	...
	arzuros: {
		...
		name: "Arzuros",
		types: ["Normal"],
		baseStats: {hp: 81, atk: 112, def: 115, spa: 60, spd: 80, spe: 62},
	...
	barroth: {
 	...
 	greatwroggi: {
		...
		name: "Great Wroggi",
		types: ["Normal", "Poison"],
		baseStats: {hp: 90, atk: 50, def: 50, spa: 123, spd: 107, spe: 90},
 	...
 	kuluyaku: {
		...
		name: "Kulu-Ya-Ku",
		types: ["Normal", "Flying"],
		baseStats: {hp: 75, atk: 95, def: 117, spa: 44, spd: 70, spe: 104},
 	...
 	khezu: {
		...
		abilities: {0: "Electric Surge", 1: "Static", H: "Lightning Rod"},
		heightm: 1.7,
		weightkg: 50.5,
		color: "White",
		eggGroups: ["Monster"],
 	...
 	royalludroth: {
		...
		name: "Royal Ludroth",
		types: ["Water"],
		baseStats: {hp: 113, atk: 107, def: 70, spa: 70, spd: 70, spe: 85},
 	...
 	tetranadon: {
		...
		abilities: {0: "Thick Fat", 1: "Drizzle", H: "Huge Power"},
		heightm: 2,
		weightkg: 105.5,
		color: "Green",
 	...
 	tobikadachi: {
		...
		abilities: {0: "Intimidate", 1: "Static", H: "Prankster"},
		heightm: 1.4,
		weightkg: 42.4,
		color: "White",
		eggGroups: ["Field"],
 	...
 	almudron: {
		...
		name: "Almudron",
		types: ["Ground"],
		baseStats: {hp: 112, atk: 108, def: 102, spa: 95, spd: 90, spe: 75},
 	...
 	garangolm: {
		...
		abilities: {0: "Rocky Payload", 1: "Gooey", H: "Gorilla Tactics"},
		heightm: 2.5,
		weightkg: 150.5,
		color: "Brown",
 	...
 	seregios: {
		...
		name: "Seregios",
		types: ["Steel", "Flying"],
		baseStats: {hp: 92, atk: 125, def: 99, spa: 60, spd: 92, spe: 112},
 	...
 	chameleos: {
		...
		abilities: {0: "Neutralizing Gas", 1: "Poison Touch"},
		heightm: 3.5,
		weightkg: 230.4,
		color: "Purple",
		eggGroups: ["Monster", "Dragon"],
 	...
 	teostra: {
 	 ...
 	 flamingespinas: {
		...
		types: ["Grass", "Fire"],
		baseStats: {hp: 98, atk: 105, def: 100, spa: 108, spd: 98, spe: 91},
 	...
 	ibushi: {
		...
		gender: "M",
		abilities: {0: "Minus", 1: "Air Lock", H: "Delta Stream"},
		heightm: 5.5,
		weightkg: 132.3,
		color: "Blue",
		eggGroups: ["Dragon"],
 	...
 	narwa: {
		...
		gender: "F",
		abilities: {0: "Plus", 1: "Levitate", H: "Electric Surge"},
		heightm: 6.6,
		weightkg: 154.3,
		color: "Yellow",
		eggGroups: ["Dragon"],
 	...
 	amatsu: {
		...
		abilities: {0: "Drizzle", 1: "Regenerator"},
		heightm: 8.5,
		weightkg: 392.0,
		color: "White",
		eggGroups: ["Undiscovered"],
 	...
 	valstrax: {
		...
		name: "Valstrax",
		types: ["Dragon", "Steel"],
		baseStats: {hp: 96, atk: 108, def: 101, spa: 112, spd: 83, spe: 140},
 	...
 	crimsonglowvalstrax: {
		...
		forme: "Mega",
		types: ["Dragon"],
		baseStats: {hp: 96, atk: 122, def: 110, spa: 122, spd: 110, spe: 180},
