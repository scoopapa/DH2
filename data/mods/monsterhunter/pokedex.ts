export const Pokedex: {[k: string]: ModdednameData} = {
	agnaktor: {
		...
		abilities: {0: "Magma Armor", 1: "Solar Wrath"},
		heightm: 1.0,
		weightkg: 60.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	barioth: {
		...
		abilities: {0: "Frostnip", 1: "Slush Rush"},
		heightm: 1.0,
		weightkg: 152.2,
		color: "Black",
		eggGroups: ["Field"],
	...
	barroth: {
		...
		abilities: {0: "Earth Eater", 1: "Sand Stream"},
		heightm: 1.0,
		weightkg: 105.8,
		color: "Black",
		eggGroups: ["Field"],
	...
	dahrenmohran: {
		...
		abilities: {0: "Rough Skin", 1: "Sand Rush"},
		heightm: 1.0,
		weightkg: 205.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	diremiralis: {
		...
		abilities: {0: "Thermal Exchange", 1: "Pressure", H: "Megiddo's Gift"},
		heightm: 1.0,
		weightkg: 335.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	duramboros: {
		...
		abilities: {0: "Grass Pelt", 1: "Tempest Force"},
		heightm: 1.0,
		weightkg: 110.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	fatalis: {
		...
		abilities: {0: "Desolate Land", 1: "Turboblaze"},
		heightm: 1.0,
		weightkg: 270.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	gobul: {
		...
		name: "Gobul",
		types: ["Water", "Ghost"],
		baseStats: {hp: 165, atk: 63, def: 65, spa: 85, spd: 100, spe: 50},
	...
	harudomerugu: {
		...
		abilities: {0: "Steelworker", 1: "Iron Barbs"},
		heightm: 1.0,
		weightkg: 300.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	kirin: {
		...
		abilities: {0: "Grim Neigh", 1: "Stalwart"},
		heightm: 1.0,
		weightkg: 1.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	legiana: {
		...
		abilities: {0: "Aerilate", 1: "Tempest Energy"},
		heightm: 1.0,
		weightkg: 45.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	malzeno: {
		...
		abilities: {0: "Vampirism", 1: "Multiscale"},
		heightm: 1.0,
		weightkg: 85.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	nefgarmat: {
		...
		abilities: {0: "Sand Stream", 1: "Centrifuge"},
		heightm: 1.0,
		weightkg: 150.,
		color: "Green",
		eggGroups: ["Field"],
	...
	safijiiva: {
		...
		abilities: {0: "Multiscale", 1: "Dragonvein"},
		heightm: 1.0,
		weightkg: 200.0,
		color: "Black",
		prevo: "Xeno'jiiva",
	...
	shagarumagala: {
		...
		abilities: {0: "Misty Surge", 1: "Magic Guard"},
		heightm: 1.0,
		weightkg: 230.3,
		color: "Black",
		prevo: "Gore Magala",
	...
	spiribird: {
		...
		abilities: {0: "Shield Dust", 1: "Hospitality"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Green",
		eggGroups: ["Amorphous"],
