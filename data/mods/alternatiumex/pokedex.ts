export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	pikachukanto: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 80, atk: 100, def: 60, spa: 90, spd: 90, spe: 100},
	...
	pikachuworld: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 80, atk: 90, def: 70, spa: 90, spd: 70, spe: 112},
	...
	lurantio: {
		...
		name: "Lurantio",
		types: ["Fairy", "Steel"],
		baseStats: {hp: 95, atk: 70, def: 90, spa: 80, spd: 90, spe: 55},
	...
	persianbandit: {
		...
		baseStats: {hp: 84, atk: 101, def: 64, spa: 96, spd: 64, spe: 111},
	...
	marowak: {
		...
		name: "Marowak",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 80, atk: 100, def: 90, spa: 60, spd: 90, spe: 65},
	...
	violentine: {
		...
		types: ["Fairy", "Poison"],
		gender: "F",
		baseStats: {hp: 74, atk: 105, def: 70, spa: 85, spd: 120, spe: 66},
	...
	basculinhotheaded: {
		...
		types: ["Water", "Fire"],
		baseStats: {hp: 70, atk: 112, def: 85, spa: 80, spd: 70, spe: 98},
	...
	zarudehero: {
		...
		name: "Zarude-Hero",
		types: ["Grass", "Flying"],
		baseStats: {hp: 95, atk: 110, def: 95, spa: 60, spd: 75, spe: 95},
	...
	goodratsunade: {
		...
		name: "Goodra-Tsunade",
		types: ["Dragon", "Poison"],
		baseStats: {hp: 100, atk: 100, def: 60, spa: 110, spd: 100, spe: 80},
		abilities: {0: "Water Compaction", 1: "Hydration", H: "Gooey"},
		heightm: 2,
		weightkg: 150.5,
	},
	goodrasymbiotic: {
	...
	oinkolognef: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 110, atk: 65, def: 80, spa: 110, spd: 75, spe: 60},
	...
	xerneasdormant: {
		...
		baseStats: {hp: 111, atk: 131, def: 80, spa: 41, spd: 73, spe: 74},
	...
	xerneasjustice: {
		...
		baseStats: {hp: 73, atk: 117, def: 93, spa: 56, spd: 82, spe: 109},
	...
	arcaninewaterballoon: {
		...
		types: ["Water", "Grass"],
		baseStats: {hp: 110, atk: 75, def: 92, spa: 115, spd: 60, spe: 88},
	...
	arcaninenoble: {
		...
		name: "Arcanine-Noble",
		types: ["Fire", "Rock"],
		baseStats: {hp: 95, atk: 100, def: 115, spa: 60, spd: 65, spe: 90},
	...
	squawkabilly: {
		...
		name: "Squawkabilly",
		types: ["Dark", "Flying"],
		baseStats: {hp: 82, atk: 96, def: 91, spa: 45, spd: 71, spe: 122},
	...
	squawkabillyyellow: {
		...
		baseStats: {hp: 65, atk: 52, def: 84, spa: 106, spd: 92, spe: 101},
	...
	wishiwashilonesome: {
		...
		types: ["Steel", "Ghost"],
		baseStats: {hp: 85, atk: 70, def: 70, spa: 85, spd: 72, spe: 123},
	...
	palafin: {
		...
		name: "Palafin",
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 90, atk: 76, def: 112, spa: 80, spd: 72, spe: 70},
	...
	hercuphin: {
		...
		name: "Hercuphin",
		types: ["Water", "Fighting"],
		baseStats: {hp: 80, atk: 110, def: 72, spa: 91, spd: 72, spe: 80},
	...
	togedemaru: {
		inherit: true,
		types: ["Rock", "Steel"],
		baseStats: {hp: 70, atk: 90, def: 156, spa: 44, spd: 70, spe: 100},
	...
	tauros: {
		inherit: true,
		types: ["Normal", "Rock"],
		baseStats: {hp: 75, atk: 110, def: 85, spa: 80, spd: 70, spe: 110},
	...
	taurossteam: {
		...
		types: ["Fire", "Water"],
		gender: "M",
		baseStats: {hp: 105, atk: 75, def: 105, spa: 75, spd: 105, spe: 50},
	...
	golemberserker: {
		...
		types: ["Rock", "Dark"],
		baseStats: {hp: 80, atk: 90, def: 90, spa: 90, spd: 90, spe: 110},
		abilities: {0: "Cannon Style", H: "Thermo Fist"},
		heightm: 1.4,
		weightkg: 300,
	},
	golemalola: {
