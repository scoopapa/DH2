export const Pokedex: {[k: string]: ModdednameData} = {
	...
	almudron: {
		...
		abilities: {0: "Mold Breaker", H: "Stamina"},
		heightm: 1.0,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field"],
	...
	magmadron: {
		...
		types: ["Ground", "Fire"],
		baseStats: {hp: 112, atk: 100, def: 112, spa: 59, spd: 112, spe: 75},
		abilities: {0: "Flash Fire", H: "Stamina"},
		heightm: 1.0,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field"],
	...
	malzeno: {
 	...
 	primozeno: {
		...
		abilities: {0: "Sword of Ruin", H: "Multiscale"},
		heightm: 1.0,
		weightkg: 85.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	nibelsnarf: {
		...
		name: "Nibelsnarf",
		types: ["Ground"],
		baseStats: {hp: 108, atk: 112, def: 108, spa: 78, spd: 82, spe: 50},
	...
	seregios: {
		...
		abilities: {0: "Weak Armor", H: "Well-Baked Body"},
		heightm: 1.0,
		weightkg: 160.4,
		color: "Black",
		eggGroups: ["Field"],
	...
	tetsucabra: {
		...
		abilities: {0: "Strong Jaw", H: "Earth Eater"},
		heightm: 1.0,
		weightkg: 110.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	zinogre: {
		...
		abilities: {0: "Volt Absorb", H: "Speed Boost"},
		heightm: 1.0,
		weightkg: 178.4,
		color: "Black",
		eggGroups: ["Field"],
