"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _randomteams = require('../gen3/random-teams');


 class RandomGen2Teams extends _randomteams.default {
	...
	randomSet(species, restrictMoves) {
		...
		let discard = false;
		let rerollsLeft = 3;
		const isPhazingMove = (move) => {
			return (move === "roar" || move === "whirlwind");
		};
		const isSleepMove = (move) => {
