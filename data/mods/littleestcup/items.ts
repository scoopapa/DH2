...
*/
	...
	dousedrive: {
		...
		gen: 5,
		isNonstandard: "Past",
		shortDesc: "Holder's Fire Blast is Water type.",
	},
	dracoplate: {
		name: "Draco Plate",
		spritenum: 105,
	...
	maliciousarmor: {
		...
		onModifyAtkPriority: 1,
		onModifyAtk(atk, pokemon) {
			if (pokemon.baseSpecies.baseSpecies === 'Ceruledge') {
		...
		onTakeItem(item, source) {
			if (source.baseSpecies.num === 937) return false;
			return true;
		},
		itemUser: ["Ceruledge"],
		num: 1861,
		gen: 9,
		rating: 0,
		shortDesc: "If held by a Ceruledge, increase Attack and Defense by 1.25x, but it can only select damaging moves.",
	},
	manectite: {
		name: "Manectite",
		spritenum: 596,
	...
	metronome: {
		...
		condition: {
			...
			onModifyDamage(damage, source, target, move) {
				const dmgMod = [4096, 5325, 6922, 6553, 8999, 11699, 15208, 19771, 25702, 33412, 43436, 56467, 73407, 95429, 124058, 161274, 209657, 272555, 354321, 460617, 598803];
				const numConsecutive = this.effectState.numConsecutive > 20 ? 20 : this.effectState.numConsecutive;
				this.debug(`Current Metronome boost: ${dmgMod[numConsecutive]}/4096`);
				return this.chainModify([dmgMod[numConsecutive], 4096]);
			},
		},
		shortDesc: "Damage of moves used on consecutive turns is increased.",
		num: 277,
		gen: 4,
	},
	mewniumz: {
...
*/
	...
	quickpowder: {
		...
		gen: 4,
		isNonstandard: "Past",
		shortDesc: "If held by a Ditto that has Transformed, its Speed is doubled.",
	},
	rabutaberry: {
		name: "Rabuta Berry",
		spritenum: 375,
