...
exports.BattlePokedex = {
	...
	knyffemega: {
		...
		formeLetter: "M",
		types: ["Bug", "Dark"],
		baseStats: {hp: 70, atk: 160, def: 70, spa: 75, spd: 60, spe: 175},
	...
	Powette: {
        ...
        baseStats: {hp: 100, atk: 50, def: 50, spa: 100, spd: 100, spe: 50},
        abilities: {0: "Camouflage", 1: "Power Change", H: "Protean"},
        heightm: 0.5,
        weightkg: 0.1,
        color: "White",
	...
	gastrodon: {
        ...
        species: "Gastrodon",
        types: ["Water", "Ground"],
        baseStats: {hp: 111, atk: 83, def: 58, spa: 92, spd: 72, spe: 39},
    ...
    gastroling: {
        ...
        species: "Gastroling",
        types: ["Water", "Ground"],
        baseStats: {hp: 121, atk: 103, def: 78, spa: 122, spd: 92, spe: 39},
        abilities: {0: "Sticky Hold", 1: "Storm Drain", H: "Analytic"},
        eggGroups: ["Water 1", "Amorphous"],
    },
	    dragonair: {
        num: 148,
    ...
    dragonight: {
        ...
        species: "Dragonight",
        types: ["Flying", "Dark"],
        baseStats: {hp: 110, atk: 80, def: 95, spa: 91, spd: 110, spe: 114},
        abilities: {0: "Cloud Nine", H: "Multiscale"},
        eggGroups: ["Dragon", "Water 1"],
    },
	Machinalibur: {
        num: 8066,
        species: "Machinalibur",
        types: ["Steel", "Fighting"],
        baseStats: {hp: 90, atk: 120, def: 130, spa: 90, spd: 120, spe: 50},
        abilities: {0: "Warrior-Soul"},
        heightm: 1,
        weightkg: 80.5,
        color: "Gray",
	...
	cherrim: {
        ...
        otherFormes: ["cherrimmegalifeless", "cherrimmegareflowered"],
    },
    cherrimmegalifeless: {
        num: 421,
        species: "Cherrim-Mega-Lifeless",
        baseSpecies: "Cherrim",
        forme: "Mega-Lifeless",
        formeLetter: "M-L",
        types: ["Grass", "Ghost"],
        baseStats: {hp: 70, atk: 20, def: 110, spa: 117, spd: 108, spe: 125},
        abilities: {0: "Sealed Flowering"},
        heightm: 0.6,
        weightkg: 10.3,
        color: "Black",
        evoLevel: 25,
    ...
    cherrimmegareflowered: {
        num: 421,
        species: "Cherrim-Mega-Reflowered",
        baseSpecies: "Cherrim",
        forme: "Mega-Reflowered",
        formeLetter: "M-R",
        types: ["Grass", "Fairy"],
        baseStats: {hp: 70, atk: 20, def: 110, spa: 117, spd: 108, spe: 125},
        abilities: {0: "Sealed Flowering"},
