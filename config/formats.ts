 ...
 */
  ...
  //	{
	...
	},
    {
		...
		banlist: ['Uber', 'Soundproof', 'Assist', 'Baton Pass + Block', 'Baton Pass + Mean Look', 'Baton Pass + Spider Web', 'Smeargle + Ingrain', 'Soul Dew', 'Starf Berry', 'Speed Boost + Blaziken', 'Drizzle', 'Drought'],
	},
	{
