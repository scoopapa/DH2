...
exports.BattleScripts = {
	...
	init: function () {
		this.modData('Learnsets', 'squirtle').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'wartortle').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'blastoise').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'sandshrew').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'sandslash').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'staryu').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'starmie').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'tentacool').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'tentacruel').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'shellder').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'cloyster').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'kabuto').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'kabutops').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'geodude').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'graveler').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'golem').learnset.rapidspin = ['1L1'];
		this.modData('Learnsets', 'cloyster').learnset.spikes = ['1L1'];
		this.modData('Learnsets', 'omanyte').learnset.spikes = ['1L1'];
		this.modData('Learnsets', 'omastar').learnset.spikes = ['1L1'];
	},
