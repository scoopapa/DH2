...
exports.Formats = {
	pokemon: {
		...
		onValidateSet: function (set, format, pokemon) {
			...
			if (template.gen > this.gen && pokemon.id !== 'ambipom' && pokemon.id !== 'mismagius' && pokemon.id !== 'honchkrow' && pokemon.id !== 'weavile' && pokemon.id !== 'magnezone' && pokemon.id !== 'lickilicky' && pokemon.id !== 'rhyperior' && pokemon.id !== 'tangrowth' && pokemon.id !== 'electivire' && pokemon.id !== 'magmortar' && pokemon.id !== 'togekiss' && pokemon.id !== 'ambipom' && pokemon.id !== 'yanmega' && pokemon.id !== 'leafeon' && pokemon.id !== 'glaceon' && pokemon.id !== 'gliscor' && pokemon.id !== 'mamoswine' && pokemon.id !== 'porygonz') {
