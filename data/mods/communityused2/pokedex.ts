export const Pokedex: { [k: string]: ModdedSpeciesData } = {
	...
	snipythic: {
		...
		name: "Snipythic",
		types: ["Ghost", "Flying"],
		baseStats: { hp: 90, atk: 150, def: 90, spa: 95, spd: 90, spe: 170 },
	...
	hulvine: {
		...
		name: "Hulvine",
		types: ["Ghost"],
		baseStats: { hp: 105, atk: 60, def: 100, spa: 115, spd: 75, spe: 52 },
		abilities: { 0: "Flame Body", 1: "Insomnia", H: "Unaware" },
		weightkg: 12.2,
	},
	ballaboar: {
		num: -1005,
		name: "Ballaboar",
		types: ["Normal", "Fairy"],
		baseStats: { hp: 105, atk: 50, def: 80, spa: 104, spd: 80, spe: 80 },
	...
	naglrirmega: {
		...
		forme: "Mega",
		types: ["Water", "Dark"],
		baseStats: { hp: 142, atk: 139, def: 74, spa: 70, spd: 74, spe: 101 },
	...
	pacrabsite: {
		...
		name: "Pacrabsite",
		types: ["Psychic", "Water"],
		baseStats: { hp: 90, atk: 40, def: 80, spa: 100, spd: 120, spe: 65 },
	...
	muerekrot: {
		...
		name: "Muerekrot",
		types: ["Ghost", "Normal"],
		baseStats: { hp: 79, atk: 115, def: 87, spa: 71, spd: 87, spe: 96 },
	...
	lumigald: {
		...
		name: "Lumigald",
		types: ["Ice", "Rock"],
		baseStats: { hp: 80, atk: 120, def: 85, spa: 60, spd: 60, spe: 115 },
	...
	hafgvindr: {
		...
		abilities: { 0: "Swift Swim", 1: "Marvel Scale", H: "Wind Eater" },
		weightkg: 999.9,
	},
	balirachnid: {
		num: -1011,
		name: "Balirachnid",
		types: ["Bug", "Steel"],
		baseStats: { hp: 85, atk: 70, def: 94, spa: 120, spd: 66, spe: 62 },
	...
	wyrmdelse: {
		...
		abilities: { 0: "Ouroboros", H: "Gluttony"},
		weightkg: 829,
	},
	drakkrab: {
		num: -1014,
		name: "Drakkrab",
		types: ["Rock", "Fighting"],
		baseStats: { hp: 55, atk: 109, def: 132, spa: 34, spd: 91, spe: 104 },
	...
	solfreyr: {
		...
		name: "Solfreyr",
		types: ["Grass", "Psychic"],
		baseStats: { hp: 110, atk: 40, def: 85, spa: 140, spd: 90, spe: 30 },
	...
	noirpeck: {
		...
		baseStats: { hp: 70, atk: 100, def: 75, spa: 41, spd: 116, spe: 101 },
	...
	miauskog: {
		...
		name: "Miauskog",
		types: ["Fairy", "Fire"],
		baseStats: { hp: 90, atk: 48, def: 94, spa: 101, spd: 85, spe: 82 },
	...
	beartunnd: {
		...
		abilities: { 0: "Thick Fat", 1: "Overconfidence", H: "Ice Body" },
		weightkg: 300,
		prevo: "Beartic",
	},
	fawntifulmega: {
		...
		forme: "Mega",
		types: ["Fairy", "Flying"],
		baseStats: { hp: 86, atk: 129, def: 88, spa: 94, spd: 110, spe: 125 },
	...
	neightmare: {
		...
		name: "Neightmare",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 90, atk: 55, def: 90, spa: 90, spd: 130, spe: 50 },
	...
	thermovult: {
		...
		name: "Thermovult",
		types: ["Electric", "Fire"],
		baseStats: { hp: 81, atk: 108, def: 93, spa: 66, spd: 111, spe: 70 },
	...
	fawntiful: {
		...
		name: "Fawntiful",
		types: ["Fairy", "Flying"],
		baseStats: { hp: 86, atk: 119, def: 73, spa: 59, spd: 90, spe: 105 },
	...
	vintriol: {
		...
		name: "Vintriol",
		types: ["Poison", "Bug"],
		baseStats: { hp: 112, atk: 88, def: 70, spa: 138, spd: 90, spe: 64 },
	...
	polipid: {
		...
		name: "Polipid",
		types: ["Psychic", "Bug"],
		baseStats: { hp: 80, atk: 40, def: 90, spa: 100, spd: 75, spe: 128 },
	...
	hurstyrhund: {
		...
		name: "Hurstyrhund ",
		types: ["Fire", "Dark"],
		baseStats: { hp: 106, atk: 121, def: 85, spa: 90, spd: 71, spe: 59 },
	...
	bicunnin: {
		...
		name: "Bicunnin",
		types: ["Flying", "Dark"],
		baseStats: { hp: 94, atk: 102, def: 75, spa: 82, spd: 75, spe: 112 },
	...
	bjorniorite: {
		...
		name: "Bjorniorite",
		types: ["Rock", "Grass"],
		baseStats: { hp: 100, atk: 70, def: 70, spa: 120, spd: 100, spe: 50 },
		abilities: { 0: "Natural Cure", 1: "Brittle Crystals", H: "Rough Skin" },
		weightkg: 580,
	...
	bjornioritemega: {
		...
		forme: "Mega",
		types: ["Rock", "Fairy"],
		baseStats: { hp: 100, atk: 120, def: 110, spa: 140, spd: 120, spe: 20 },
	...
	pthormign: {
		...
		abilities: { 0: "Steadfast", 1: "Volt Absorb", H: "Reckless" },
		prevo: "Healogi",
		weightkg: 40,
	},
	gravalley: {
		...
		name: "Gravalley",
		types: ["Grass", "Poison"],
		baseStats: { hp: 80, atk: 70, def: 70, spa: 115, spd: 125, spe: 70 },
	...
	vintree: {
		...
		name: "Vintree",
		types: ["Poison", "Bug"],
		baseStats: { hp: 57, atk: 41, def: 32, spa: 81, spd: 42, spe: 36 },
		abilities: { 0: "Swarm", 1: "Shield Dust", H: "Flash Fire" },
		weightkg: 0.9,
		evoLevel: 43,
		evos: ["Vintriol"],
	...
	polipidmega: {
		...
		forme: "Mega",
		types: ["Psychic", "Ghost"],
		baseStats: { hp: 80, atk: 69, def: 140, spa: 150, spd: 102, spe: 62 },
