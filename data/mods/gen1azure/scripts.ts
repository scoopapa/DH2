...
export const Scripts: ModdedBattleScriptsData = {
	...
	init() {
		...
		this.modData('Learnsets', 'aerodactyl').learnset.earthquake = ['1L1'];
		this.modData('Learnsets', 'aerodactyl').learnset.rockslide = ['1L1'];
		this.modData('Learnsets', 'dodrio').learnset.swordsdance = ['1L1'];
		this.modData('Learnsets', 'gyarados').learnset.thunderwave = ['1L1'];
		this.modData('Learnsets', 'kabutops').learnset.rockslide = ['1L1'];
		this.modData('Learnsets', 'golbat').learnset.agility = ['1L1'];
		this.modData('Learnsets', 'golbat').learnset.hypnosis = ['1L1'];
		this.modData('Learnsets', 'golbat').learnset.superfang = ['1L1'];
		this.modData('Learnsets', 'clefable').learnset.amnesia = ['1L1'];
		this.modData('Learnsets', 'magneton').learnset.lightscreen = ['1L1'];
		this.modData('Learnsets', 'magneton').learnset.explosion = ['1L1'];
		this.modData('Learnsets', 'magneton').learnset.agility = ['1L1'];
		this.modData('Learnsets', 'pinsir').learnset.earthquake = ['1L1'];
		this.modData('Learnsets', 'pinsir').learnset.rockslide = ['1L1'];
		this.modData('Learnsets', 'ninetales').learnset.nightshade = ['1L1'];
		this.modData('Learnsets', 'ninetales').learnset.hypnosis = ['1L1'];
		this.modData('Learnsets', 'hitmonlee').learnset.swordsdance = ['1L1'];
		this.modData('Learnsets', 'hitmonlee').learnset.lowkick = ['1L1'];
		this.modData('Learnsets', 'hitmonlee').learnset.rockslide = ['1L1'];
		this.modData('Learnsets', 'sandslash').learnset.pinmissile = ['1L1'];
		this.modData('Learnsets', 'tangela').learnset.amnesia = ['1L1'];
		this.modData('Learnsets', 'venusaur').learnset.earthquake = ['1L1'];
		this.modData('Learnsets', 'venusaur').learnset.headbutt = ['1L1'];
		this.modData('Learnsets', 'wigglytuff').learnset.amnesia = ['1L1'];
		this.modData('Learnsets', 'wigglytuff').learnset.selfdestruct = ['1L1'];
		this.modData('Learnsets', 'wigglytuff').learnset.metronome = ['1L1'];
		this.modData('Learnsets', 'seaking').learnset.hydropump = ['1L1'];
		this.modData('Learnsets', 'seaking').learnset.bodyslam = ['1L1'];
		this.modData('Learnsets', 'seaking').learnset.swordsdance = ['1L1'];
		this.modData('Learnsets', 'seaking').learnset.quickattack = ['1L1'];
		this.modData('Learnsets', 'seaking').learnset.headbutt = ['1L1'];
		this.modData('Learnsets', 'kingler').learnset.slash = ['1L1'];
		this.modData('Learnsets', 'kingler').learnset.agility = ['1L1'];
		...
		moveHit(target, pokemon, move, moveData, isSecondary, isSelf) {
			...
			if (target) {
				...
				if (!isSelf && !isSecondary) {
					...
					if (!this.battle.runEvent('TryFieldHit', target, pokemon, move) && move.id !== 'toxic') {
						return false;
					}
				...
				if (hitResult === 0) {
					...
					target = null;
				} else if (!hitResult && move.id !== 'toxic') {
					if (hitResult === false) this.battle.add('-fail', target);
					return false;
				}
			}
