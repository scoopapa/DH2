...
export class RandomTeams {
	...
	randomMoveset(
		...
		// Enforce wacky moves
		for (const moveid of ['stuffcheeks', 'headsmash', 'bloodmoon', 'eternabeam', 'terastarstorm', 'attract', 'dragontail', 'boltbeak', 'saltcure', 'sandtomb', 'finalgambit', 'darkvoid', 'aurawheel', 'metronome']) {
	...
	randomTeam() {
		...
		while (baseSpeciesPool.length && pokemon.length < this.maxTeamSize) {
			...
			//otherwise sample normally
				...
				console.log(currentSpeciesPool);
				species = this.sample(currentSpeciesPool);
			}
