	...
	},
{
	...
	},
	{
		...
		ruleset: ['Obtainable', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod'],
		banlist: [
			'All Pokemon', 'Power Construct', 'Gengarite', 'Kangaskhanite', 'Lucarionite', 'Metagrossite', 'Salamencite',
		],
		unbanlist: [
			...
			'Fearow', 'Rufflet', 'Braviary', 'Vullaby', 'Mandibuzz', 'Mankey', 'Primeape', 'Delibird', 'Hawlucha', 'Oricorio', 'Oricorio', 'Oricorio', 'Oricorio', 'Cutiefly',
			...
			'Xatu', 'Nosepass', 'Probopass', 'Pyukumuku', 'Chinchou', 'Lanturn', 'Type: Null', 'Silvally', 'Poipole', 'Naganadel', 'Zygarde', 'Trubbish', 'Garbodor', 'Minccino',
		...
		onSwitchIn(pokemon) {
			if (['plubia', 'snoxin', 'komodond', 'anglevolt', 'thundigeist', 'forsnaken'].includes(pokemon.species.id)) {
				this.add('-start', pokemon, 'typechange', pokemon.getTypes(true).join('/'), '[silent]');
			}
		},
		mod: 'gen7dlcmons',
