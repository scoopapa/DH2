...
export class RandomTeams {
	...
	randomSet(species: string | Species, teamDetails: RandomTeamsTypes.TeamDetails = {}, isLead = false, isDoubles = false): RandomTeamsTypes.RandomSet {
		...
		} else if ((forme === 'Banshigen') && mega) {
			ability = 'Soundproof';
		} else if ((forme === 'Blastonoise') && mega) {
			ability = 'Natural Cure'; 
		} else if ((forme === 'Charodile') && mega) {
			ability = 'Rough Skin';
		} else if ((forme === 'Hornetox') && mega) {
			ability = 'Corrosion';
		} else if ((forme === 'Lapidour') && mega) {
			ability = 'Prankster';
		} else if ((forme === 'Pitchasaur') && mega) {
			ability = 'Storm Drain';
		} else {
			ability = ability0.name;
		}
