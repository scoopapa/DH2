export const Pokedex: {[k: string]: ModdednameData} = {
	agnaktor: {
		...
		abilities: {0: "Flame Body", 1: "Solar Wrath"},
		heightm: 1.0,
		weightkg: 60.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	akantor: {
		...
		name: "Akantor",
		types: ["Ground"],
		baseStats: {hp: 100, atk: 101, def: 100, spa: 121, spd: 90, spe: 70},
	...
	anjanath: {
		...
		name: "Anjanath",
		types: ["Fire"],
		baseStats: {hp: 94, atk: 135, def: 80, spa: 50, spd: 78, spe: 93},
	...
	banbaro: {
		...
		name: "Banbaro",
		types: ["Ground", "Ice"],
		baseStats: {hp: 94, atk: 109, def: 99, spa: 60, spd: 78, spe: 81},
	...
	barroth: {
		...
		name: "Barroth",
		types: ["Ground"],
		baseStats: {hp: 86, atk: 84, def: 90, spa: 75, spd: 115, spe: 70},
	...
	beotodus: {
		...
		name: "Beotodus",
		types: ["Ice"],
		baseStats: {hp: 72, atk: 109, def: 83, spa: 70, spd: 81, spe: 105},
	...
	bulldrome: {
		...
		name: "Bulldrome",
		types: ["Normal"],
		baseStats: {hp: 70, atk: 125, def: 85, spa: 60, spd: 75, spe: 105},
		abilities: {0: "Hustle"},
		heightm: 1.0,
		weightkg: 90.0,
		color: "Black",
	...
	dalamadur: {
		...
		name: "Dalamadur",
		types: ["Dragon"],
		baseStats: {hp: 112, atk: 103, def: 120, spa: 100, spd: 125, spe: 50},
	...
	diremiralis: {
		...
		name: "Dire Miralis",
		types: ["Fire", "Water"],
		baseStats: {hp: 124, atk: 96, def: 104, spa: 115, spd: 126, spe: 55},
	...
	duramboros: {
		...
		name: "Duramboros",
		types: ["Grass", "Flying"],
		baseStats: {hp: 110, atk: 110, def: 90, spa: 100, spd: 80, spe: 40},
	...
	eruzerion: {
		...
		name: "Eruzerion",
		types: ["Fire", "Ice"],
		baseStats: {hp: 90, atk: 99, def: 99, spa: 122, spd: 105, spe: 105},
	...
	fatalis: {
		...
		name: "Fatalis",
		types: ["Dragon"],
		baseStats: {hp: 100, atk: 120, def: 100, spa: 150, spd: 100, spe: 80},
	...
	gravios: {
		...
		name: "Gravios",
		types: ["Fire", "Psychic"],
		baseStats: {hp: 101, atk: 62, def: 107, spa: 120, spd: 100, spe: 65},
	...
	ibushi: {
		...
		name: "Ibushi",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 104, atk: 87, def: 112, spa: 102, spd: 122, spe: 88},
		gender: "M",
	...
	lagiacrus: {
		...
		baseStats: {hp: 114, atk: 100, def: 107, spa: 100, spd: 107, spe: 37},
	...
	lavasioth: {
		...
		name: "Lavasioth",
		types: ["Fire"],
		baseStats: {hp: 70, atk: 102, def: 80, spa: 104, spd: 95, spe: 69},
	...
	legiana: {
		...
		name: "Legiana",
		types: ["Flying", "Ice"],
		baseStats: {hp: 63, atk: 80, def: 65, spa: 115, spd: 105, spe: 122},
		abilities: {0: "Aerilate", 1: "Wind Power"},
		heightm: 1.0,
		weightkg: 45.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	lunastra: {
		...
		name: "Lunastra",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 85, atk: 105, def: 74, spa: 135, spd: 120, spe: 96},
	...
	magnamalo: {
		...
		name: "Magnamalo",
		types: ["Dark", "Fire"],
		baseStats: {hp: 105, atk: 115, def: 88, spa: 88, spd: 98, spe: 96},
	...
	malzeno: {
		...
		abilities: {0: "Fairy Aura", 1: "Multiscale"},
		heightm: 1.0,
		weightkg: 85.0,
		color: "Black",
		eggGroups: ["Field"],
 	...
 	primordialmalzeno: {
		...
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 90, atk: 110, def: 120, spa: 130, spd: 80, spe: 80},
		abilities: {0: "Aura Break", 1: "Multiscale"},
		heightm: 1.0,
		weightkg: 85.0,
		color: "Black",
		eggGroups: ["Field"],
	...
	narwa: {
		...
		name: "Narwa",
		types: ["Dragon", "Electric"],
		baseStats: {hp: 104, atk: 102, def: 87, spa: 122, spd: 92, spe: 112},
		gender: "F",
	...
	nergigante: {
		...
		baseStats: {hp: 94, atk: 119, def: 111, spa: 80, spd: 100, spe: 106},
	...
	nerscylla: {
		...
		name: "Nerscylla",
		types: ["Bug", "Poison"],
		baseStats: {hp: 80, atk: 110, def: 85, spa: 100, spd: 100, spe: 50},
	...
	paolumu: {
		...
		name: "Paolumu",
		types: ["Normal", "Flying"],
		baseStats: {hp: 102, atk: 105, def: 107, spa: 55, spd: 103, spe: 78},
	...
	plesioth: {
		...
		name: "Plesioth",
		types: ["Water"],
		baseStats: {hp: 70, atk: 104, def: 80, spa: 102, spd: 95, spe: 69},
	...
	qurupeco: {
		...
		name: "Qurupeco",
		types: ["Flying"],
		baseStats: {hp: 75, atk: 75, def: 75, spa: 95, spd: 120, spe: 85},
	...
	rathalos: {
		...
		types: ["Fire", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 120, def: 85, spa: 120, spd: 80, spe: 110},
 	...
 	rathian: {
		...
		types: ["Poison", "Ground"],
		gender: "F",
		baseStats: {hp: 120, atk: 85, def: 120, spa: 70, spd: 120, spe: 70},
	...
	safijiiva: {
		...
		baseStats: {hp: 100, atk: 104, def: 81, spa: 130, spd: 121, spe: 80},
	...
	shagarumagala: {
		...
		name: "Shagaru Magala",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 100, atk: 82, def: 91, spa: 132, spd: 110, spe: 95},
	...
	valstrax: {
		...
		name: "Valstrax",
		types: ["Dragon", "Steel"],
		baseStats: {hp: 90, atk: 105, def: 100, spa: 110, spd: 70, spe: 140},
	...
	velkhana: {
		...
		name: "Velkhana",
		types: ["Dragon", "Ice"],
		baseStats: {hp: 76, atk: 102, def: 65, spa: 140, spd: 104, spe: 128},
