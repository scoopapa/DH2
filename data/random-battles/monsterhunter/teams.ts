...
const CONTRARY_MOVES = [
	'armorcannon', 'closecombat', 'leafstorm', 'makeitrain', 'overheat', 'spinout', 'superpower', 'vcreate', 'abyssaleruption'
];
...
const SPECIAL_SETUP = [
	'calmmind', 'chargebeam', 'geomancy', 'nastyplot', 'quiverdance', 'tailglow', 'takeheart', 'torchsong', 'biocharge'
];
...
const NO_STAB = [
	...
	'vacuumwave', 'voltswitch', 'watershuriken', 'waterspout', 'harshsting', 'sweetlick',
];
...
const PROTECT_MOVES = [
	'banefulbunker', 'burningbulwark', 'protect', 'silktrap', 'spikyshield', 'shroomshield',
];
