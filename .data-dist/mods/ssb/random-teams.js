"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _randomteams = require('../../random-teams');
 ...
 class RandomStaffBrosTeams extends _randomteams.default {
	...
	randomStaffBrosTeam(options = {}) {
		...
		while (pool.length && team.length < 6) {
			...
			depth++;
			const name = this.allXfix ? 'xfix' : this.sampleNoReplace(pool);
			const ssbSet = sets[name];
