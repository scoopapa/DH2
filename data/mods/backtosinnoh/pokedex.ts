export const Pokedex: { [k: string]: ModdedSpeciesData; } = {
	...
	brambela: {
		...
		abilities: {0: "Sand Veil", H: "Overcoat"},
		weightkg: 20,
		prevo: "Tangela",
		eggGroups: ["Grass"],
	},
	...
	huginkrow: {
		...
		abilities: {0: "Levitate", H: "Overcoat"},
		weightkg: 110,
		prevo: "Murkrow",
		eggGroups: ["Flying"],
	},
	...
	elfowl: {
		...
		abilities: {0: "Insomnia", H: "Thick Fat"},
		weightkg: 51.3,
		prevo: "Delibird",
		eggGroups: ["Water 1", "Field"],
	},
	...
	putrewoodo: {
		...
		abilities: {0: "Clear Body", H: "Rock Head"},
		weightkg: 5,
		prevo: "Sudowoodo",
		eggGroups: ["Mineral"],
	},
