...
exports.BattleScripts = {
	...
	init: function () {
		this.modData('Learnsets', 'clefairy').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'clefable').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'jigglypuff').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'wigglytuff').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'lickitung').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'chansey').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'jynx').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'lapras').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'eevee').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'jolteon').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'flareon').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'vaporeon').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'dragonite').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'articuno').learnset.healbell = ['1L1'];
		this.modData('Learnsets', 'mew').learnset.healbell = ['1L1'];
	},
