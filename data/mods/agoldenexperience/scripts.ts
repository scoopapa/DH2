  ...
  init() {
    ...
    const addNewMoves = (pokemonid: string, moveids: string[]) => {
      for (const moveid of moveids) {
        this.modData('Learnsets', pokemonid).learnset[moveid] = [moveid === 'dracometeor' || moveid === 'steelbeam' ? '9T' : '9M'];
      }
    };
    ...
    this.modData('Learnsets', 'arcaninehisui').learnset.headsmash = ['9L1'];
    this.modData('Learnsets', 'samurott').learnset.drillrun = ['9L1'];
    this.modData('Learnsets', 'samurotthisui').learnset.drillrun = ['9L1'];
    this.modData('Learnsets', 'samurotthisui').learnset.suckerpunch = ['9L1'];
    this.modData('Learnsets', 'lilliganthisui').learnset.defog = ['9L1'];
    this.modData('Learnsets', 'zoroarkhisui').learnset.bodyslam = ['9L1'];
    this.modData('Learnsets', 'zoroarkhisui').learnset.focusblast = ['9L1'];
    this.modData('Learnsets', 'zoroarkhisui').learnset.trick = ['9L1'];
    this.modData('Learnsets', 'goodrahisui').learnset.bodypress = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.swordsdance = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.acrobatics = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.fakeout = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.rockslide = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.firepunch = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.rockslide = ['9L1'];
    ...
    this.modData('Learnsets', 'enamorus').learnset.focusblast = ['9L1'];
    this.modData('Learnsets', 'avalugg').learnset.iciclecrash = ['9L1'];
    this.modData('Learnsets', 'avalugghisui').learnset.iciclecrash = ['9L1'];
    this.modData('Learnsets', 'scyther').learnset.closecombat = ['9L1'];
    this.modData('Learnsets', 'arcaninehisui').learnset.extremespeed = ['9L1'];
    ...
    this.modData('Learnsets', 'baskiron').learnset.ragingfury = ['9L1'];
    ...
    this.modData('Learnsets', 'stoutland').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'snubbull').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'granbull').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'eevee').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'vaporeon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'jolteon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'flareon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'espeon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'umbreon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'leafeon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'glaceon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'sylveon').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'furfrou').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'growlithe').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'growlithehisui').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'arcanine').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'arcaninehisui').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'houndour').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'houndourgalar').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'houndoom').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'yamper').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'boltund').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'watchog').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'tauros').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'furret').learnset.underdog = ['9L1'];
    this.modData('Learnsets', 'gumshoos').learnset.underdog = ['9L1'];
    ...
    this.modData('Learnsets', 'moltres').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'houndoom').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'entei').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'hooh').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'magmortar').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'reshiram').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'braixen').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'delphox').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'cinderace').learnset.flamingsphere = ['9T'];
    this.modData('Learnsets', 'scizorgalar').learnset.flamingsphere = ['9T'];

    // fireball 
    this.modData('Learnsets', 'charizard').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'hooh').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'reshiram').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'mismagius').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'delphox').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'houndoom').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'ninetales').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'chandelure').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'magmortar').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'cinderace').learnset.fireball = ['9T'];
    this.modData('Learnsets', 'drinferno').learnset.fireball = ['9T'];

    // backfire 
    this.modData('Learnsets', 'reshiram').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'hooh').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'victini').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'blacephalon').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'chimchar').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'monferno').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'infernape').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'tepig').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'pignite').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'emboar').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'emboargalar').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'turtonator').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'litwick').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'lampent').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'chandelure').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'houndour').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'houndoom').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'marowakalola').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'vulpix').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'ninetales').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'litleo').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'pyroar').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'fletchinder').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'talonflame').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'cyndaquil').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'quilava').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'typhlosion').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'wizamadol').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'solens').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'charmander').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'charmeleon').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'charizard').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'torchic').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'combusken').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'blaziken').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'ponyta').learnset.backfire = ['9L1'];
    this.modData('Learnsets', 'rapidash').learnset.backfire = ['9L1'];

    // highwater 
    this.modData('Learnsets', 'squirtle').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'wartortle').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'blastoise').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'poliwrath').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'dewgong').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'vaporeon').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'chinchou').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'lanturn').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'politoed').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'regice').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'seismitoad').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'jellicent').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'eelektross').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'stunfisk').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'skrelp').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'dragalge').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'araquanid').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'grapploct').learnset.highwater = ['9T'];
    this.modData('Learnsets', 'medidragon').learnset.highwater = ['9T'];

    // seajaws 
    this.modData('Learnsets', 'dracovish').learnset.seajaws = ['9L1'];
    this.modData('Learnsets', 'gyarados').learnset.seajaws = ['9L1'];
    this.modData('Learnsets', 'samurott').learnset.seajaws = ['9L1'];
    ...
    this.modData('Learnsets', 'ironthorns').learnset.parallelcircuit = ['9L1'];
    this.modData('Learnsets', 'electivire').learnset.parallelcircuit = ['9L1'];
    this.modData('Learnsets', 'luxray').learnset.parallelcircuit = ['9L1'];
    this.modData('Learnsets', 'thundurus').learnset.parallelcircuit = ['9L1'];
    this.modData('Learnsets', 'morpeko').learnset.parallelcircuit = ['9L1'];
    this.modData('Learnsets', 'zeraora').learnset.parallelcircuit = ['9L1'];
    this.modData('Learnsets', 'pincurchin').learnset.parallelcircuit = ['9L1'];
    ...
    this.modData('Learnsets', 'tapuwala').learnset.musclecare = ['9L1'];

    // dissolution 
    this.modData('Learnsets', 'arbok').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'grimer').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'grimeralola').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'muk').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'mukalola').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'koffing').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'weezing').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'weezinggalar').learnset.dissolution = ['9T'];
    ...
    this.modData('Learnsets', 'swalot').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'tentacool').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'tentacruel').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'bellsprout').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'weepinbell').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'victreebel').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'vileplume').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'accelgor').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'seismitoad').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'shuckle').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'lickilicky').learnset.dissolution = ['9T'];
    this.modData('Learnsets', 'annoyog').learnset.dissolution = ['9T'];

    // landslide 
    this.modData('Learnsets', 'hippopotas').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'hippowdon').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'mudsdale').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'palossand').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'sandaconda').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'larvitar').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'pupitar').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'tyranitar').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'torterra').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'machamp').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'graveler').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'golem').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'graveleralola').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'golemalola').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'piloswine').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'mamoswine').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'onix').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'steelix').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'rhyhorn').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'rhydon').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'rhyperior').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'coalossal').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'gigalith').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'lairon').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'aggron').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'stonjourner').learnset.landslide = ['9L1'];
    this.modData('Learnsets', 'ironthorns').learnset.landslide = ['9L1'];
    ...
    // golemstrike 
    this.modData('Learnsets', 'nidoqueen').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'nidoking').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'primeape').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'machamp').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'geodude').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'geodudealola').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'graveler').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'graveleralola').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'golem').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'golemalola').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'grimeralola').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'mukalola').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'hitmonlee').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'hitmonchan').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'rhydon').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'rhyperior').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'aerodactyl').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'dragonite').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'mew').learnset.golemstrike = ['9T'];
    ...
    this.modData('Learnsets', 'regirock').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'groudon').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'infernape').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'lucario').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'toxicroak').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'gallade').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'dialga').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'palkia').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'regigigas').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'arceus').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'pignite').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'emboar').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'timburr').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'gurdurr').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'conkeldurr').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'throh').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'sawk').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'krokorok').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'krookodile').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'darmanitan').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'darmanitangalar').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'dwebble').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'crustle').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'scraggy').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'scrafty').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'tirtouga').learnset.golemstrike = ['9T'];
    ...
    this.modData('Learnsets', 'binacle').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'barbaracle').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'crabrawler').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'crabominable').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'rockruff').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'lycanroc').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'lycanrocdusk').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'lycanrocmidnight').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'solgaleo').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'buzzwole').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'celesteela').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'stakataka').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'runerigus').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'copperajah').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'urshifu').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'urshifurapidstrike').learnset.golemstrike = ['9T'];
    this.modData('Learnsets', 'kleavor').learnset.golemstrike = ['9T'];
    ...
    this.modData('Learnsets', 'baskiron').learnset.punishingblow = ['9L1'];
    ...
    // indomitablespirit 
    this.modData('Learnsets', 'gastly').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'croagunk').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'snorunt').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'marowakalola').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'sandygast').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'hawlucha').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'jangmoo').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'riolu').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'buzzwole').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'heracross').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'pancham').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'scraggy').learnset.indomitablespirit = ['9T'];
    this.modData('Learnsets', 'poliwag').learnset.indomitablespirit = ['9T'];
    ...
    // contrariety 
    this.modData('Learnsets', 'houndour').learnset.contrariety = ['9T'];
    this.modData('Learnsets', 'larvitar').learnset.contrariety = ['9T'];
    this.modData('Learnsets', 'carvanha').learnset.contrariety = ['9T'];
    this.modData('Learnsets', 'pawniard').learnset.contrariety = ['9T'];
    this.modData('Learnsets', 'sandile').learnset.contrariety = ['9T'];
    this.modData('Learnsets', 'zorua').learnset.contrariety = ['9T'];
    ...
    this.modData('Learnsets', 'hypno').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'spiritomb').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'darkrai').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'zorua').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'zoruahisui').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'zoroark').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'zoroarkhisui').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'chandelure').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'malamar').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'paranormear').learnset.hypnotichorror = ['9T'];
    this.modData('Learnsets', 'slendawful').learnset.hypnotichorror = ['9T'];
    ...
    // mercuryshot 
    this.modData('Learnsets', 'squirtle').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'wartortle').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'blastoise').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'piplup').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'prinplup').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'empoleon').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'magnemite').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'magneton').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'magnezone').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'heatran').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'dialga').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'celesteela').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'duraludon').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'kyogre').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'phione').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'manaphy').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'alomomola').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'tapufini').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'xurkitree').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'aron').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'lairon').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'aggron').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'clauncher').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'clawitzer').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'meltan').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'melmetal').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'corsolagalar').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'cursola').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'entei').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'clamperl').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'huntail').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'gorebyss').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'frillish').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'jellicent').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'lapras').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'chinchou').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'lanturn').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'tentacool').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'tentacruel').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'wailmer').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'wailord').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'spheal').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'sealeo').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'walrein').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'remoraid').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'octillery').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'registeel').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'koffing').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'weezing').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'weezinggalar').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'volcanion').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'mantyke').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'mantine').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'sliggoohisui').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'goodrahisui').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'genesect').learnset.mercuryshot = ['9T'];
    this.modData('Learnsets', 'magearna').learnset.mercuryshot = ['9T'];
    ...
    this.modData('Learnsets', 'golduck').learnset.powergem = ['9L1'];
    this.modData('Learnsets', 'golduck').learnset.thunderbolt = ['9L1'];
    this.modData('Learnsets', 'golduck').learnset.grassknot = ['9L1'];
    ...
    this.modData('Learnsets', 'muk').learnset.toxicspikes = ['9L1'];
    ...
    this.modData('Learnsets', 'typhlosion').learnset.scorchingsands = ['9T'];
    this.modData('Learnsets', 'furret').learnset.extremespeed = ['9T'];
    this.modData('Learnsets', 'furret').learnset.taunt = ['9T'];
    this.modData('Learnsets', 'furret').learnset.rapidspin = ['9T'];
    ...
    this.modData('Learnsets', 'slowking').learnset.chillyreception = ['9L1'];
    this.modData('Learnsets', 'slowkinggalar').learnset.chillyreception = ['9L1'];
    ...
    this.modData('Learnsets', 'dunsparce').learnset.hyperdrill = ['9L1'];
    ...
    this.modData('Learnsets', 'magcargo').learnset.scald = ['9L1'];
    this.modData('Learnsets', 'magcargo').learnset.powergem = ['9L1'];
    ...
    this.modData('Learnsets', 'shiftry').learnset.oniwind = ['9L1'];
    ...
    this.modData('Learnsets', 'makuhita').learnset.drainpunch = ['9L1'];
    ...
    this.modData('Learnsets', 'cacturne').learnset.knockoff = ['9L1'];
    ...
    this.modData('Learnsets', 'milotic').learnset.dracometeor = ['9T'];
    ...
    //gen 4:
    this.modData('Learnsets', 'torterra').learnset.bodypress = ['9L1'];
    this.modData('Learnsets', 'torterra').learnset.weatherball = ['9L1'];
    this.modData('Learnsets', 'empoleon').learnset.flipturn = ['9T'];
    this.modData('Learnsets', 'empoleon').learnset.roost = ['9T'];
    ...
    this.modData('Learnsets', 'carnivine').learnset.junglehealing = ['9L1'];
    ...
    this.modData('Learnsets', 'phione').learnset.takeheart = ['9L1'];
    this.modData('Learnsets', 'manaphy').learnset.takeheart = ['9L1'];
    ...
    this.modData('Learnsets', 'samurotthisui').learnset.flipturn = ['9L1'];
    ...
    this.modData('Learnsets', 'minccino').learnset.tidyup = ['9L1'];
    this.modData('Learnsets', 'cinccino').learnset.tidyup = ['9L1'];
    ...
    this.modData('Learnsets', 'haxorus').learnset.ironhead = ['9L1'];
    this.modData('Learnsets', 'beartic').learnset.closecombat = ['9L1'];
    this.modData('Learnsets', 'beartic').learnset.earthquake = ['9L1'];
    ...
    this.modData('Learnsets', 'thundurus').learnset.airslash = ['9L1'];
    this.modData('Learnsets', 'thundurus').learnset.acrobatics = ['9L1'];
    ...
    this.modData('Learnsets', 'toucannon').learnset.hurricane = ['9L1'];
    this.modData('Learnsets', 'toucannon').learnset.facade = ['9L1'];
    ...
    this.modData('Learnsets', 'stakataka').learnset.zawall = ['9T'];

    //gen 8:
    this.modData('Learnsets', 'cinderace').learnset.willowisp = ['9M'];
    ...
    this.modData('Learnsets', 'grimmsnarl').learnset.partingshot = ['9L1'];
    ...
    this.modData('Learnsets', 'duraludon').learnset.fireblast = ['9L1'];
    this.modData('Learnsets', 'duraludon').learnset.icebeam = ['9L1'];
    this.modData('Learnsets', 'duraludon').learnset.flamethrower = ['9L1'];
    this.modData('Learnsets', 'zacian').learnset.poisonjab = ['9L1'];
    this.modData('Learnsets', 'zamazenta').learnset.bodypress = ['9L1'];
    ...
    this.modData('Learnsets', 'regidrago').learnset.earthquake = ['9L1'];
    this.modData('Learnsets', 'regidrago').learnset.earthpower = ['9L1'];
    this.modData('Learnsets', 'glastrier').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'glastrier').learnset.tripleaxel = ['9L1'];
    delete this.modData('Learnsets', 'spectrier').learnset.nastyplot;
    this.modData('Learnsets', 'calyrexice').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'calyrexice').learnset.tripleaxel = ['9L1'];


    // return 
    this.modData('Learnsets', 'meltan').learnset.return = ['9L1'];
    this.modData('Learnsets', 'melmetal').learnset.return = ['9L1'];
    this.modData('Learnsets', 'grookey').learnset.return = ['9L1'];
    this.modData('Learnsets', 'thwackey').learnset.return = ['9L1'];
    this.modData('Learnsets', 'rillaboom').learnset.return = ['9L1'];
    this.modData('Learnsets', 'scorbunny').learnset.return = ['9L1'];
    this.modData('Learnsets', 'raboot').learnset.return = ['9L1'];
    this.modData('Learnsets', 'cinderace').learnset.return = ['9L1'];
    this.modData('Learnsets', 'sobble').learnset.return = ['9L1'];
    this.modData('Learnsets', 'drizzile').learnset.return = ['9L1'];
    this.modData('Learnsets', 'inteleon').learnset.return = ['9L1'];
    this.modData('Learnsets', 'skwovet').learnset.return = ['9L1'];
    this.modData('Learnsets', 'greedent').learnset.return = ['9L1'];
    this.modData('Learnsets', 'rookidee').learnset.return = ['9L1'];
    this.modData('Learnsets', 'corvisquire').learnset.return = ['9L1'];
    this.modData('Learnsets', 'corviknight').learnset.return = ['9L1'];
    this.modData('Learnsets', 'blipbug').learnset.return = ['9L1'];
    this.modData('Learnsets', 'dottler').learnset.return = ['9L1'];
    this.modData('Learnsets', 'orbeetle').learnset.return = ['9L1'];
    this.modData('Learnsets', 'nickit').learnset.return = ['9L1'];
    this.modData('Learnsets', 'thievul').learnset.return = ['9L1'];
    this.modData('Learnsets', 'gossifleur').learnset.return = ['9L1'];
    this.modData('Learnsets', 'eldegoss').learnset.return = ['9L1'];
    this.modData('Learnsets', 'wooloo').learnset.return = ['9L1'];
    this.modData('Learnsets', 'dubwool').learnset.return = ['9L1'];
    this.modData('Learnsets', 'chewtle').learnset.return = ['9L1'];
    this.modData('Learnsets', 'drednaw').learnset.return = ['9L1'];
    this.modData('Learnsets', 'yamper').learnset.return = ['9L1'];
    this.modData('Learnsets', 'boltund').learnset.return = ['9L1'];
    this.modData('Learnsets', 'rolycoly').learnset.return = ['9L1'];
    this.modData('Learnsets', 'carkol').learnset.return = ['9L1'];
    this.modData('Learnsets', 'coalossal').learnset.return = ['9L1'];
    this.modData('Learnsets', 'applin').learnset.return = ['9L1'];
    this.modData('Learnsets', 'flapple').learnset.return = ['9L1'];
    this.modData('Learnsets', 'appletun').learnset.return = ['9L1'];
    this.modData('Learnsets', 'silicobra').learnset.return = ['9L1'];
    this.modData('Learnsets', 'sandaconda').learnset.return = ['9L1'];
    this.modData('Learnsets', 'cramorant').learnset.return = ['9L1'];
    this.modData('Learnsets', 'arrokuda').learnset.return = ['9L1'];
    this.modData('Learnsets', 'barraskewda').learnset.return = ['9L1'];
    this.modData('Learnsets', 'toxel').learnset.return = ['9L1'];
    this.modData('Learnsets', 'sizzlipede').learnset.return = ['9L1'];
    this.modData('Learnsets', 'centiskorch').learnset.return = ['9L1'];
    this.modData('Learnsets', 'clobbopus').learnset.return = ['9L1'];
    this.modData('Learnsets', 'grapploct').learnset.return = ['9L1'];
    this.modData('Learnsets', 'sinistea').learnset.return = ['9L1'];
    this.modData('Learnsets', 'polteageist').learnset.return = ['9L1'];
    this.modData('Learnsets', 'hatenna').learnset.return = ['9L1'];
    this.modData('Learnsets', 'hattrem').learnset.return = ['9L1'];
    this.modData('Learnsets', 'hatterene').learnset.return = ['9L1'];
    this.modData('Learnsets', 'impidimp').learnset.return = ['9L1'];
    this.modData('Learnsets', 'morgrem').learnset.return = ['9L1'];
    this.modData('Learnsets', 'grimmsnarl').learnset.return = ['9L1'];
    this.modData('Learnsets', 'obstagoon').learnset.return = ['9L1'];
    this.modData('Learnsets', 'perrserker').learnset.return = ['9L1'];
    this.modData('Learnsets', 'cursola').learnset.return = ['9L1'];
    this.modData('Learnsets', 'sirfetchd').learnset.return = ['9L1'];
    this.modData('Learnsets', 'mrrime').learnset.return = ['9L1'];
    this.modData('Learnsets', 'runerigus').learnset.return = ['9L1'];
    this.modData('Learnsets', 'milcery').learnset.return = ['9L1'];
    this.modData('Learnsets', 'alcremie').learnset.return = ['9L1'];
    this.modData('Learnsets', 'falinks').learnset.return = ['9L1'];
    this.modData('Learnsets', 'pincurchin').learnset.return = ['9L1'];
    this.modData('Learnsets', 'snom').learnset.return = ['9L1'];
    this.modData('Learnsets', 'frosmoth').learnset.return = ['9L1'];
    this.modData('Learnsets', 'stonjourner').learnset.return = ['9L1'];
    this.modData('Learnsets', 'eiscue').learnset.return = ['9L1'];
    this.modData('Learnsets', 'indeedee').learnset.return = ['9L1'];
    this.modData('Learnsets', 'indeedeef').learnset.return = ['9L1'];
    this.modData('Learnsets', 'morpeko').learnset.return = ['9L1'];
    this.modData('Learnsets', 'cufant').learnset.return = ['9L1'];
    this.modData('Learnsets', 'copperajah').learnset.return = ['9L1'];
    this.modData('Learnsets', 'dracozolt').learnset.return = ['9L1'];
    this.modData('Learnsets', 'arctozolt').learnset.return = ['9L1'];
    this.modData('Learnsets', 'dracovish').learnset.return = ['9L1'];
    this.modData('Learnsets', 'arctovish').learnset.return = ['9L1'];
    this.modData('Learnsets', 'duraludon').learnset.return = ['9L1'];
    this.modData('Learnsets', 'dreepy').learnset.return = ['9L1'];
    this.modData('Learnsets', 'drakloak').learnset.return = ['9L1'];
    this.modData('Learnsets', 'dragapult').learnset.return = ['9L1'];
    this.modData('Learnsets', 'zacian').learnset.return = ['9L1'];
    this.modData('Learnsets', 'zaciancrowned').learnset.return = ['9L1'];
    this.modData('Learnsets', 'zamazenta').learnset.return = ['9L1'];
    this.modData('Learnsets', 'zamazentacrowned').learnset.return = ['9L1'];
    this.modData('Learnsets', 'eternatus').learnset.return = ['9L1'];
    this.modData('Learnsets', 'zarude').learnset.return = ['9L1'];
    this.modData('Learnsets', 'kubfu').learnset.return = ['9L1'];
    this.modData('Learnsets', 'urshifu').learnset.return = ['9L1'];
    this.modData('Learnsets', 'urshifurapidstrike').learnset.return = ['9L1'];
    this.modData('Learnsets', 'regieleki').learnset.return = ['9L1'];
    this.modData('Learnsets', 'regidrago').learnset.return = ['9L1'];
    this.modData('Learnsets', 'glastrier').learnset.return = ['9L1'];
    this.modData('Learnsets', 'spectrier').learnset.return = ['9L1'];
    this.modData('Learnsets', 'calyrex').learnset.return = ['9L1'];
    this.modData('Learnsets', 'wyrdeer').learnset.return = ['9L1'];
    this.modData('Learnsets', 'kleavor').learnset.return = ['9L1'];
    this.modData('Learnsets', 'ursaluna').learnset.return = ['9L1'];
    this.modData('Learnsets', 'basculegion').learnset.return = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.return = ['9L1'];
    this.modData('Learnsets', 'overqwil').learnset.return = ['9L1'];
    this.modData('Learnsets', 'enamorus').learnset.return = ['9L1'];

    // frustration 
    this.modData('Learnsets', 'meltan').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'melmetal').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'grookey').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'thwackey').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'rillaboom').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'scorbunny').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'raboot').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'cinderace').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'sobble').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'drizzile').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'inteleon').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'skwovet').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'greedent').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'rookidee').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'corvisquire').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'corviknight').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'blipbug').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'dottler').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'orbeetle').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'nickit').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'thievul').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'gossifleur').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'eldegoss').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'wooloo').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'dubwool').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'chewtle').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'drednaw').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'yamper').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'boltund').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'rolycoly').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'carkol').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'coalossal').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'applin').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'flapple').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'appletun').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'silicobra').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'sandaconda').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'cramorant').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'arrokuda').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'barraskewda').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'toxel').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'sizzlipede').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'centiskorch').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'clobbopus').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'grapploct').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'sinistea').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'polteageist').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'hatenna').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'hattrem').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'hatterene').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'impidimp').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'morgrem').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'grimmsnarl').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'obstagoon').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'perrserker').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'cursola').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'sirfetchd').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'mrrime').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'runerigus').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'milcery').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'alcremie').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'falinks').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'pincurchin').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'snom').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'frosmoth').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'stonjourner').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'eiscue').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'indeedee').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'indeedeef').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'morpeko').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'cufant').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'copperajah').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'dracozolt').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'arctozolt').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'dracovish').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'arctovish').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'duraludon').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'dreepy').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'drakloak').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'dragapult').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'zacian').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'zaciancrowned').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'zamazenta').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'zamazentacrowned').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'eternatus').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'zarude').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'kubfu').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'urshifu').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'urshifurapidstrike').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'regieleki').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'regidrago').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'glastrier').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'spectrier').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'calyrex').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'wyrdeer').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'kleavor').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'ursaluna').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'basculegion').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'sneasler').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'overqwil').learnset.frustration = ['9L1'];
    this.modData('Learnsets', 'enamorus').learnset.frustration = ['9L1'];
