"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; } const Scripts = {
	runMove(moveOrMoveName, pokemon, targetLoc, sourceEffect, zMove, externalMove, maxMove, originalTarget) {
		...
		if (!willTryMove) {
			if (_optionalChain([pokemon, 'access', _ => _.volatiles, 'access', _2 => _2['twoturnmove'], 'optionalAccess', _3 => _3.move]) === move.id) {
	...
	runAction(action) {
		const pokemonOriginalHP = _optionalChain([action, 'access', _4 => _4.pokemon, 'optionalAccess', _5 => _5.hp]);
		...
		case 'residual':
			...
			this.clearActiveMove(true);
			this.updateSpeed();
			const residualPokemon = this.getAllActive().map(pokemon => [pokemon, pokemon.hp] );
		...
		if (!this.queue.peek() || (this.gen <= 3 && ['move', 'residual'].includes(this.queue.peek().choice))) {
			...
			return false;
		} else if (_optionalChain([this, 'access', _6 => _6.queue, 'access', _7 => _7.peek, 'call', _8 => _8(), 'optionalAccess', _9 => _9.choice]) === 'instaswitch') {
			return false;
		}
		...
		if (this.gen >= 8 && _optionalChain([this, 'access', _10 => _10.queue, 'access', _11 => _11.peek, 'call', _12 => _12(), 'optionalAccess', _13 => _13.choice]) === 'move') {
