...
// Future Mons
	anorith: {
		...
		name: "Anorith",
		types: ["Rock", "Bug"],
		baseStats: {hp: 45, atk: 95, def: 50, spa: 40, spd: 40, spe: 75},
		abilities: {},
		heightm: 0.7,
		weightkg: 12.5,
		color: "Gray",
	...
	armaldo: {
		...
		name: "Armaldo",
		types: ["Rock", "Bug"],
		baseStats: {hp: 75, atk: 125, def: 100, spa: 70, spd: 70, spe: 45},
		abilities: {},
		heightm: 1.5,
		weightkg: 68.2,
		color: "Gray",
	...
	snover: {
		...
		name: "Snover",
		types: ["Grass", "Ice"],
		baseStats: {hp: 60, atk: 62, def: 50, spa: 62, spd: 62, spe: 40},
		abilities: {},
		heightm: 1,
		weightkg: 50.5,
		color: "White",
	...
	abomasnow: {
		...
		name: "Abomasnow",
		types: ["Grass", "Ice"],
		baseStats: {hp: 90, atk: 92, def: 75, spa: 92, spd: 92, spe: 60},
		abilities: {},
		heightm: 2.2,
		weightkg: 135.5,
		color: "White",
	...
	meditite: {
		...
		baseStats: {hp: 30, atk: 40, def: 55, spa: 55, spd: 55, spe: 60},
		abilities: {},
		heightm: 0.6,
		weightkg: 11.2,
		color: "Blue",
	...
	medicham: {
		...
		name: "Medicham",
		types: ["Fighting", "Psychic"],
		baseStats: {hp: 60, atk: 100, def: 85, spa: 85, spd: 85, spe: 100},
		abilities: {},
		heightm: 1.3,
		weightkg: 31.5,
		color: "Red",
	...
	talonflame: {
		...
		name: "Talonflame",
		types: ["Fire", "Flying"],
		baseStats: {hp: 78, atk: 81, def: 71, spa: 74, spd: 74, spe: 126},
		abilities: {},
		heightm: 1.2,
		weightkg: 24.5,
		color: "Red",
	...
	larvitar: {
		...
		name: "Larvitar",
		types: ["Rock", "Ground"],
		baseStats: {hp: 50, atk: 64, def: 45, spa: 50, spd: 50, spe: 41},
		abilities: {},
		heightm: 0.6,
		weightkg: 72,
		color: "Green",
	...
	pupitar: {
		...
		name: "Pupitar",
		types: ["Rock", "Ground"],
		baseStats: {hp: 70, atk: 84, def: 65, spa: 70, spd: 70, spe: 51},
		abilities: {},
		heightm: 1.2,
		weightkg: 152,
		color: "Gray",
	...
	popplio: {
		...
		baseStats: {hp: 50, atk: 54, def: 54, spa: 66, spd: 66, spe: 40},
		abilities: {},
		heightm: 0.4,
		weightkg: 7.5,
		color: "Blue",
	...
	primarina: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 74, def: 74, spa: 126, spd: 126, spe: 60},
		abilities: {},
		heightm: 1.8,
		weightkg: 44,
		color: "Blue",
...
// Old Mons
	...
	beedrill: {
		inherit: true,
		types: ["Bug", "Ground"],
		baseStats: {hp: 65, atk: 100, def: 60, spa: 65, spd: 65, spe: 95},
	},
	pidgey: {
		inherit: true,
	...
	venomoth: {
		inherit: true,
		baseStats: {hp: 70, atk: 88, def: 84, spa: 90, spd: 90, spe: 90},
	},
	diglett: {
		inherit: true,
	...
	machamp: {
		inherit: true,
		baseStats: {hp: 90, atk: 130, def: 80, spa: 80, spd: 80, spe: 80},
	},
	bellsprout: {
		inherit: true,
	...
	onix: {
		inherit: true,
		types: ["Rock", "Ice"],
		baseStats: {hp: 70, atk: 45, def: 30, spa: 160, spd: 160, spe: 70},
	},
	drowzee: {
		inherit: true,
