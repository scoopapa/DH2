export const Moves: { [moveid: string]: ModdedMoveData } = {
	...
	deathstare: {
		...
		type: "Ghost",
		contestType: "Cool",
		desc: "Inflicts Curse status upon the target.",
		shortDesc: "Inflicts Curse status upon the target.",
	},
	calciapplejuice: {
		num: -10,
		accuracy: 100,
		...
		target: "normal",
		type: "Grass",
		desc: "Has a 20% chance to lower the target's Defense and SpD by 1 stage each.",
