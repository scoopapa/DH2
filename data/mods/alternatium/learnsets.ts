...
export const Learnsets: {[speciesid: string]: LearnsetData} = {
	...
	pikachu: {
		...
		eventData: [
			{generation: 3, level: 50, abilities: ["staticcling", "motordrive"], moves: ["thunderbolt", "agility", "thunder", "lightscreen"], pokeball: "pokeball"},
			...
			{generation: 4, level: 10, gender: "F", nature: "Hardy", abilities: ["staticcling", "motordrive"], moves: ["surf", "volttackle", "tailwhip", "thunderwave"], pokeball: "pokeball"},
			...
			{generation: 5, level: 50, shiny: 1, gender: "F", abilities: ["staticcling", "motordrive"], moves: ["extremespeed", "thunderbolt", "grassknot", "brickbreak"], pokeball: "cherishball"},
