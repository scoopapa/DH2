 ...
 */
 ...
 const Scripts = {
	...
	runMove(moveOrMoveName, pokemon, targetLoc, sourceEffect) {
		...
		if (_optionalChain([target, 'optionalAccess', _ => _.subFainted])) target.subFainted = null;
	...
	tryMoveHit(target, pokemon, move) {
		...
		if (move.volatileStatus === 'partiallytrapped' && target === _optionalChain([pokemon, 'access', _2 => _2.volatiles, 'access', _3 => _3['partialtrappinglock'], 'optionalAccess', _4 => _4.locked])) {
			accuracy = true;
		}
	...
	moveHit(target, pokemon, move, moveData, isSecondary, isSelf) {
		...
		const targetHasSub = !!(_optionalChain([target, 'optionalAccess', _5 => _5.volatiles, 'access', _6 => _6['substitute']]));
