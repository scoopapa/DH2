...
export const Scripts: ModdedBattleScriptsData = {
	...
	init: function () {
		...
		this.modData('Learnsets', 'ralts').learnset.taunt = ['1L1'];
		this.modData('Learnsets', 'hitmonchan').learnset.taunt = ['1L1'];
		...
		this.modData('Learnsets', 'parasect').learnset.taunt = ['1L1'];
		this.modData('Learnsets', 'meowth').learnset.taunt = ['1L1'];
		this.modData('Learnsets', 'mankey').learnset.taunt = ['1L1'];
		this.modData('Learnsets', 'scyther').learnset.taunt = ['1L1'];
		this.modData('Learnsets', 'koffing').learnset.taunt = ['1L1'];
		this.modData('Learnsets', 'mew').learnset.taunt = ['1L1'];
		this.modData('Learnsets', 'blastoise').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'nidoking').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'nidoqueen').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'geodude').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'rhydon').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'onix').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'lickitung').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'lapras').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'machamp').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'poliwrath').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'dragonite').learnset.heavyslam = ['1L1'];
		this.modData('Learnsets', 'butterfree').learnset.fleurcannon = ['1L1'];
		this.modData('Learnsets', 'parasect').learnset.fleurcannon = ['1L1'];
		this.modData('Learnsets', 'vileplume').learnset.fleurcannon = ['1L1'];
		this.modData('Learnsets', 'venusaur').learnset.fleurcannon = ['1L1'];
		this.modData('Learnsets', 'tangela').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'lickitung').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'bellsprout').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'dratini').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'deino').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'bulbasaur').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'ekans').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'pinsir').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'persian').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'gyarados').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'mew').learnset.lashout = ['1L1'];
		this.modData('Learnsets', 'growlithe').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'charmander').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'flareon').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'magmar').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'vulpix').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'ponyta').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'spiritomb').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'moltres').learnset.sunsteelstrike = ['1L1'];
		this.modData('Learnsets', 'clefairy').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'jigglypuff').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'magnemite').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'drowzee').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'voltorb').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'mrmime').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'ralts').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'porygon').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'mew').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'mewtwo').learnset.craftyshield = ['1L1'];
		this.modData('Learnsets', 'moltres').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'arcanine').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'ninetales').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'gardevoir').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'spiritomb').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'charizard').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'rapidash').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'magmar').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'weezing').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'whimsicott').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'mew').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'gengar').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'mimikyu').learnset.fierywrath = ['1L1'];
		this.modData('Learnsets', 'fearow').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'rhyhorn').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'beedrill').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'sandshrew').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'nidoqueen').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'nidoranm').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'rapidash').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'seel').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'onix').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'goldeen').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'lapras').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'karrablast').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'tauros').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'pinsir').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'dragonair').learnset.smartstrike = ['1L1'];
		this.modData('Learnsets', 'wigglytuff').learnset.fairylock = ['1L1'];
		this.modData('Learnsets', 'clefable').learnset.fairylock = ['1L1'];
		this.modData('Learnsets', 'alcremie').learnset.fairylock = ['1L1'];
		this.modData('Learnsets', 'golduck').learnset.fairylock = ['1L1'];
		this.modData('Learnsets', 'ralts').learnset.fairylock = ['1L1'];
		this.modData('Learnsets', 'venonat').learnset.fairylock = ['1L1'];
		this.modData('Learnsets', 'drowzee').learnset.fairylock = ['1L1'];
		this.modData('Learnsets', 'mimikyu').learnset.fairylock = ['1L1'];
	},
};
