...
export const Formats: FormatList = [
	...
	},
	{
		...
		threads: [],
		mod: 'pokemonthrone',
		ruleset: ['Standard NatDex', 'HP Percentage Mod', 'Species Clause', 'Endless Battle Clause', 'Force Open Team Sheets'],
	...
	},
	{
		...
		threads: [],
		mod: 'pokemonthrone',
		ruleset: ['Standard NatDex', 'HP Percentage Mod', 'Species Clause', 'Endless Battle Clause'],
		banlist: ['Arceus', 'Calyrex-Ice', 'Calyrex-Shadow', 'Chien-Pao', 'Chi-Yu',
				'Deoxys', 'Deoxys-Attack', 'Dialga', 'Dialga-Origin', 'Eternatus', 'Genesect',
				'Giratina', 'Giratina-Origin', 'Groudon', 'Ho-Oh', 'Kyogre', 'Kyurem-White', 'Kyurem-Black',
				'Landorus-Incarnate', 'Lugia', 'Lunala', 'Marshadow', 'Mewtwo', 'Necrozma-Dawn-Wings', 'Necrozma-Dusk-Mane',
	...
	},
	{
		...
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Standard NatDex', 'HP Percentage Mod', 'Species Clause', 'Item Clause', 'Picked Team Size = 4', 'Adjust Level = 50', 'VGC Timer', 'Open Team Sheets'],
		banlist: [
