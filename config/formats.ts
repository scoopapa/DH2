...
export const Formats: FormatList = [
	...
	},
	{
		...
		unbanlist: [
				...
				'Necrozma', 'Necrozma-Lionheart', 'Necrozma-Batwing', 'Necrozma-Dragon', 'Braviary-Pariot', 'Braviary-Hisui', 'Lilligant-Bard', 'Mistlegant', 'Electrode-Screwball', 
				'Electrode-Ringo',
		],
...
*/		onAfterMega(pokemon) {
	...
	// },
	{
		...
		unbanlist: [
			...
			'Burmlin', 'Axedge', 'Rolypek', 'Piplouth-Galar', 'Bagouth-Alola', "Mudboach", "Lickigull", "Frillopod", "Frillopod-F", "Eevuto",
			'Exeggcute',
		],
	},
	{
