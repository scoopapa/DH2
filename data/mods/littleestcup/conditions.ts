...
The running speed starts slowly but gets faster each minute after you hear this signal kricketune.mp4. 
...
A sing lap should be completed every time you hear this sound. kricketune.mp4
 ...
 The test will begin on the word start. On your mark. Get ready!… Start. kricketune.mp4.
*/
	brn: {
		name: 'brn',
		effectType: 'Status',
...
*/
	...
	confusion: {
		...
		onBeforeMove(pokemon) {
			...
			if (!this.randomChance(33, 100) || pokemon.hasAbility('magicguard')) {
				return;
			}
...
A sing lap should be completed every time you hear this sound. kricketune.mp4
 ...
 The test will begin on the word start. On your mark. Get ready!… Start. kricketune.mp4.
*/
// why was rolloutstorage under everything else
};
