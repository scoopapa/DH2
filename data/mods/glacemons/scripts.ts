export const Scripts: ModdedBattleScriptsData = {
	...
	init() {//Tera Blast
		...
		this.modData('Learnsets', 'hattena').learnset.hypnotichorror = ['9M'];
		...
		this.modData('Learnsets', 'krookdile').learnset.blackout = ['9M'];
		...
		this.modData('Learnsets', 'pontyagalar').learnset.bonfire = ['9M'];
