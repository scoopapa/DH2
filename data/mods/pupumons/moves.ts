...
statusm: Attacking moves that can apply a volatile or non-volatile status condition.
...
export const Moves: {[moveid: string]: MoveData} = {
	...
	beakblast: {
		...
		pp: 15,
		priority: -3,
		flags: {bullet: 1, protect: 1, statusm: 1},
	...
	blizzard: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, statusm: 1},
		onModifyMove(move) {
	...
	bodyslam: {
		...
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, nonsky: 1, statusm: 1},
		secondary: {
			chance: 30,
			status: 'par',
		},
	...
	bounce: {
		...
		pp: 5,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, gravity: 1, distance: 1, statusm: 1},
	...
	chatter: {
		...
		pp: 20,
		priority: 0,
		flags: {protect: 1, mirror: 1, sound: 1, distance: 1, authentic: 1, statusm: 1},
		noSketch: true,
		secondary: {
			chance: 100,
	...
	dizzypunch: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, punch: 1, statusm: 1},
		secondary: {
			chance: 20,
			volatileStatus: 'confusion',
		},
	...
	firefang: {
		...
		pp: 15,
		priority: 0,
		flags: {bite: 1, contact: 1, protect: 1, mirror: 1, statusm: 1},
		secondaries: [
			{
				chance: 10,
				status: 'brn',
	...
	flamewheel: {
		...
		pp: 25,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, defrost: 1, statusm: 1},
		secondary: {
			chance: 10,
			status: 'brn',
		},
	...
	freezeshock: {
		...
		pp: 5,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, statusm: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	hurricane: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, distance: 1, statusm: 1},
	...
	pyroball: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, defrost: 1, bullet: 1, statusm: 1},
		secondary: {
			chance: 10,
			status: 'brn',
		},
	...
	sacredfire: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, defrost: 1, statusm: 1},
		secondary: {
			chance: 50,
			status: 'brn',
		},
	...
	searingshot: {
		...
		pp: 5,
		priority: 0,
		flags: {bullet: 1, protect: 1, mirror: 1, statusm: 1},
		secondary: {
			chance: 30,
			status: 'brn',
		},
	...
	sizzlyslide: {
		...
		pp: 20,
		priority: 0,
		flags: {contact: 1, protect: 1, defrost: 1, statusm: 1},
		secondary: {
			chance: 100,
			status: 'brn',
		},
	...
	waterpulse: {
		...
		pp: 20,
		priority: 0,
		flags: {protect: 1, pulse: 1, mirror: 1, distance: 1, statusm: 1},
		secondary: {
			chance: 20,
			volatileStatus: 'confusion',
		},
