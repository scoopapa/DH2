...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['Uber', 'AG', 'Arena Trap', 'Moody', 'Shadow Tag', 'King\'s Rock', 'Baton Pass', 'Last Respects', 'Shed Tail', 'Matchup Moth', 'Wobbadubba', 'Jumbo Jet', 
			'the tomb guy', 'Palafinbutnotreallybutmaybe', 'bulky bean'],
		onValidateTeam(team, format) {
			let speciesTable = {};
